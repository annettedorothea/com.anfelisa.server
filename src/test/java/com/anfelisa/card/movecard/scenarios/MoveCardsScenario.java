...
public class MoveCardsScenario extends AbstractMoveCardsScenario {
	...
	protected void verifications() {
		...
		ICardModel expectedCard = new CardModel("c1", "given", "wanted", "image", "Annette-" + getTestId(), 1, "cat2","boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
		
		actualCard = this.daoProvider.getCardDao().selectByCardId(handle, "c2");
		expectedCard = new CardModel("c2", "given2", "wanted2", "image2", "Annette-" + getTestId(), 2, "cat2","boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
		...
		expectedCard = new CardModel("c4", "4given4", "4wanted4", null, "Annette-" + getTestId(), 3, "cat2","boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
