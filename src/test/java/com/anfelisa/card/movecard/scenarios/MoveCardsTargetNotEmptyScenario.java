...
public class MoveCardsTargetNotEmptyScenario extends AbstractMoveCardsTargetNotEmptyScenario {
	...
	protected void verifications() {
		...
		ICardModel expectedCard = new CardModel("c1-" + getTestId(), "given", "wanted", "image", "Annette-" + getTestId(), 2, "cat2-" + getTestId(),"boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
		
		actualCard = this.daoProvider.getCardDao().selectByCardId(handle, "c2-" + getTestId());
		expectedCard = new CardModel("c2-" + getTestId(), "given2", "wanted2", "image2", "Annette-" + getTestId(), 3, "cat2-" + getTestId(),"boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
		...
		expectedCard = new CardModel("c4-" + getTestId(), "4given4", "4wanted4", null, "Annette-" + getTestId(), 4, "cat2-" + getTestId(),"boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
		...
		actualCard = this.daoProvider.getCardDao().selectByCardId(handle, "c6-" + getTestId());
		expectedCard = new CardModel("c6-" + getTestId(), "aa-given", "zz-wanted", null, "Annette-" + getTestId(), 1, "cat2-" + getTestId(),"boxId-" + getTestId());
		assertThat(actualCard, expectedCard);
	}
