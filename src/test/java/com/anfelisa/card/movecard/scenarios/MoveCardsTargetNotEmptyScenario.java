...
public class MoveCardsTargetNotEmptyScenario extends AbstractMoveCardsTargetNotEmptyScenario {
	...
	protected void verifications() {
		...
		ICardModel expectedCard = new CardModel("c1", "given", "wanted", "image", "Annette", 2, "cat2", "boxId");
		assertThat(actualCard, expectedCard);
		
		actualCard = this.daoProvider.getCardDao().selectByCardId(handle, "c2");
		expectedCard = new CardModel("c2", "given2", "wanted2", "image2", "Annette", 3, "cat2", "boxId");
		assertThat(actualCard, expectedCard);
		...
		expectedCard = new CardModel("c4", "4given4", "4wanted4", null, "Annette", 4, "cat2", "boxId");
		assertThat(actualCard, expectedCard);
		...
		expectedCard = new CardModel("c6", "aa-given", "zz-wanted", null, "Annette", 1, "cat2", "boxId");
		assertThat(actualCard, expectedCard);
	}
