...
public class ScoreCard2Scenario extends AbstractScoreCard2Scenario {
	...
	protected void verifications() {
		...
		IScheduledCardModel actualScheduledCard = this.daoProvider.getScheduledCardDao().selectByScheduledCardId(handle,
				"score2-" + getTestId());
		IScheduledCardModel expectedScheduledCard = new ScheduledCardModel("score2-" + getTestId(), "c1-" + getTestId(),"boxId-" + getTestId(),
				scoredDateTime, 2.5F, 1, 1, 1, scoredDateTime.plusDays(1), 2, null,
				null);
		...
		expectedScheduledCard = new ScheduledCardModel("c1-" + getTestId() + "-sc1-" + getTestId(), "c1-" + getTestId(),"boxId-" + getTestId(),
				dateTime, 2.5F, 1, 1, 0, dateTime, null, 2,
				scoredDateTime);
		assertThat(actualScheduledCard, expectedScheduledCard);
		...
		IReinforceCardModel expectedReinforceCard = new ReinforceCardModel("score2-" + getTestId(), "c1-" + getTestId() + "-sc1-" + getTestId(),"boxId-" + getTestId(), scoredDateTime);
