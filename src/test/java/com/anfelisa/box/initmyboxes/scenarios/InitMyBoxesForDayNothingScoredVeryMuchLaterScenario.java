...
public class InitMyBoxesForDayNothingScoredVeryMuchLaterScenario extends AbstractInitMyBoxesForDayNothingScoredVeryMuchLaterScenario {

	@Override
	protected void verifications() {
		LocalDateTime createdDateTime = LocalDateTime.of(2020, 4, 18, 10, 30);
		LocalDateTime dateTime = LocalDateTime.of(2021, 1, 20, 10, 30);
