...
public class ChangeOrderFirstToFourthScenario extends AbstractChangeOrderFirstToFourthScenario {
	...
	protected void verifications() {
		...
		ICategoryModel expectedCategory1 = new CategoryModel("cat1", "level 1 #1", "Annette", 3, "boxId", "boxId", false, null,
				null);
		...
		ICategoryModel expectedCategory2 = new CategoryModel("cat2", "level 1 #2", "Annette", 1, "boxId", "boxId", false, null,
				null);
