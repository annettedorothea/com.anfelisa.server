...
public class ChangeOrderFourthToFirstScenario extends AbstractChangeOrderFourthToFirstScenario {
	...
	protected void verifications() {
		...
		ICategoryModel expectedCategory1 = new CategoryModel("cat1-" + getTestId(), "level 1 #1", "Annette-" + getTestId(), 2,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
		...
		ICategoryModel expectedCategory3 = new CategoryModel("cat3-" + getTestId(), "level 1 #3", "Annette-" + getTestId(), 4,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
		...
		ICategoryModel expectedCategory4 = new CategoryModel("cat4-" + getTestId(), "level 1 #4", "Annette-" + getTestId(), 1,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
