...
public class ChangeOrderFourthToFirstScenario extends AbstractChangeOrderFourthToFirstScenario {
	...
	protected void verifications() {
		...
		ICategoryModel expectedCategory1 = new CategoryModel("cat1", "level 1 #1", "Annette", 2, "boxId", "boxId", false, null,
				null);
		...
		ICategoryModel expectedCategory3 = new CategoryModel("cat3", "level 1 #3", "Annette", 4, "boxId", "boxId", false, null,
				null);
		...
		ICategoryModel expectedCategory4 = new CategoryModel("cat4", "level 1 #4", "Annette", 1, "boxId", "boxId", false, null,
				null);
