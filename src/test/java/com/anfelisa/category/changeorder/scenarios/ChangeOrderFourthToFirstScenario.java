...
public class ChangeOrderFourthToFirstScenario extends AbstractChangeOrderFourthToFirstScenario {

	@Override
	protected void verifications() {
		ICategoryModel actualCategory1 = this.daoProvider.getCategoryDao().selectByCategoryId(handle, "cat1");
		ICategoryModel expectedCategory1 = new CategoryModel("cat1", "level 1 #1", "Annette-" + getTestId(), 2,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
		...
		ICategoryModel expectedCategory2 = new CategoryModel("cat2", "level 1 #2", "Annette-" + getTestId(), 3,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
		...
		ICategoryModel expectedCategory3 = new CategoryModel("cat3", "level 1 #3", "Annette-" + getTestId(), 4,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
		...
		ICategoryModel expectedCategory4 = new CategoryModel("cat4", "level 1 #4", "Annette-" + getTestId(), 1,"boxId-" + getTestId(),"boxId-" + getTestId(), false, null,
				null);
