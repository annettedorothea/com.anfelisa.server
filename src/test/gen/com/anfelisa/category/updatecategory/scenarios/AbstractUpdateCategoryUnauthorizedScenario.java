...
public abstract class AbstractUpdateCategoryUnauthorizedScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callUpdateCategory(randomUUID(), this.templateStringValue("cat1", 0), this.templateStringValue("changed", 0), DROPWIZARD.getLocalPort(), null);
	}
