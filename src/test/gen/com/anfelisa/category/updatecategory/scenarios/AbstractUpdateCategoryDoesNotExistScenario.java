...
public abstract class AbstractUpdateCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryUpdateTestData updateCategory0 = new com.anfelisa.category.data.CategoryUpdateTestData(randomUUID());
		updateCategory0.setCategoryName(this.templateStringValue("changed", 0));
		updateCategory0.setCategoryId(this.templateStringValue("xxx", 0));
		
		
		return 
		com.anfelisa.category.ActionCalls.callUpdateCategory(updateCategory0, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
