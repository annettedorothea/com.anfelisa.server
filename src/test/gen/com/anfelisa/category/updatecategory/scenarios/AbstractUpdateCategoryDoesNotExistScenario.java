...
public abstract class AbstractUpdateCategoryDoesNotExistScenario extends BaseScenario {
	...
	private com.anfelisa.category.data.UpdateCategoryResponse then(Response response) throws Exception {
		...
		com.anfelisa.category.data.UpdateCategoryResponse actual = null;
		try {
			actual = response.readEntity(com.anfelisa.category.data.UpdateCategoryResponse.class);
		} catch (Exception x) {
		}
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UpdateCategoryDoesNotExist")) {
			...
			com.anfelisa.category.data.UpdateCategoryResponse actualResponse = then(response);
