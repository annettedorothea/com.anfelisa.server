...
public abstract class AbstractUpdateCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callUpdateCategory(randomUUID(), this.templateStringValue("xxx", 0), this.templateStringValue("changed", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
