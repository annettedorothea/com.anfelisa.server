...
public abstract class AbstractMoveCategoryNotToChildScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCategoryNotToChildScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.category.data.MoveCategoryPayload payload_0 = objectMapper.readValue("{" +
			"\"movedCategoryId\" : \"cat2-" + this.getTestId() + "\"," + 
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("MoveCategoryNotToChild")) {
			...
			LOG.info("WHEN: prerequisite for MoveCategoryNotToChild not met");
		}
