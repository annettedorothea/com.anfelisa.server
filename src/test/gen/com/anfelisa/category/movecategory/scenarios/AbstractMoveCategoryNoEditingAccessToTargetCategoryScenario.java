...
public abstract class AbstractMoveCategoryNoEditingAccessToTargetCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCategoryNoEditingAccessToTargetCategoryScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.category.data.MoveCategoryPayload payload_0 = objectMapper.readValue("{" +
			"\"movedCategoryId\" : \"boxId-" + this.getTestId() + "\"," + 
		...
		com.anfelisa.category.models.CategoryMoveModel model_0 = objectMapper.readValue("{" +
			"\"movedCategoryId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"targetCategoryId\" : \"cat3-" + this.getTestId() + "\"} ", com.anfelisa.category.models.CategoryMoveModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("MoveCategoryNoEditingAccessToTargetCategory")) {
			...
			LOG.info("WHEN: prerequisite for MoveCategoryNoEditingAccessToTargetCategory not met");
		}
	...
	protected String scenarioName() {
		return "MoveCategoryNoEditingAccessToTargetCategory";
	}
