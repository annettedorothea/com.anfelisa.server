...
public abstract class AbstractMoveCategoryTargetCategoryIsNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCategoryTargetCategoryIsNullScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.category.data.MoveCategoryPayload payload_0 = objectMapper.readValue("{" +
			...
			"\"targetCategoryId\" : \"xxx-" + this.getTestId() + "\"} ",
		...
		com.anfelisa.category.models.CategoryMoveModel model_0 = objectMapper.readValue("{" +
			"\"movedCategoryId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"targetCategoryId\" : \"xxx-" + this.getTestId() + "\"} ", com.anfelisa.category.models.CategoryMoveModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("MoveCategoryTargetCategoryIsNull")) {
			...
			LOG.info("WHEN: prerequisite for MoveCategoryTargetCategoryIsNull not met");
		}
	...
	protected String scenarioName() {
		return "MoveCategoryTargetCategoryIsNull";
	}
