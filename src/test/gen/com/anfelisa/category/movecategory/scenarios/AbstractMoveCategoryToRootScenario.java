...
public abstract class AbstractMoveCategoryToRootScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callMoveCategory(randomUUID(), this.templateStringValue("cat3", 0), this.templateStringValue("boxId", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
