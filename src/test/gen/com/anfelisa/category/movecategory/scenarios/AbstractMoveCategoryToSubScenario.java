...
public abstract class AbstractMoveCategoryToSubScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callMoveCategory(randomUUID(), this.templateStringValue("cat1", 0), this.templateStringValue("cat3", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
