...
public abstract class AbstractMoveCategoryToSubScenario extends BaseScenario {
	...
	private com.anfelisa.category.data.MoveCategoryResponse then(Response response) throws Exception {
		...
		com.anfelisa.category.data.MoveCategoryResponse actual = null;
		try {
			actual = response.readEntity(com.anfelisa.category.data.MoveCategoryResponse.class);
		} catch (Exception x) {
		}
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("MoveCategoryToSub")) {
			...
			com.anfelisa.category.data.MoveCategoryResponse actualResponse = then(response);
