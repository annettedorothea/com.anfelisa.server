...
public abstract class AbstractMoveCategoryNotInSameBoxScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCategoryNotInSameBoxScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("CreateSecondBox")) {
			...
			if (response_5.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateSecondBox fails due to {} in {} ms", message, response_5.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateSecondBox success in {} ms", response_5.getDuration());
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.category.data.MoveCategoryPayload payload_0 = objectMapper.readValue("{" +
			...
			"\"targetCategoryId\" : \"boxId2-" + this.getTestId() + "\"} ",
		...
		com.anfelisa.category.models.CategoryMoveModel model_0 = objectMapper.readValue("{" +
			"\"movedCategoryId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"targetCategoryId\" : \"boxId2-" + this.getTestId() + "\"} ", com.anfelisa.category.models.CategoryMoveModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("MoveCategoryNotInSameBox")) {
			...
			LOG.info("WHEN: prerequisite for MoveCategoryNotInSameBox not met");
		}
	...
	protected String scenarioName() {
		return "MoveCategoryNotInSameBox";
	}
