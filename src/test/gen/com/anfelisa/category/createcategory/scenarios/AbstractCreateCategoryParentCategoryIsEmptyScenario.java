...
public abstract class AbstractCreateCategoryParentCategoryIsEmptyScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCategoryParentCategoryIsEmptyScenario.class);
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				public void createCategoryParentCategoryIsEmpty() throws Exception {
					...
					if (prerequisite("CreateCategoryParentCategoryIsEmpty")) {
						...
						LOG.info("prerequisite for CreateCategoryParentCategoryIsEmpty not met");
					}
				}
				...
				protected String scenarioName() {
					return "CreateCategoryParentCategoryIsEmpty";
				}
