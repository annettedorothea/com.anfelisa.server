...
public abstract class AbstractCreateCategoryParentCategoryIsNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCategoryParentCategoryIsNullScenario.class);
			...
			assertFail(message);
				...
				public void createCategoryParentCategoryIsNull() throws Exception {
					...
					if (prerequisite("CreateCategoryParentCategoryIsNull")) {
						...
						LOG.info("prerequisite for CreateCategoryParentCategoryIsNull not met");
					}
				}
				...
				protected String scenarioName() {
					return "CreateCategoryParentCategoryIsNull";
				}
