...
public abstract class AbstractCreateSecondCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateSecondCategoryScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "cat2-${testId}".replace("${testId}", this.getTestId());
			...
			assertFail(message);
				...
				public void createSecondCategory() throws Exception {
					...
					if (prerequisite("CreateSecondCategory")) {
						...
						LOG.info("prerequisite for CreateSecondCategory not met");
					}
				}
