...
public abstract class AbstractCreateSecondCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryCreationTestData createCategory0 = new com.anfelisa.category.data.CategoryCreationTestData("cat2");
		createCategory0.setCategoryName(this.templateStringValue("level 1 #2", 0));
