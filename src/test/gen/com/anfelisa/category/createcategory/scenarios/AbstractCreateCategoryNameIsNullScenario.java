...
public abstract class AbstractCreateCategoryNameIsNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCategoryNameIsNullScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "null-${testId}".replace("${testId}", this.getTestId());
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("CreateCategoryNameIsNull")) {
	...
	private void categoryWasNotCreated() throws Exception {
		com.anfelisa.category.models.ICategoryModel actual = daoProvider.getCategoryDao().selectByCategoryId(handle, "null-" + this.getTestId() + "");
	...
	protected String scenarioName() {
		return "CreateCategoryNameIsNull";
	}
