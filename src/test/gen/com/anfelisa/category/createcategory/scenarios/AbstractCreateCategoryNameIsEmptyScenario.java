...
public abstract class AbstractCreateCategoryNameIsEmptyScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callCreateCategory(randomUUID(), this.templateStringValue("", 0), this.templateStringValue("boxId", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
