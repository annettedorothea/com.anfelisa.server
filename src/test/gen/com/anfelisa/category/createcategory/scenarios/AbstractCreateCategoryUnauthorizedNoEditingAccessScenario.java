...
public abstract class AbstractCreateCategoryUnauthorizedNoEditingAccessScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCategoryUnauthorizedNoEditingAccessScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("CreateCategoryUnauthorizedNoEditingAccess")) {
			...
			LOG.info("WHEN: prerequisite for CreateCategoryUnauthorizedNoEditingAccess not met");
		}
	}
	...
	protected String scenarioName() {
		return "CreateCategoryUnauthorizedNoEditingAccess";
	}
