...
public abstract class AbstractCreateCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryCreationData createCategory0 = new com.anfelisa.category.data.CategoryCreationData("cat1");
		createCategory0.setCategoryName(this.templateStringValue("level 1 #1", null));
