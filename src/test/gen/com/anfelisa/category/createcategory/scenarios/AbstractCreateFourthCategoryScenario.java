...
public abstract class AbstractCreateFourthCategoryScenario extends BaseScenario {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("CreateFourthCategory")) {
				...
				then_0(response_0);
				this.thirdCategoryWasCreated();
				
			
				HttpResponse<Object> response_1 = when_1();
				then_1(response_1);
				this.fourthCategoryWasCreated();
	...
	private void thirdCategoryWasCreated() throws Exception {
		...
		LOG.info("THEN: thirdCategoryWasCreated passed");
	}
	
	private void fourthCategoryWasCreated() throws Exception {
		...
		LOG.info("THEN: fourthCategoryWasCreated passed");
	}
