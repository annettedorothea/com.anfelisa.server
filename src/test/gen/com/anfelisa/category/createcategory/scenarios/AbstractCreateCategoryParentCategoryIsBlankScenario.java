...
public abstract class AbstractCreateCategoryParentCategoryIsBlankScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callCreateCategory(randomUUID(), this.templateStringValue("lala", 0), this.templateStringValue("   ", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 400);
				...
				@Test
				public void createCategoryParentCategoryIsBlank() throws Exception {
					given();
