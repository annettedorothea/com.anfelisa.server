...
public abstract class AbstractCreateCategoryWithDictionaryLookupScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryCreationTestData createCategory0 = new com.anfelisa.category.data.CategoryCreationTestData("dict");
		createCategory0.setCategoryName(this.templateStringValue("dict", 0));
