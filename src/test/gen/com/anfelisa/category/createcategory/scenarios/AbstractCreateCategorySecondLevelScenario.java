...
public abstract class AbstractCreateCategorySecondLevelScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryCreationTestData createCategory0 = new com.anfelisa.category.data.CategoryCreationTestData("cat3");
		createCategory0.setCategoryName(this.templateStringValue("level 2 #1", 0));
		createCategory0.setParentCategoryId(this.templateStringValue("cat2", 0));
