...
public abstract class AbstractCreateCategorySecondLevelScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callCreateCategory("cat3", this.templateStringValue("level 2 #1", 0), this.templateStringValue("cat2", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
