...
public abstract class AbstractCreateCategorySecondLevelScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryCreationData createCategory0 = new com.anfelisa.category.data.CategoryCreationData("cat3");
		createCategory0.setCategoryName(this.templateStringValue("level 2 #1", null));
		createCategory0.setParentCategoryId(this.templateStringValue("cat2", null));
