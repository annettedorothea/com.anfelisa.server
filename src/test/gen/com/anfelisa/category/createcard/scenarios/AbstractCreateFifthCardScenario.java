...
public abstract class AbstractCreateFifthCardScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.card.ActionCalls.callCreateCard("c3", "wanted", "given", null, "cat1", DROPWIZARD.getLocalPort(), authorization("Annette", "password"));

		com.anfelisa.card.ActionCalls.callCreateCard("c4", "wanted", "given", null, "cat1", DROPWIZARD.getLocalPort(), authorization("Annette", "password"));

	}
	
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c5", "wanted", "given", null, "cat1", DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
