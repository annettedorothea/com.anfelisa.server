...
public abstract class AbstractToggleCategoryOrderNoEditingAccessToCategory1Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractToggleCategoryOrderNoEditingAccessToCategory1Scenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ToggleCategoryOrderNoEditingAccessToCategory1")) {
			...
			LOG.info("WHEN: prerequisite for ToggleCategoryOrderNoEditingAccessToCategory1 not met");
		}
	...
	protected String scenarioName() {
		return "ToggleCategoryOrderNoEditingAccessToCategory1";
	}
