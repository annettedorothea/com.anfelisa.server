...
public abstract class AbstractToggleCategoryOrderUnauthorizedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractToggleCategoryOrderUnauthorizedScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ToggleCategoryOrderUnauthorized")) {
			...
			LOG.info("WHEN: prerequisite for ToggleCategoryOrderUnauthorized not met");
		}
	...
	protected String scenarioName() {
		return "ToggleCategoryOrderUnauthorized";
	}
