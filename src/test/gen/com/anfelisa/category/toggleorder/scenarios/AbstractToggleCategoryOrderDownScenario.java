...
public abstract class AbstractToggleCategoryOrderDownScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractToggleCategoryOrderDownScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ToggleCategoryOrderDown")) {
			...
			LOG.info("WHEN: prerequisite for ToggleCategoryOrderDown not met");
		}
	...
	protected String scenarioName() {
		return "ToggleCategoryOrderDown";
	}
