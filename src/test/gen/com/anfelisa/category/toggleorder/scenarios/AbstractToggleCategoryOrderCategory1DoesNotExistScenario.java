...
public abstract class AbstractToggleCategoryOrderCategory1DoesNotExistScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractToggleCategoryOrderCategory1DoesNotExistScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ToggleCategoryOrderCategory1DoesNotExist")) {
			...
			LOG.info("WHEN: prerequisite for ToggleCategoryOrderCategory1DoesNotExist not met");
		}
	...
	protected String scenarioName() {
		return "ToggleCategoryOrderCategory1DoesNotExist";
	}
