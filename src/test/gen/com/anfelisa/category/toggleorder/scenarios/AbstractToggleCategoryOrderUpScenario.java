...
public abstract class AbstractToggleCategoryOrderUpScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractToggleCategoryOrderUpScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.category.models.ToggleCategoryOrderModel model_0 = objectMapper.readValue("{" +
			"\"categoryId\" : \"cat3-" + this.getTestId() + "\"," + 
			"\"down\" : false} ", com.anfelisa.category.models.ToggleCategoryOrderModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ToggleCategoryOrderUp")) {
			...
			LOG.info("WHEN: prerequisite for ToggleCategoryOrderUp not met");
		}
