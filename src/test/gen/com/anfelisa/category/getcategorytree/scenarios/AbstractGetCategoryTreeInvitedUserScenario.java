...
public abstract class AbstractGetCategoryTreeInvitedUserScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetCategoryTreeInvitedUserScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetCategoryTreeInvitedUser")) {
			...
			LOG.info("WHEN: prerequisite for GetCategoryTreeInvitedUser not met");
		}
	...
	protected String scenarioName() {
		return "GetCategoryTreeInvitedUser";
	}
