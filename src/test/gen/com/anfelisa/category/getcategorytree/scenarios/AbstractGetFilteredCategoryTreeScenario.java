...
public abstract class AbstractGetFilteredCategoryTreeScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetFilteredCategoryTreeScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("CreateSecondCategory")) {
			...
			com.anfelisa.category.data.CreateCategoryPayload payload_9 = objectMapper.readValue("{" +
				"\"categoryName\" : \"level 1 #2\"," + 
				"\"parentCategoryId\" : \"boxId-" + this.getTestId() + "\"} ",
					com.anfelisa.category.data.CreateCategoryPayload.class);
			com.anfelisa.category.models.CategoryCreationModel model_9 = objectMapper.readValue("{" +
				"\"categoryName\" : \"level 1 #2\"," + 
				"\"parentCategoryId\" : \"boxId-" + this.getTestId() + "\"} ", com.anfelisa.category.models.CategoryCreationModel.class);
			Data<com.anfelisa.category.models.CategoryCreationModel> data_9 = new Data<com.anfelisa.category.models.CategoryCreationModel>(uuid);
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateSecondCategory fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateSecondCategory success in {} ms", response_9.getDuration());
			addToMetrics("CreateCategory", response_9.getDuration());
		} else {
		...
		if (prerequisite("CreateCategorySecondLevel")) {
			...
			com.anfelisa.category.data.CreateCategoryPayload payload_10 = objectMapper.readValue("{" +
				"\"categoryName\" : \"level 2 #1\"," + 
				"\"parentCategoryId\" : \"cat2-" + this.getTestId() + "\"} ",
					com.anfelisa.category.data.CreateCategoryPayload.class);
			com.anfelisa.category.models.CategoryCreationModel model_10 = objectMapper.readValue("{" +
				"\"categoryName\" : \"level 2 #1\"," + 
				"\"parentCategoryId\" : \"cat2-" + this.getTestId() + "\"} ", com.anfelisa.category.models.CategoryCreationModel.class);
			Data<com.anfelisa.category.models.CategoryCreationModel> data_10 = new Data<com.anfelisa.category.models.CategoryCreationModel>(uuid);
			...
			if (response_10.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateCategorySecondLevel fails due to {} in {} ms", message, response_10.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateCategorySecondLevel success in {} ms", response_10.getDuration());
			addToMetrics("CreateCategory", response_10.getDuration());
		} else {
		...
		if (prerequisite("CreateCardInOtherCategory")) {
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateCardInOtherCategory fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateCardInOtherCategory success in {} ms", response_11.getDuration());
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetFilteredCategoryTree")) {
			...
			LOG.info("WHEN: prerequisite for GetFilteredCategoryTree not met");
		}
	...
	protected String scenarioName() {
		return "GetFilteredCategoryTree";
	}
