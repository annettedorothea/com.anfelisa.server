...
public abstract class AbstractGetFilteredCategoryPriority1TreeScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetFilteredCategoryPriority1TreeScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetFilteredCategoryPriority1Tree")) {
			...
			LOG.info("WHEN: prerequisite for GetFilteredCategoryPriority1Tree not met");
		}
	...
	protected String scenarioName() {
		return "GetFilteredCategoryPriority1Tree";
	}
