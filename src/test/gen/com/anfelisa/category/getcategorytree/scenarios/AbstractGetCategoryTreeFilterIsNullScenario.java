...
public abstract class AbstractGetCategoryTreeFilterIsNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetCategoryTreeFilterIsNullScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetCategoryTreeFilterIsNull")) {
			...
			LOG.info("WHEN: prerequisite for GetCategoryTreeFilterIsNull not met");
		}
	}
	...
	protected String scenarioName() {
		return "GetCategoryTreeFilterIsNull";
	}
