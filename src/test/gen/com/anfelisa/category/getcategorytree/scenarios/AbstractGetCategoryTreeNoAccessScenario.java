...
public abstract class AbstractGetCategoryTreeNoAccessScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callGetCategoryTree(randomUUID(), this.templateStringValue("boxId", 0), DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	}
