...
public abstract class AbstractGetFilteredCategoryPriority3TreeScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetFilteredCategoryPriority3TreeScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("UpdateCardPriority3")) {
			...
			com.anfelisa.card.models.CardUpdatePriorityModel model_9 = objectMapper.readValue("{" +
				"\"cardId\" : \"c1-" + this.getTestId() + "\"," + 
				"\"priority\" : 3} ", com.anfelisa.card.models.CardUpdatePriorityModel.class);
			...
			if (response_9.getStatusCode() >= 400) {
				...
				String message = "GIVEN UpdateCardPriority3 fails\n" + statusMessage;
				LOG.error("GIVEN: UpdateCardPriority3 fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: UpdateCardPriority3 success in {} ms", response_9.getDuration());
			addToMetrics("UpdateCardPriority", response_9.getDuration());
		} else {
			LOG.info("GIVEN: prerequisite for UpdateCardPriority3 not met");
		}
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetFilteredCategoryPriority3Tree")) {
			...
			LOG.info("WHEN: prerequisite for GetFilteredCategoryPriority3Tree not met");
		}
	...
	protected String scenarioName() {
		return "GetFilteredCategoryPriority3Tree";
	}
