...
public abstract class AbstractChangeOrderTargetCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callChangeOrderCategory(randomUUID(), this.templateStringValue("cat1", 0), this.templateStringValue("lala", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
