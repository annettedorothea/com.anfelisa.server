...
public abstract class AbstractChangeOrderNoAccessToMovedCategoryScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.category.ActionCalls.callCreateCategory("adminCat", "c", "adminBox", DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));

	}
	
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callChangeOrderCategory(randomUUID(), "adminCat", "cat1", DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
