...
public abstract class AbstractChangeOrderNoAccessToTargetCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callChangeOrderCategory(randomUUID(), this.templateStringValue("cat1", 0), this.templateStringValue("adminCat", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
