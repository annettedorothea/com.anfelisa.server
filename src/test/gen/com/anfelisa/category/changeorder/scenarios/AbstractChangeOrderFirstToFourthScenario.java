...
public abstract class AbstractChangeOrderFirstToFourthScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractChangeOrderFirstToFourthScenario.class);
	...
	private Response when() throws Exception {
		...
		com.anfelisa.category.data.CategoryChangeOrderData data_0 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
				...
				"\"targetCategoryId\" : \"cat4-" + this.getTestId() + "\"} ",
	...
	private void cat1AtIndex3() throws Exception {
		...
		LOG.info("THEN: cat1AtIndex3 passed");
	}
	private void cat2AtIndex1() throws Exception {
		...
		LOG.info("THEN: cat2AtIndex1 passed");
	}
	private void cat3AtIndex2() throws Exception {
		...
		LOG.info("THEN: cat3AtIndex2 passed");
	}
	private void cat4AtIndex4() throws Exception {
		...
		LOG.info("THEN: cat4AtIndex4 passed");
	}
