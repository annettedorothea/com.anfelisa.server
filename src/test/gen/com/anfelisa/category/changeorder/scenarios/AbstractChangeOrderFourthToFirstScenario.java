...
public abstract class AbstractChangeOrderFourthToFirstScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		createCategory4.setCategoryName(this.templateStringValue("level 1 #3", null));
		createCategory4.setParentCategoryId(this.templateStringValue("boxId", null));
		...
		createCategory5.setCategoryName(this.templateStringValue("level 1 #4", null));
		createCategory5.setParentCategoryId(this.templateStringValue("boxId", null));
	...
	private Response when() throws Exception {
		...
		changeOrderCategory0.setMovedCategoryId(this.templateStringValue("cat4", null));
		changeOrderCategory0.setTargetCategoryId(this.templateStringValue("cat1", null));
