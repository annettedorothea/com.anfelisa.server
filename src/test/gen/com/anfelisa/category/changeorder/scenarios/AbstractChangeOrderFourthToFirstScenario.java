...
public abstract class AbstractChangeOrderFourthToFirstScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("CreateFourthCategory")) {
			...
			if (response_4.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateFourthCategory fails due to {} in {} ms", message, response_4.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateFourthCategory success in {} ms", response_4.getDuration());
	...
	private void cat4AtIndex1() throws Exception {
		com.anfelisa.category.models.CategoryModel actual = daoProvider.getCategoryDao().selectByCategoryId(handle, "cat4-" + this.getTestId() + "");
