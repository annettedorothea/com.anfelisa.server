...
public abstract class AbstractChangeOrderFourthToFirstScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.category.data.CategoryCreationTestData createCategory5 = new com.anfelisa.category.data.CategoryCreationTestData("cat4");
	...
	private Response when() throws Exception {
		...
		changeOrderCategory0.setMovedCategoryId(this.templateStringValue("cat4", 0));
