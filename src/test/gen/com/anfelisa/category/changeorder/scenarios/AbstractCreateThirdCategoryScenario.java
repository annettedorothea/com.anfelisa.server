...
public abstract class AbstractCreateThirdCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callCreateCategory("cat3", this.templateStringValue("level 1 #3", 0), this.templateStringValue("boxId", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
