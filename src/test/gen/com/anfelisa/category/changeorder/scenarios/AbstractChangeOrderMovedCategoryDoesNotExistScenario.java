...
public abstract class AbstractChangeOrderMovedCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callChangeOrderCategory(randomUUID(), this.templateStringValue("lala", 0), this.templateStringValue("cat1", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 400);
				...
				@Test
				public void changeOrderMovedCategoryDoesNotExist() throws Exception {
					given();
