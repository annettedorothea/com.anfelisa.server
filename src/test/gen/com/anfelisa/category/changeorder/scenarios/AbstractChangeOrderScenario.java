...
public abstract class AbstractChangeOrderScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callChangeOrderCategory(randomUUID(), this.templateStringValue("cat3", 0), this.templateStringValue("cat2", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
