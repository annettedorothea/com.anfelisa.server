...
public abstract class AbstractCreateFourthCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callCreateCategory("cat4", this.templateStringValue("level 1 #4", 0), this.templateStringValue("boxId", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
