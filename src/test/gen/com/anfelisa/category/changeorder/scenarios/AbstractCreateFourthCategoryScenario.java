...
public abstract class AbstractCreateFourthCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryCreationTestData createCategory0 = new com.anfelisa.category.data.CategoryCreationTestData("cat4");
		createCategory0.setCategoryName(this.templateStringValue("level 1 #4", 0));
