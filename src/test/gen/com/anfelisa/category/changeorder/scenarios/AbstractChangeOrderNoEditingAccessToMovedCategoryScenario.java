...
public abstract class AbstractChangeOrderNoEditingAccessToMovedCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractChangeOrderNoEditingAccessToMovedCategoryScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ChangeOrderNoEditingAccessToMovedCategory")) {
			...
			LOG.info("WHEN: prerequisite for ChangeOrderNoEditingAccessToMovedCategory not met");
		}
	}
	...
	protected String scenarioName() {
		return "ChangeOrderNoEditingAccessToMovedCategory";
	}
