...
public abstract class AbstractGetInvitedUsersEditableScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetInvitedUsersEditableScenario.class);
	...
	private com.anfelisa.category.data.GetInvitedUsersResponse then_0(HttpResponse<com.anfelisa.category.data.GetInvitedUsersResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.category.models.AlreadyInvitedUsernamesModel expectedData = objectMapper.readValue("{" +
				"\"invitedUsers\" : [ { \"invitedUsername\" : \"Anne-" + this.getTestId() + "\"," + 
				"\"editable\" : true}]} ", com.anfelisa.category.models.AlreadyInvitedUsernamesModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetInvitedUsersEditable")) {
			...
			LOG.info("WHEN: prerequisite for GetInvitedUsersEditable not met");
		}
	...
	protected String scenarioName() {
		return "GetInvitedUsersEditable";
	}
