...
public abstract class AbstractGetInvitedUsersNoAccessToCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetInvitedUsersNoAccessToCategoryScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetInvitedUsersNoAccessToCategory")) {
			...
			LOG.info("WHEN: prerequisite for GetInvitedUsersNoAccessToCategory not met");
		}
	...
	protected String scenarioName() {
		return "GetInvitedUsersNoAccessToCategory";
	}
