...
public abstract class AbstractGetInvitedUsersCategoryDoesNotExistScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetInvitedUsersCategoryDoesNotExistScenario.class);
	...
	private HttpResponse<com.anfelisa.category.data.GetInvitedUsersResponse> when_0() throws Exception {
		...
		this.httpGet(
			"/category/invited-usernames?categoryId=" + (data_0.getCategoryId() != null ? URLEncoder.encode(data_0.getCategoryId(), StandardCharsets.UTF_8.toString()) : "") + "", 
			authorization("Annette-${testId}", "password"),
			uuid,
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetInvitedUsersCategoryDoesNotExist")) {
			...
			LOG.info("WHEN: prerequisite for GetInvitedUsersCategoryDoesNotExist not met");
		}
	...
	protected String scenarioName() {
		return "GetInvitedUsersCategoryDoesNotExist";
	}
