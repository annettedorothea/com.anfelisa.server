...
public abstract class AbstractInviteUserChangeEditableFalseScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteUserChangeEditableFalseScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InviteUserChangeEditableFalse")) {
			...
			LOG.info("WHEN: prerequisite for InviteUserChangeEditableFalse not met");
		}
	...
	protected String scenarioName() {
		return "InviteUserChangeEditableFalse";
	}
