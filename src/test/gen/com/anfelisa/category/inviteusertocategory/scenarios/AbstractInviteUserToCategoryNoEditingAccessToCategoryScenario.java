...
public abstract class AbstractInviteUserToCategoryNoEditingAccessToCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteUserToCategoryNoEditingAccessToCategoryScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InviteUserToCategoryNoEditingAccessToCategory")) {
			...
			LOG.info("WHEN: prerequisite for InviteUserToCategoryNoEditingAccessToCategory not met");
		}
	}
	...
	protected String scenarioName() {
		return "InviteUserToCategoryNoEditingAccessToCategory";
	}
