...
public abstract class AbstractInviteUserToCategoryNoAccessToCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteUserToCategoryNoAccessToCategoryScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InviteUserToCategoryNoAccessToCategory")) {
			...
			LOG.info("WHEN: prerequisite for InviteUserToCategoryNoAccessToCategory not met");
		}
	...
	protected String scenarioName() {
		return "InviteUserToCategoryNoAccessToCategory";
	}
