...
public abstract class AbstractInviteUserToCategorySelfScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteUserToCategorySelfScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.category.data.InviteUserToCategoryPayload payload_0 = objectMapper.readValue("{" +
			...
			"\"invitedUsername\" : \"Annette-" + this.getTestId() + "\"} ",
		...
		com.anfelisa.category.models.UserToCategoryInvitationModel model_0 = objectMapper.readValue("{" +
			"\"categoryId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"invitedUsername\" : \"Annette-" + this.getTestId() + "\"} ", com.anfelisa.category.models.UserToCategoryInvitationModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InviteUserToCategorySelf")) {
			
				HttpResponse<Object> response_0 = when_0();
				then_0(response_0);
				this.accessToCategoryWasNotChanged();
				
		
		} else {
			LOG.info("WHEN: prerequisite for InviteUserToCategorySelf not met");
		}
	...
	private void accessToCategoryWasNotChanged() throws Exception {
		...
		LOG.info("THEN: accessToCategoryWasNotChanged passed");
	}
		
	@Override
	protected String scenarioName() {
		return "InviteUserToCategorySelf";
	}
