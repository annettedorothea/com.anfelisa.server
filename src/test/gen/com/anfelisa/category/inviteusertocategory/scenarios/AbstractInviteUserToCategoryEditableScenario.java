...
public abstract class AbstractInviteUserToCategoryEditableScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteUserToCategoryEditableScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InviteUserToCategoryEditable")) {
			...
			LOG.info("WHEN: prerequisite for InviteUserToCategoryEditable not met");
		}
	...
	protected String scenarioName() {
		return "InviteUserToCategoryEditable";
	}
