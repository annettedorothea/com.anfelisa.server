...
public abstract class AbstractInviteTwoUsersToCategoryScenario extends BaseScenario {
	...
	private void accessToCategoryWasGranted() throws Exception {
		com.anfelisa.category.models.UserAccessToCategoryModel actual = daoProvider.getUserAccessToCategoryDao().selectByPrimaryKey(handle, "boxId-" + this.getTestId() + "", "uuid-admin");
	...
	private void boxWasCreated() throws Exception {
		com.anfelisa.box.models.BoxModel actual = daoProvider.getBoxDao().selectByPrimaryKey(handle, "boxIdOfInvitedAdminUser-" + this.getTestId() + "");
