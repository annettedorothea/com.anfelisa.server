...
public abstract class AbstractInviteTwoUsersToCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteTwoUsersToCategoryScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		String uuid = "boxIdOfInvitedAdminUser-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InviteTwoUsersToCategory")) {
			...
			LOG.info("WHEN: prerequisite for InviteTwoUsersToCategory not met");
		}
	...
	private void accessToCategoryWasGranted() throws Exception {
		com.anfelisa.category.models.IUserAccessToCategoryModel actual = daoProvider.getUserAccessToCategoryDao().selectByPrimaryKey(handle, "boxId-" + this.getTestId() + "", "uuid-admin");
	...
	private void boxWasCreated() throws Exception {
		com.anfelisa.box.models.IBoxModel actual = daoProvider.getBoxDao().selectByPrimaryKey(handle, "boxIdOfInvitedAdminUser-" + this.getTestId() + "");
		
		com.anfelisa.box.models.IBoxModel expected = objectMapper.readValue("{" +
			"\"categoryId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"userId\" : \"uuid-admin\"," + 
			"\"boxId\" : \"boxIdOfInvitedAdminUser-" + this.getTestId() + "\"," + 
			"\"maxCardsPerDay\" : 10," + 
			"\"maxInterval\" : null," + 
			"\"reverse\" : false," + 
			"\"archived\" : false} ",
	...
	protected String scenarioName() {
		return "InviteTwoUsersToCategory";
	}
