...
public abstract class AbstractDeleteCategoryNoEditingAccessScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteCategoryNoEditingAccessScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DeleteCategoryNoEditingAccess")) {
			...
			LOG.info("WHEN: prerequisite for DeleteCategoryNoEditingAccess not met");
		}
	}
	...
	protected String scenarioName() {
		return "DeleteCategoryNoEditingAccess";
	}
