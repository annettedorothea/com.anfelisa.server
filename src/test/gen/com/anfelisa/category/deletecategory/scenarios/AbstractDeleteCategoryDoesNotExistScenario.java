...
public abstract class AbstractDeleteCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callDeleteCategory(randomUUID(), this.templateStringValue("xx", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
