...
public abstract class AbstractDeleteCategoryUnauthorizedScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteCategoryUnauthorizedScenario.class);
			...
			assertFail(message);
				...
				public void deleteCategoryUnauthorized() throws Exception {
					...
					if (prerequisite("DeleteCategoryUnauthorized")) {
						...
						LOG.info("prerequisite for DeleteCategoryUnauthorized not met");
					}
				}
