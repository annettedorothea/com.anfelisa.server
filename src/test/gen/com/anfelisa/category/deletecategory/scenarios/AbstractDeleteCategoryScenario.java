...
public abstract class AbstractDeleteCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteCategoryScenario.class);
	...
	private void categoryWasDeleted() throws Exception {
		...
		LOG.info("THEN: categoryWasDeleted passed");
	}
	private void indexWasShifted() throws Exception {
		...
		LOG.info("THEN: indexWasShifted passed");
	}
