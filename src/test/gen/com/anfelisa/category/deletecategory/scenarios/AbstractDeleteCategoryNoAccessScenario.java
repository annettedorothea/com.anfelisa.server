...
public abstract class AbstractDeleteCategoryNoAccessScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.category.data.CategoryDeleteTestData deleteCategory0 = new com.anfelisa.category.data.CategoryDeleteTestData(randomUUID());
		deleteCategory0.setCategoryId(this.templateStringValue("cat1", 0));
		
		
		return 
		com.anfelisa.category.ActionCalls.callDeleteCategory(deleteCategory0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
