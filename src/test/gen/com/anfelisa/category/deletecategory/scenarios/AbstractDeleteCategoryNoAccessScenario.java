...
public abstract class AbstractDeleteCategoryNoAccessScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.category.ActionCalls.callDeleteCategory(randomUUID(), this.templateStringValue("cat1", 0), DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	}
