...
public abstract class AbstractSearchUsernameExcludesInvitedUserScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSearchUsernameExcludesInvitedUserScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("SearchUsernameExcludesInvitedUser")) {
			...
			LOG.info("WHEN: prerequisite for SearchUsernameExcludesInvitedUser not met");
		}
	...
	protected String scenarioName() {
		return "SearchUsernameExcludesInvitedUser";
	}
