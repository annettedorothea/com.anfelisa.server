...
public abstract class AbstractSearchUsernameUnauthorizedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSearchUsernameUnauthorizedScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("SearchUsernameUnauthorized")) {
			...
			LOG.info("WHEN: prerequisite for SearchUsernameUnauthorized not met");
		}
	...
	protected String scenarioName() {
		return "SearchUsernameUnauthorized";
	}
