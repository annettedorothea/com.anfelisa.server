...
public abstract class AbstractSearchUsernameScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSearchUsernameScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("SearchUsername")) {
				...
				responseUsernamesShouldStartWithAnne(actualResponse_0);
				responseShouldBeLimitedToTen(actualResponse_0);
				
		
		} else {
			LOG.info("WHEN: prerequisite for SearchUsername not met");
		}
		
			
	}
	
	protected abstract void responseUsernamesShouldStartWithAnne(com.anfelisa.category.data.SearchUsernameForInvitationResponse response);
