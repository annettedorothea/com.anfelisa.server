...
public abstract class AbstractSearchUsernameNarrowScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSearchUsernameNarrowScenario.class);
	...
	private HttpResponse<com.anfelisa.category.data.SearchUsernameForInvitationResponse> when_0() throws Exception {
		...
		this.httpGet(
			"/users/search?usernameSearchString=" + (data_0.getUsernameSearchString() != null ? URLEncoder.encode(data_0.getUsernameSearchString(), StandardCharsets.UTF_8.toString()) : "") + "&categoryId=" + (data_0.getCategoryId() != null ? URLEncoder.encode(data_0.getCategoryId(), StandardCharsets.UTF_8.toString()) : "") + "", 
			authorization("Annette-${testId}", "password"),
			uuid,
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("SearchUsernameNarrow")) {
				...
				responseUsernamesShouldStartWithAnnette(actualResponse_0);
				responseShouldBeLimitedToTen(actualResponse_0);
				
		
		} else {
			LOG.info("WHEN: prerequisite for SearchUsernameNarrow not met");
		}
		
			
	}
	
	protected abstract void responseUsernamesShouldStartWithAnnette(com.anfelisa.category.data.SearchUsernameForInvitationResponse response);
	protected abstract void responseShouldBeLimitedToTen(com.anfelisa.category.data.SearchUsernameForInvitationResponse response);
	
		
	@Override
	protected String scenarioName() {
		return "SearchUsernameNarrow";
	}
