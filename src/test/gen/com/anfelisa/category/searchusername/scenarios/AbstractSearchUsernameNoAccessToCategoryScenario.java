...
public abstract class AbstractSearchUsernameNoAccessToCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSearchUsernameNoAccessToCategoryScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("SearchUsernameNoAccessToCategory")) {
			...
			LOG.info("WHEN: prerequisite for SearchUsernameNoAccessToCategory not met");
		}
	...
	protected String scenarioName() {
		return "SearchUsernameNoAccessToCategory";
	}
