...
public abstract class AbstractUpdateCardPriority0InvalidScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardPriority0InvalidScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.card.models.CardUpdatePriorityModel model_0 = objectMapper.readValue("{" +
			"\"cardId\" : \"c1-" + this.getTestId() + "\"," + 
			"\"priority\" : 0} ", com.anfelisa.card.models.CardUpdatePriorityModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UpdateCardPriority0Invalid")) {
			...
			LOG.info("WHEN: prerequisite for UpdateCardPriority0Invalid not met");
		}
	...
	protected String scenarioName() {
		return "UpdateCardPriority0Invalid";
	}
