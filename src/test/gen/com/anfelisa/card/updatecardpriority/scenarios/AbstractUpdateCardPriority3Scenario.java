...
public abstract class AbstractUpdateCardPriority3Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardPriority3Scenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UpdateCardPriority3")) {
			...
			LOG.info("WHEN: prerequisite for UpdateCardPriority3 not met");
		}
