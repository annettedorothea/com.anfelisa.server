...
public abstract class AbstractUpdateCardPriority1Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardPriority1Scenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UpdateCardPriority1")) {
			...
			LOG.info("WHEN: prerequisite for UpdateCardPriority1 not met");
		}
