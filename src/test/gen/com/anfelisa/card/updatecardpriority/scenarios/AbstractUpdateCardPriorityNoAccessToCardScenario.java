...
public abstract class AbstractUpdateCardPriorityNoAccessToCardScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardPriorityNoAccessToCardScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UpdateCardPriorityNoAccessToCard")) {
			...
			LOG.info("WHEN: prerequisite for UpdateCardPriorityNoAccessToCard not met");
		}
	...
	protected String scenarioName() {
		return "UpdateCardPriorityNoAccessToCard";
	}
