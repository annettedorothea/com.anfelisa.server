	...
	private void given() throws Exception {
		...
		if (prerequisite("CreateSecondBox")) {
			...
			if (response_10.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateSecondBox fails due to {} in {} ms", message, response_10.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("CreateCardInOtherBox")) {
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateCardInOtherBox fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
	...
	private com.anfelisa.card.data.GetDuplicatesResponse then_0(HttpResponse<com.anfelisa.card.data.GetDuplicatesResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.card.models.CardSearchModel expectedData = objectMapper.readValue("{" +
				...
				"\"rootCategoryId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"wanted\" : \"wanted2\"," + 
				"\"categoryName\" : \"level 1 #1\"}]} ", com.anfelisa.card.models.CardSearchModel.class);
