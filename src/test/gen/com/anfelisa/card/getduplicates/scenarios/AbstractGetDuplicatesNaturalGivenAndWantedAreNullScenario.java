...
public abstract class AbstractGetDuplicatesNaturalGivenAndWantedAreNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractGetDuplicatesNaturalGivenAndWantedAreNullScenario.class);
			...
			return actual;
				...
				public void getDuplicatesNaturalGivenAndWantedAreNull() throws Exception {
					...
					if (prerequisite("GetDuplicatesNaturalGivenAndWantedAreNull")) {
						...
						LOG.info("prerequisite for GetDuplicatesNaturalGivenAndWantedAreNull not met");
					}
				}
