...
public abstract class AbstractGetDuplicatesNoAccessToCategoryScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractGetDuplicatesNoAccessToCategoryScenario.class);
			...
			return actual;
				...
				public void getDuplicatesNoAccessToCategory() throws Exception {
					if (prerequisite("GetDuplicatesNoAccessToCategory")) {
						...
						LOG.info("prerequisite for GetDuplicatesNoAccessToCategory not met");
					}
				}
