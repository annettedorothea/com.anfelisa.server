...
public abstract class AbstractGetDuplicatesUnauthorizedScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractGetDuplicatesUnauthorizedScenario.class);
			...
			return actual;
				...
				public void getDuplicatesUnauthorized() throws Exception {
					...
					if (prerequisite("GetDuplicatesUnauthorized")) {
						...
						LOG.info("prerequisite for GetDuplicatesUnauthorized not met");
					}
				}
				...
				protected String scenarioName() {
					return "GetDuplicatesUnauthorized";
				}
