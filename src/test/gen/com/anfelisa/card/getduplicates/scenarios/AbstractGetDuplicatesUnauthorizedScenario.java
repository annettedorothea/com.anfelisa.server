...
public abstract class AbstractGetDuplicatesUnauthorizedScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callGetDuplicates(randomUUID(), this.templateStringValue("ive", 0), this.templateStringValue("nted", 0), new Boolean("true"), this.templateStringValue("boxId", 0), DROPWIZARD.getLocalPort(), null);
	}
