...
public abstract class AbstractGetDuplicatesCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callGetDuplicates(randomUUID(), "ive", "nted", new Boolean("true"), "lala", DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
