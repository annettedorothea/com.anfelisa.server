...
public abstract class AbstractMoveCardsCardDoesNotExistScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCardsCardDoesNotExistScenario.class);
	...
	private Response when() throws Exception {
		...
		return 
		this.httpPut(
			"/cards/move?uuid=" + data_0.getUuid() + "", 
			data_0,
			authorization("Annette-${testId}", "password")
		);
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				@Test
				public void moveCardsCardDoesNotExist() throws Exception {
					given();
						
					if (prerequisite("MoveCardsCardDoesNotExist")) {
						...
						LOG.info("prerequisite for MoveCardsCardDoesNotExist not met");
					}
				}
				...
				protected String scenarioName() {
					return "MoveCardsCardDoesNotExist";
				}
