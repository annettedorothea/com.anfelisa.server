...
public abstract class AbstractMoveCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCardsScenario.class);
			...
			assertFail(message);
				...
				public void moveCards() throws Exception {
					...
					if (prerequisite("MoveCards")) {
						...
						LOG.info("prerequisite for MoveCards not met");
					}
				}
