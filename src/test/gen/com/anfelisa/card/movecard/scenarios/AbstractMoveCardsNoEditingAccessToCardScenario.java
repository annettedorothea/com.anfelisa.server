...
public abstract class AbstractMoveCardsNoEditingAccessToCardScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractMoveCardsNoEditingAccessToCardScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("MoveCardsNoEditingAccessToCard")) {
			...
			LOG.info("WHEN: prerequisite for MoveCardsNoEditingAccessToCard not met");
		}
	...
	protected String scenarioName() {
		return "MoveCardsNoEditingAccessToCard";
	}
