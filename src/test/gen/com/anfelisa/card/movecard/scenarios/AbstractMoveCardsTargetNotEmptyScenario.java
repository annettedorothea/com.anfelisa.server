...
public abstract class AbstractMoveCardsTargetNotEmptyScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		createCategory10.setCategoryName(this.templateStringValue("level 1 #2", null));
		createCategory10.setParentCategoryId(this.templateStringValue("boxId", null));
		...
		createCard11.setCategoryId(this.templateStringValue("cat2", null));
		createCard11.setGiven(this.templateStringValue("aa-given", null));
		createCard11.setWanted(this.templateStringValue("zz-wanted", null));
