...
public abstract class AbstractUpdateCardMissingCardIdScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardMissingCardIdScenario.class);
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				public void updateCardMissingCardId() throws Exception {
					if (prerequisite("UpdateCardMissingCardId")) {
						given();
						...
						LOG.info("prerequisite for UpdateCardMissingCardId not met");
					}
				}
				...
				protected String scenarioName() {
					return "UpdateCardMissingCardId";
				}
