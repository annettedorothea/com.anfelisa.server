...
public abstract class AbstractUpdateCardWantedEmptyScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardWantedEmptyScenario.class);
			...
			assertFail(message);
				...
				public void updateCardWantedEmpty() throws Exception {
					if (prerequisite("UpdateCardWantedEmpty")) {
						...
						LOG.info("prerequisite for UpdateCardWantedEmpty not met");
					}
				}
