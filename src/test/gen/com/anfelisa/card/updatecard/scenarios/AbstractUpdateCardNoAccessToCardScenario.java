...
public abstract class AbstractUpdateCardNoAccessToCardScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardNoAccessToCardScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UpdateCardNoAccessToCard")) {
			...
			LOG.info("WHEN: prerequisite for UpdateCardNoAccessToCard not met");
		}
	...
	protected String scenarioName() {
		return "UpdateCardNoAccessToCard";
	}
