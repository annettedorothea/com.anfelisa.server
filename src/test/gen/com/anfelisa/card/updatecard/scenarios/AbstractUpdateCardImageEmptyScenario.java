...
public abstract class AbstractUpdateCardImageEmptyScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardImageEmptyScenario.class);
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				public void updateCardImageEmpty() throws Exception {
					...
					if (prerequisite("UpdateCardImageEmpty")) {
						...
						LOG.info("prerequisite for UpdateCardImageEmpty not met");
					}
				}
