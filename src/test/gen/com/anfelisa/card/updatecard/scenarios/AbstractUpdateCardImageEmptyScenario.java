...
public abstract class AbstractUpdateCardImageEmptyScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		updateCard0.setGiven(this.templateStringValue("given", 0));
		updateCard0.setImage(this.templateStringValue("  ", 0));
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 200);
				...
				@Test
				public void updateCardImageEmpty() throws Exception {
					given();
