...
public abstract class AbstractUpdateCardGivenEmptyScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callUpdateCard(randomUUID(), this.templateStringValue("c1", 0), this.templateStringValue("  ", 0), this.templateStringValue("image", 0), this.templateStringValue("wanted", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
