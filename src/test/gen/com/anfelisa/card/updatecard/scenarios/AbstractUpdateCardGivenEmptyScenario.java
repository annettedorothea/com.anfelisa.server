...
public abstract class AbstractUpdateCardGivenEmptyScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateCardGivenEmptyScenario.class);
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				public void updateCardGivenEmpty() throws Exception {
					...
					if (prerequisite("UpdateCardGivenEmpty")) {
						...
						LOG.info("WHEN: prerequisite for UpdateCardGivenEmpty not met");
					}
				}
