...
public abstract class AbstractUpdateCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		updateCard0.setCardId(this.templateStringValue("c1", null));
		updateCard0.setGiven(this.templateStringValue("given-updated", null));
		updateCard0.setImage(this.templateStringValue("image-updated", null));
		updateCard0.setWanted(this.templateStringValue("wanted-updated", null));
