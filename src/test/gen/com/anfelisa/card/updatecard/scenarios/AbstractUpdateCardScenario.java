...
public abstract class AbstractUpdateCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callUpdateCard(randomUUID(), this.templateStringValue("c1", 0), this.templateStringValue("given-updated", 0), this.templateStringValue("image-updated", 0), this.templateStringValue("wanted-updated", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
