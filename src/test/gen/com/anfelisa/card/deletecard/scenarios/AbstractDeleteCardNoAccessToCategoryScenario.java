...
public abstract class AbstractDeleteCardNoAccessToCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callDeleteCard(randomUUID(), this.templateStringValue("c1", 0), DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	}
