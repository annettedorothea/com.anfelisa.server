...
public abstract class AbstractDeleteCardNoAccessToCategoryScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardDeleteTestData deleteCard0 = new com.anfelisa.card.data.CardDeleteTestData(randomUUID());
		deleteCard0.setCardId(this.templateStringValue("c1", 0));
		
		
		return 
		com.anfelisa.card.ActionCalls.callDeleteCard(deleteCard0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
