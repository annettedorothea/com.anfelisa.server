...
public abstract class AbstractDeleteCardNoEditingAccessToCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteCardNoEditingAccessToCategoryScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		this.httpDelete(
			"/card/delete?cardId=" + (data_0.getCardId() != null ? URLEncoder.encode(data_0.getCardId(), StandardCharsets.UTF_8.toString()) : "") + "", 
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DeleteCardNoEditingAccessToCategory")) {
			...
			LOG.info("WHEN: prerequisite for DeleteCardNoEditingAccessToCategory not met");
		}
	...
	protected String scenarioName() {
		return "DeleteCardNoEditingAccessToCategory";
	}
