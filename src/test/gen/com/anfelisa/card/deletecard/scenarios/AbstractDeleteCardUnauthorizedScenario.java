...
public abstract class AbstractDeleteCardUnauthorizedScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		return 
		com.anfelisa.card.ActionCalls.callDeleteCard(deleteCard0, DROPWIZARD.getLocalPort(), null);
