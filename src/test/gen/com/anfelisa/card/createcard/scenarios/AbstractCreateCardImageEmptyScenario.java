...
public abstract class AbstractCreateCardImageEmptyScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		createCard0.setImage(this.templateStringValue("  ", null));
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 200);
				...
				@Test
				public void createCardImageEmpty() throws Exception {
					given();
