...
public abstract class AbstractCreateSecondCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		createCard0.setGiven(this.templateStringValue("given2", null));
		createCard0.setImage(this.templateStringValue("image2", null));
		createCard0.setWanted(this.templateStringValue("wanted2", null));
