...
public abstract class AbstractCreateSecondCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("c2");
		createCard0.setCategoryId(this.templateStringValue("cat1", 0));
		createCard0.setGiven(this.templateStringValue("given2", 0));
		createCard0.setImage(this.templateStringValue("image2", 0));
		createCard0.setWanted(this.templateStringValue("wanted2", 0));
