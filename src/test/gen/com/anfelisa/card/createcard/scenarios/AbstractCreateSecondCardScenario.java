...
public abstract class AbstractCreateSecondCardScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateSecondCardScenario.class);
			...
			assertFail(message);
				...
				public void createSecondCard() throws Exception {
					...
					if (prerequisite("CreateSecondCard")) {
						...
						LOG.info("prerequisite for CreateSecondCard not met");
					}
				}
