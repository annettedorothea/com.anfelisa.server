...
public abstract class AbstractCreateSecondCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c2", this.templateStringValue("wanted2", 0), this.templateStringValue("given2", 0), this.templateStringValue("image2", 0), this.templateStringValue("cat1", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
