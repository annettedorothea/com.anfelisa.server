...
public abstract class AbstractCreateCardInOtherBoxScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.box.data.BoxCreationTestData createBox2 = new com.anfelisa.box.data.BoxCreationTestData("boxId2");
		createBox2.setCategoryName(this.templateStringValue("cat2", 2));
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("c7");
		createCard0.setCategoryId(this.templateStringValue("boxId2", 0));
