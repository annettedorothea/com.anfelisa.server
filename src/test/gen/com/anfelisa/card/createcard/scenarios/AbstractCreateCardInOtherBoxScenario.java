...
public abstract class AbstractCreateCardInOtherBoxScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.box.ActionCalls.callCreateBox("boxId2", this.templateStringValue("cat2", 2), new Boolean("false"), null, null, 8, null, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));

	}
	
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c7", this.templateStringValue("wanted", 0), this.templateStringValue("given", 0), null, this.templateStringValue("boxId2", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
