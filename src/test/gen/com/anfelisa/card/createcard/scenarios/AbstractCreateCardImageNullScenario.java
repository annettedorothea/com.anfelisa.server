...
public abstract class AbstractCreateCardImageNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCardImageNullScenario.class);
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				public void createCardImageNull() throws Exception {
					...
					if (prerequisite("CreateCardImageNull")) {
						...
						LOG.info("prerequisite for CreateCardImageNull not met");
					}
				}
