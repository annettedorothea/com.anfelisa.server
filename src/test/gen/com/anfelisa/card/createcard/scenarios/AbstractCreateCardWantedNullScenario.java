...
public abstract class AbstractCreateCardWantedNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCardWantedNullScenario.class);
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				public void createCardWantedNull() throws Exception {
					...
					if (prerequisite("CreateCardWantedNull")) {
						...
						LOG.info("prerequisite for CreateCardWantedNull not met");
					}
				}
