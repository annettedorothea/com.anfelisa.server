...
public abstract class AbstractCreateCardWantedNullScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c1", null, this.templateStringValue("given", 0), this.templateStringValue("image", 0), this.templateStringValue("cat1", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
