...
public abstract class AbstractCreateCardWithLongUuidScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("123456789-123456789-123456789-123456789");
		createCard0.setCategoryId(this.templateStringValue("cat1", 0));
		createCard0.setGiven(this.templateStringValue("x", 0));
		createCard0.setWanted(this.templateStringValue("y", 0));
