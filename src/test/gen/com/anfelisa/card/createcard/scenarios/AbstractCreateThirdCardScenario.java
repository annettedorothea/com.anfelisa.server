...
public abstract class AbstractCreateThirdCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c3", this.templateStringValue("3wanted", 0), this.templateStringValue("3given", 0), null, this.templateStringValue("cat1", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
