...
public abstract class AbstractCreateThirdCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("c3");
		createCard0.setCategoryId(this.templateStringValue("cat1", 0));
		createCard0.setGiven(this.templateStringValue("3given", 0));
		createCard0.setWanted(this.templateStringValue("3wanted", 0));
