...
public abstract class AbstractCreateThirdCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationData createCard0 = new com.anfelisa.card.data.CardCreationData("c3");
		createCard0.setCategoryId(this.templateStringValue("cat1", null));
		createCard0.setGiven(this.templateStringValue("3given", null));
		createCard0.setWanted(this.templateStringValue("3wanted", null));
