...
public abstract class AbstractCreateCardDuplicateIdScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCardDuplicateIdScenario.class);
			...
			assertFail(message);
				...
				public void createCardDuplicateId() throws Exception {
					...
					if (prerequisite("CreateCardDuplicateId")) {
						...
						LOG.info("prerequisite for CreateCardDuplicateId not met");
					}
				}
