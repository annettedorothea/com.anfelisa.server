...
public abstract class AbstractCreateFourthCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("c4");
		createCard0.setCategoryId(this.templateStringValue("cat1", 0));
		createCard0.setGiven(this.templateStringValue("4given4", 0));
		createCard0.setWanted(this.templateStringValue("4wanted4", 0));
