...
public abstract class AbstractCreateFourthCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationData createCard0 = new com.anfelisa.card.data.CardCreationData("c4");
		createCard0.setCategoryId(this.templateStringValue("cat1", null));
		createCard0.setGiven(this.templateStringValue("4given4", null));
		createCard0.setWanted(this.templateStringValue("4wanted4", null));
