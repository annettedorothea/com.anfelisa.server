...
public abstract class AbstractCreateCardMissingCategoryIdScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCardMissingCategoryIdScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "c2-${testId}".replace("${testId}", this.getTestId());
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				@Test
				public void createCardMissingCategoryId() throws Exception {
					given();
						
					if (prerequisite("CreateCardMissingCategoryId")) {
						...
						LOG.info("prerequisite for CreateCardMissingCategoryId not met");
					}
				}
				...
				protected String scenarioName() {
					return "CreateCardMissingCategoryId";
				}
