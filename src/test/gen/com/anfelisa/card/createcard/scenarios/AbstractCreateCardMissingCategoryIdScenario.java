...
public abstract class AbstractCreateCardMissingCategoryIdScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c2", this.templateStringValue("wanted", 0), this.templateStringValue("given", 0), this.templateStringValue("image", 0), null, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
