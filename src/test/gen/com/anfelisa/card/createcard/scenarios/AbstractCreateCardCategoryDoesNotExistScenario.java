...
public abstract class AbstractCreateCardCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("c1");
		createCard0.setCategoryId(this.templateStringValue("lala", 0));
