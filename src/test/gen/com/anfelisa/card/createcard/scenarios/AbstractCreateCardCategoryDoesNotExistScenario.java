...
public abstract class AbstractCreateCardCategoryDoesNotExistScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateCardCategoryDoesNotExistScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "c1-${testId}".replace("${testId}", this.getTestId());
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				public void createCardCategoryDoesNotExist() throws Exception {
					...
					if (prerequisite("CreateCardCategoryDoesNotExist")) {
						...
						LOG.info("prerequisite for CreateCardCategoryDoesNotExist not met");
					}
				}
				...
				protected String scenarioName() {
					return "CreateCardCategoryDoesNotExist";
				}
