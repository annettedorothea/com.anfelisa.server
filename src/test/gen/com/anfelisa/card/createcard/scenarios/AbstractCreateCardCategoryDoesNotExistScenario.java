...
public abstract class AbstractCreateCardCategoryDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c1", this.templateStringValue("wanted", 0), this.templateStringValue("given", 0), this.templateStringValue("image", 0), this.templateStringValue("lala", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
