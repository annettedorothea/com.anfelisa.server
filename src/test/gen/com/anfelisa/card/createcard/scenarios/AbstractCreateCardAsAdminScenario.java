...
public abstract class AbstractCreateCardAsAdminScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.category.data.CategoryCreationTestData createCategory2 = new com.anfelisa.category.data.CategoryCreationTestData("adminCat");
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationTestData createCard0 = new com.anfelisa.card.data.CardCreationTestData("c6");
		createCard0.setCategoryId(this.templateStringValue("adminCat", 0));
