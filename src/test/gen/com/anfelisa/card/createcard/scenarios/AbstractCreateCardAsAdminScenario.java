...
public abstract class AbstractCreateCardAsAdminScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		createCategory2.setCategoryName(this.templateStringValue("c", null));
		createCategory2.setParentCategoryId(this.templateStringValue("adminBox", null));
	...
	private Response when() throws Exception {
		com.anfelisa.card.data.CardCreationData createCard0 = new com.anfelisa.card.data.CardCreationData("c6");
		createCard0.setCategoryId(this.templateStringValue("adminCat", null));
