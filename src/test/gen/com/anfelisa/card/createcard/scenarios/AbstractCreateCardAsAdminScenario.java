...
public abstract class AbstractCreateCardAsAdminScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callCreateCard("c6", this.templateStringValue("wanted", 0), this.templateStringValue("given", 0), this.templateStringValue("image", 0), this.templateStringValue("adminCat", 0), DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	}
