...
public abstract class AbstractGetNonActiveCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetNonActiveCardsScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetNonActiveCards")) {
			...
			LOG.info("WHEN: prerequisite for GetNonActiveCards not met");
		}
	}
