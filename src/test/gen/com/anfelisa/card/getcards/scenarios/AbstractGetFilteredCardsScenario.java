...
public abstract class AbstractGetFilteredCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetFilteredCardsScenario.class);
	...
	private com.anfelisa.card.data.GetCardsResponse then_0(HttpResponse<com.anfelisa.card.data.GetCardsResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.card.models.CardListModel expectedData = objectMapper.readValue("{" +
				...
				"\"given\" : \"different\"," + 
				"\"rootCategoryId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"wanted\" : \"different\"}]} ", com.anfelisa.card.models.CardListModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetFilteredCards")) {
			...
			LOG.info("WHEN: prerequisite for GetFilteredCards not met");
		}
