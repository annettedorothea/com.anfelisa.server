	...
	private void given() throws Exception {
		...
		if (prerequisite("RegisterUserAdmin")) {
			...
			if (response_8.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: RegisterUserAdmin fails due to {} in {} ms", message, response_8.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: RegisterUserAdmin success in {} ms", response_8.getDuration());
