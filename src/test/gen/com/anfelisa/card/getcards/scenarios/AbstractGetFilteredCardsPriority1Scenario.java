...
public abstract class AbstractGetFilteredCardsPriority1Scenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("UpdateCardPriority1")) {
			...
			com.anfelisa.card.models.CardUpdatePriorityModel model_8 = objectMapper.readValue("{" +
				"\"cardId\" : \"c1-" + this.getTestId() + "\"," + 
				"\"priority\" : 1} ", com.anfelisa.card.models.CardUpdatePriorityModel.class);
			Data<com.anfelisa.card.models.CardUpdatePriorityModel> data_8 = new Data<com.anfelisa.card.models.CardUpdatePriorityModel>(uuid);
	...
	private com.anfelisa.card.data.GetCardsResponse then_0(HttpResponse<com.anfelisa.card.data.GetCardsResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.card.models.CardListModel expectedData = objectMapper.readValue("{" +
				...
				"\"wanted\" : \"wanted\"," + 
				"\"priority\" : 1}]} ", com.anfelisa.card.models.CardListModel.class);
