...
public abstract class AbstractGetCardsFilterIsNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetCardsFilterIsNullScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("CreateCardInOtherCategory")) {
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: CreateCardInOtherCategory fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateCardInOtherCategory success in {} ms", response_9.getDuration());
	...
	private HttpResponse<com.anfelisa.card.data.GetCardsResponse> when_0() throws Exception {
		String uuid = this.randomUUID();
		com.anfelisa.card.models.CardListModel model_0 = objectMapper.readValue("{" +
			"\"categoryId\" : \"cat1-" + this.getTestId() + "\"," + 
			"\"reverse\" : false} ", com.anfelisa.card.models.CardListModel.class);
		Data<com.anfelisa.card.models.CardListModel> data_0 = new Data<com.anfelisa.card.models.CardListModel>(uuid);
		data_0.setModel(model_0);
		HttpResponse<com.anfelisa.card.data.GetCardsResponse> response = 
		this.httpGet(
			"/cards?categoryId=" + (data_0.getModel().getCategoryId() != null ? URLEncoder.encode(data_0.getModel().getCategoryId(), StandardCharsets.UTF_8.toString()) : "") + "&filterNonScheduled=" + data_0.getModel().getFilterNonScheduled() + "&priority=" + data_0.getModel().getPriority() + "&reverse=" + data_0.getModel().getReverse() + "", 
			authorization("Annette-${testId}", "password"),
			uuid,
	...
	private com.anfelisa.card.data.GetCardsResponse then_0(HttpResponse<com.anfelisa.card.data.GetCardsResponse> response) throws Exception {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetCardsFilterIsNull")) {
			
				HttpResponse<com.anfelisa.card.data.GetCardsResponse> response_0 = when_0();
				com.anfelisa.card.data.GetCardsResponse actualResponse_0 = then_0(response_0);
				
		
		} else {
			LOG.info("WHEN: prerequisite for GetCardsFilterIsNull not met");
		}
