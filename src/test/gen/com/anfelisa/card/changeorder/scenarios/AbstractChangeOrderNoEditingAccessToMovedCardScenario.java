...
public abstract class AbstractChangeOrderNoEditingAccessToMovedCardScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractChangeOrderNoEditingAccessToMovedCardScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ChangeOrderNoEditingAccessToMovedCard")) {
			...
			LOG.info("WHEN: prerequisite for ChangeOrderNoEditingAccessToMovedCard not met");
		}
	...
	protected String scenarioName() {
		return "ChangeOrderNoEditingAccessToMovedCard";
	}
