...
public abstract class AbstractNoMoveDownScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractNoMoveDownScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("NoMoveDown")) {
			...
			LOG.info("WHEN: prerequisite for NoMoveDown not met");
		}
