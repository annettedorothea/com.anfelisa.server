...
public abstract class AbstractChangeOrderFifthToFirstScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractChangeOrderFifthToFirstScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ChangeOrderFifthToFirst")) {
			...
			LOG.info("WHEN: prerequisite for ChangeOrderFifthToFirst not met");
		}
	}
	...
	protected String scenarioName() {
		return "ChangeOrderFifthToFirst";
	}
