...
public abstract class AbstractChangeOrderNoEditingAccessToTargetCardScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractChangeOrderNoEditingAccessToTargetCardScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("RegisterTwoUsers")) {
			...
			com.anfelisa.user.data.RegisterUserPayload payload_8 = objectMapper.readValue("{" +
				...
				"\"username\" : \"Anne-" + this.getTestId() + "\"} ",
					com.anfelisa.user.data.RegisterUserPayload.class);
			com.anfelisa.user.models.UserRegistrationModel model_8 = objectMapper.readValue("{" +
				"\"email\" : \"info@anfelisa.de\"," + 
				"\"language\" : \"de\"," + 
				"\"password\" : \"pw\"," + 
				"\"username\" : \"Anne-" + this.getTestId() + "\"} ", com.anfelisa.user.models.UserRegistrationModel.class);
			Data<com.anfelisa.user.models.UserRegistrationModel> data_8 = new Data<com.anfelisa.user.models.UserRegistrationModel>(uuid);
			...
			if (response_8.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: RegisterTwoUsers fails due to {} in {} ms", message, response_8.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: RegisterTwoUsers success in {} ms", response_8.getDuration());
			addToMetrics("RegisterUser", response_8.getDuration());
		} else {
		...
		if (prerequisite("InviteUserToCategory")) {
			...
			com.anfelisa.category.data.InviteUserToCategoryPayload payload_9 = objectMapper.readValue("{" +
				"\"categoryId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"invitedUsername\" : \"Anne-" + this.getTestId() + "\"," + 
				"\"editable\" : false} ",
					com.anfelisa.category.data.InviteUserToCategoryPayload.class);
			com.anfelisa.category.models.UserToCategoryInvitationModel model_9 = objectMapper.readValue("{" +
				"\"categoryId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"invitedUsername\" : \"Anne-" + this.getTestId() + "\"," + 
				"\"editable\" : false} ", com.anfelisa.category.models.UserToCategoryInvitationModel.class);
			Data<com.anfelisa.category.models.UserToCategoryInvitationModel> data_9 = new Data<com.anfelisa.category.models.UserToCategoryInvitationModel>(uuid);
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: InviteUserToCategory fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: InviteUserToCategory success in {} ms", response_9.getDuration());
			addToMetrics("InviteUserToCategory", response_9.getDuration());
		} else {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ChangeOrderNoEditingAccessToTargetCard")) {
			...
			LOG.info("WHEN: prerequisite for ChangeOrderNoEditingAccessToTargetCard not met");
		}
	...
	private void fifthCard() throws Exception {
		com.anfelisa.card.models.CardModel actual = daoProvider.getCardDao().selectByPrimaryKey(handle, "c5-" + this.getTestId() + "");
	...
	protected String scenarioName() {
		return "ChangeOrderNoEditingAccessToTargetCard";
	}
