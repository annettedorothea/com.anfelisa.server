...
public abstract class AbstractChangeOrderTargetCardDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callChangeOrder(randomUUID(), new ArrayList<>(Arrays.asList(new String[] { "c2", "c4" })), 
		this.templateStringValue("xx", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
