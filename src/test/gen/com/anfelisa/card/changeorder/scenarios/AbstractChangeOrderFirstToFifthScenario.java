...
public abstract class AbstractChangeOrderFirstToFifthScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callChangeOrder(randomUUID(), new ArrayList<>(Arrays.asList(new String[] { "c1" })), 
		this.templateStringValue("c5", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 200);
				...
				@Test
				public void changeOrderFirstToFifth() throws Exception {
					given();
