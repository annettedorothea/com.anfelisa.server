...
public abstract class AbstractChangeOrderNoAccessToTargetCardScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.card.ActionCalls.callChangeOrder(randomUUID(), new ArrayList<>(Arrays.asList(new String[] { "c2" })), 
		this.templateStringValue("c6", 0), DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
