...
public abstract class AbstractInitMyBoxesForDayWithScoredAndReinforceCardsScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		NotReplayableDataProvider.setSystemTime(DateTime.parse("20200418 16:30", DateTimeFormat.forPattern("yyyyMMdd HH:mm")).withZone(DateTimeZone.UTC));
		com.anfelisa.box.data.ScoreCardTestData scoreCard10 = new com.anfelisa.box.data.ScoreCardTestData("score1");
		...
		NotReplayableDataProvider.setSystemTime(DateTime.parse("20200418 16:30", DateTimeFormat.forPattern("yyyyMMdd HH:mm")).withZone(DateTimeZone.UTC));
		com.anfelisa.box.data.ScoreCardTestData scoreCard11 = new com.anfelisa.box.data.ScoreCardTestData("score5");
	...
	private Response when() throws Exception {
		com.anfelisa.box.data.InitMyBoxesDataTestData initMyBoxesForDay0 = new com.anfelisa.box.data.InitMyBoxesDataTestData(randomUUID());
		initMyBoxesForDay0.setToday(DateTime.parse("20200516 13:30", DateTimeFormat.forPattern("yyyyMMdd HH:mm")).withZone(DateTimeZone.UTC).toString());
		
		
		return 
		com.anfelisa.box.ActionCalls.callInitMyBoxesForDay(initMyBoxesForDay0, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
