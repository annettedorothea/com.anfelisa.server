...
public abstract class AbstractInitMyBoxesForDayNothingScoredScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		com.anfelisa.box.data.InitMyBoxesDataData initMyBoxesForDay0 = new com.anfelisa.box.data.InitMyBoxesDataData(randomUUID());
		initMyBoxesForDay0.setToday(DateTime.parse("20200416 13:30", DateTimeFormat.forPattern("yyyyMMdd HH:mm")).withZone(DateTimeZone.UTC));
