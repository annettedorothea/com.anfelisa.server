...
public abstract class AbstractInitMyBoxesForDayNothingScoredMuchLaterScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.InitMyBoxesDataData data_0 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
				"\"todayAtMidnightInUTC\" : \"2020-07-19T00:00:00.000Z\"} ",
			...
			assertFail(message);
				...
				public void initMyBoxesForDayNothingScoredMuchLater() throws Exception {
					...
					if (prerequisite("InitMyBoxesForDayNothingScoredMuchLater")) {
						...
						LOG.info("prerequisite for InitMyBoxesForDayNothingScoredMuchLater not met");
					}
				}
				...
				protected String scenarioName() {
					return "InitMyBoxesForDayNothingScoredMuchLater";
				}
