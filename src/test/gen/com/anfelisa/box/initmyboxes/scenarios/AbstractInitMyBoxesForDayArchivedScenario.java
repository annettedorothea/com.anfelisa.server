...
public abstract class AbstractInitMyBoxesForDayArchivedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInitMyBoxesForDayArchivedScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("ArchiveBox")) {
			...
			com.anfelisa.box.data.ArchiveBoxPayload payload_9 = objectMapper.readValue("{" +
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"archived\" : true} ",
					com.anfelisa.box.data.ArchiveBoxPayload.class);
			com.anfelisa.box.models.BoxArchiveModel model_9 = objectMapper.readValue("{" +
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"archived\" : true} ", com.anfelisa.box.models.BoxArchiveModel.class);
			Data<com.anfelisa.box.models.BoxArchiveModel> data_9 = new Data<com.anfelisa.box.models.BoxArchiveModel>(uuid);
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ArchiveBox fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ArchiveBox success in {} ms", response_9.getDuration());
			addToMetrics("ArchiveBox", response_9.getDuration());
		} else {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.InitMyBoxesDataModel model_0 = objectMapper.readValue("{" +
			"\"todayAtMidnightInUTC\" : \"2021-01-20T02:00\"} ", com.anfelisa.box.models.InitMyBoxesDataModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("InitMyBoxesForDayArchived")) {
			...
			LOG.info("WHEN: prerequisite for InitMyBoxesForDayArchived not met");
		}
	...
	protected String scenarioName() {
		return "InitMyBoxesForDayArchived";
	}
