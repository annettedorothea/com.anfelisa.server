	...
	private void given() throws Exception {
		...
		if (prerequisite("RegisterUser")) {
			...
			if (response_9.getStatusCode() >= 400) {
				...
				String message = "GIVEN RegisterUser fails\n" + statusMessage;
				LOG.error("GIVEN: RegisterUser fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: RegisterUser success in {} ms", response_9.getDuration());
		...
		if (prerequisite("CreateBoxMinimal")) {
			uuid = "boxId-" + this.getTestId() + "";
			com.anfelisa.box.data.CreateBoxPayload payload_10 = objectMapper.readValue("{" +
				"\"categoryName\" : \"cat\"," + 
				"\"dictionaryLookup\" : false," + 
				"\"maxCardsPerDay\" : 10} ",
					com.anfelisa.box.data.CreateBoxPayload.class);
			...
			if (response_10.getStatusCode() >= 400) {
				...
				String message = "GIVEN CreateBoxMinimal fails\n" + statusMessage;
				LOG.error("GIVEN: CreateBoxMinimal fails due to {} in {} ms", message, response_10.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateBoxMinimal success in {} ms", response_10.getDuration());
			addToMetrics("CreateBox", response_10.getDuration());
		} else {
			LOG.info("GIVEN: prerequisite for CreateBoxMinimal not met");
		}
		...
		if (prerequisite("ArchiveBox")) {
			...
			com.anfelisa.box.data.ArchiveBoxPayload payload_11 = objectMapper.readValue("{" +
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"archived\" : true} ",
					com.anfelisa.box.data.ArchiveBoxPayload.class);
			com.anfelisa.box.data.BoxArchiveData data_11 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"archived\" : true} ",
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ArchiveBox fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ArchiveBox success in {} ms", response_11.getDuration());
			addToMetrics("ArchiveBox", response_11.getDuration());
		} else {
