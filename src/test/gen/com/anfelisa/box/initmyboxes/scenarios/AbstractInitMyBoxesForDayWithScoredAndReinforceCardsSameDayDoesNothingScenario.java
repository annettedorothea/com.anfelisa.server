...
public abstract class AbstractInitMyBoxesForDayWithScoredAndReinforceCardsSameDayDoesNothingScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractInitMyBoxesForDayWithScoredAndReinforceCardsSameDayDoesNothingScenario.class);
			...
			assertFail(message);
				...
				public void initMyBoxesForDayWithScoredAndReinforceCardsSameDayDoesNothing() throws Exception {
					if (prerequisite("InitMyBoxesForDayWithScoredAndReinforceCardsSameDayDoesNothing")) {
						...
						LOG.info("prerequisite for InitMyBoxesForDayWithScoredAndReinforceCardsSameDayDoesNothing not met");
					}
				}
