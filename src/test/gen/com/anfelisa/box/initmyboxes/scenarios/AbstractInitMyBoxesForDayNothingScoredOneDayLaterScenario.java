...
public abstract class AbstractInitMyBoxesForDayNothingScoredOneDayLaterScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractInitMyBoxesForDayNothingScoredOneDayLaterScenario.class);
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void initMyBoxesForDayNothingScoredOneDayLater() throws Exception {
					given();
						
					if (prerequisite("InitMyBoxesForDayNothingScoredOneDayLater")) {
						...
						LOG.info("prerequisite for InitMyBoxesForDayNothingScoredOneDayLater not met");
					}
				}
				...
				protected String scenarioName() {
					return "InitMyBoxesForDayNothingScoredOneDayLater";
				}
