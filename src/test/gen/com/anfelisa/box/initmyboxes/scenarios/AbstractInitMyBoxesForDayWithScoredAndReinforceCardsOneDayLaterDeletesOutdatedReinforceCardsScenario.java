...
public abstract class AbstractInitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCardsScenario extends BaseScenario {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.InitMyBoxesDataModel model_0 = objectMapper.readValue("{" +
			"\"todayAtMidnightInUTC\" : \"2020-04-19T02:00\"} ", com.anfelisa.box.models.InitMyBoxesDataModel.class);
		Data<com.anfelisa.box.models.InitMyBoxesDataModel> data_0 = new Data<com.anfelisa.box.models.InitMyBoxesDataModel>(uuid);
		data_0.setModel(model_0);
		...
		LOG.info("WHEN: InitMyBoxesForDay finished in {} ms", response.getDuration());
		if (response.getStatusCode() >= 200 && response.getStatusCode() < 300) {
			addToMetrics("InitMyBoxesForDay", response.getDuration());
		}
		return response;
	}
	...
	private void noChangeForCard4() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score5-" + this.getTestId() + "");
