...
public abstract class AbstractInitMyBoxesForDayNothingScoredVeryMuchLaterScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractInitMyBoxesForDayNothingScoredVeryMuchLaterScenario.class);
			...
			assertFail(message);
				...
				public void initMyBoxesForDayNothingScoredVeryMuchLater() throws Exception {
					...
					if (prerequisite("InitMyBoxesForDayNothingScoredVeryMuchLater")) {
						...
						LOG.info("prerequisite for InitMyBoxesForDayNothingScoredVeryMuchLater not met");
					}
				}
