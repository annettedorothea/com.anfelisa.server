...
public abstract class AbstractScheduleCardsCombineIdsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScheduleCardsCombineIdsScenario.class);
			...
			assertFail(message);
				...
				public void scheduleCardsCombineIds() throws Exception {
					if (prerequisite("ScheduleCardsCombineIds")) {
						...
						LOG.info("prerequisite for ScheduleCardsCombineIds not met");
					}
				}
				...
				protected String scenarioName() {
					return "ScheduleCardsCombineIds";
				}
