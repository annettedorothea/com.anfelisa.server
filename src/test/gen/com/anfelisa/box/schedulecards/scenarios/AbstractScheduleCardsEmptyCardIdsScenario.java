...
public abstract class AbstractScheduleCardsEmptyCardIdsScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScheduleCardsEmptyCardIdsScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "sc1-empty-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScheduleCardsEmptyCardIds")) {
	...
	protected String scenarioName() {
		return "ScheduleCardsEmptyCardIds";
	}
