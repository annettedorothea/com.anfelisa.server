...
public abstract class AbstractScheduleCardsUnauthorizedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScheduleCardsUnauthorizedScenario.class);
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 401) {
			...
			assertFail(message);
				...
				@Test
				public void scheduleCardsUnauthorized() throws Exception {
					given();
					...
					if (prerequisite("ScheduleCardsUnauthorized")) {
						...
						LOG.info("prerequisite for ScheduleCardsUnauthorized not met");
					}
				}
