...
public abstract class AbstractScheduleSortedOutCardScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("SortCardsOutWithScoredAndReinforce")) {
			...
			com.anfelisa.box.data.SortCardsOutPayload payload_11 = objectMapper.readValue("{" +
				"\"cardIds\" : [ \"c1-" + this.getTestId() + "\"," + 
				"\"c4-" + this.getTestId() + "\"]," + 
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ",
					com.anfelisa.box.data.SortCardsOutPayload.class);
			com.anfelisa.box.models.SortCardsOutModel model_11 = objectMapper.readValue("{" +
				"\"cardIds\" : [ \"c1-" + this.getTestId() + "\"," + 
				"\"c4-" + this.getTestId() + "\"]," + 
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ", com.anfelisa.box.models.SortCardsOutModel.class);
			Data<com.anfelisa.box.models.SortCardsOutModel> data_11 = new Data<com.anfelisa.box.models.SortCardsOutModel>(uuid);
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: SortCardsOutWithScoredAndReinforce fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: SortCardsOutWithScoredAndReinforce success in {} ms", response_11.getDuration());
			addToMetrics("SortCardsOut", response_11.getDuration());
		} else {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200420 09:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
