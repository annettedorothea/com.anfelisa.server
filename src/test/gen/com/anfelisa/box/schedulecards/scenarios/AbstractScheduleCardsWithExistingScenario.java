...
public abstract class AbstractScheduleCardsWithExistingScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScheduleCardsWithExistingScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "s12-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScheduleCardsWithExisting")) {
	...
	private void card1NoChange() throws Exception {
		...
		LOG.info("THEN: card1NoChange passed");
	}
	private void card3NoChange() throws Exception {
		...
		LOG.info("THEN: card3NoChange passed");
	}
	private void card4NoChange() throws Exception {
		...
		LOG.info("THEN: card4NoChange passed");
	}
	private void card2WasScheduled() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c2-" + this.getTestId() + "-s12-" + this.getTestId() + "");
		
		com.anfelisa.box.models.IScheduledCardModel expected = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"cardId\" : \"c2-" + this.getTestId() + "\"," + 
				"\"count\" : 0," + 
				"\"createdDate\" : \"2020-04-19T12:20\"," + 
				"\"ef\" : \"2.5F\"," + 
				"\"interval\" : 1," + 
				"\"lastQuality\" : null," + 
				"\"n\" : 1," + 
				"\"quality\" : null," + 
				"\"scheduledCardId\" : \"c2-" + this.getTestId() + "-s12-" + this.getTestId() + "\"," + 
				"\"scheduledDate\" : \"2020-04-19T12:20\"," + 
				"\"scoredDate\" : null} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);

		LOG.info("THEN: card2WasScheduled passed");
	}
	private void card5WasScheduled() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c5-" + this.getTestId() + "-s12-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.IScheduledCardModel expected = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				...
				"\"n\" : 1," + 
				"\"quality\" : null," + 
				"\"scheduledCardId\" : \"c5-" + this.getTestId() + "-s12-" + this.getTestId() + "\"," + 
				"\"scheduledDate\" : \"2020-04-19T12:20\"," + 
				"\"scoredDate\" : null} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);

		LOG.info("THEN: card5WasScheduled passed");
	}
	
	@Override
	protected String scenarioName() {
		return "ScheduleCardsWithExisting";
	}
