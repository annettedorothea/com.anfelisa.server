...
public abstract class AbstractScheduleCardsWithExistingScenario extends BaseScenario {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.data.ScheduleCardsPayload payload_0 = objectMapper.readValue("{" +
			...
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ",
				com.anfelisa.box.data.ScheduleCardsPayload.class);
		com.anfelisa.box.models.ScheduledCardsModel model_0 = objectMapper.readValue("{" +
			"\"cardIds\" : [ \"c2-" + this.getTestId() + "\"," + 
			"\"c5-" + this.getTestId() + "\"]," + 
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScheduledCardsModel.class);
		Data<com.anfelisa.box.models.ScheduledCardsModel> data_0 = new Data<com.anfelisa.box.models.ScheduledCardsModel>(uuid);
		data_0.setModel(model_0);
	...
	private void card2WasScheduled() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c2-" + this.getTestId() + "-s12-" + this.getTestId() + "");
	...
	private void card5WasScheduled() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c5-" + this.getTestId() + "-s12-" + this.getTestId() + "");
