...
public abstract class AbstractScheduleCardsWithExistingScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		String uuid = "s12-${testId}".replace("${testId}", this.getTestId());
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void scheduleCardsWithExisting() throws Exception {
					given();
					...
					if (prerequisite("ScheduleCardsWithExisting")) {
						...
						LOG.info("prerequisite for ScheduleCardsWithExisting not met");
					}
				}
