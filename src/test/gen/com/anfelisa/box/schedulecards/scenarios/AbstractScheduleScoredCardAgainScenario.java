...
public abstract class AbstractScheduleScoredCardAgainScenario extends BaseScenario {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200418 17:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
	...
	private void anotherScheduledCardWasNotCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "again-" + this.getTestId() + "");
