...
public abstract class AbstractScheduleSortedOutCardsWithMultipleScoresScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("SortCardsOut")) {
			...
			if (response_20.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: SortCardsOut fails due to {} in {} ms", message, response_20.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: SortCardsOut success in {} ms", response_20.getDuration());
			addToMetrics("SortCardsOut", response_20.getDuration());
		} else {
	...
	private HttpResponse<Object> when() throws Exception {
		...
		this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20220318 10:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
