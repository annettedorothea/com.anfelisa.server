...
public abstract class AbstractScheduleCardsScenario extends BaseScenario {
	...
	private void card2WasNotScheduled() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c2-" + this.getTestId() + "-sc1-" + this.getTestId() + "");
	...
	private void card5WasNotScheduled() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c5-" + this.getTestId() + "-sc1-" + this.getTestId() + "");
