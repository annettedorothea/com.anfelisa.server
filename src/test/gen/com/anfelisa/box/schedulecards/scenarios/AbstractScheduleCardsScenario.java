...
public abstract class AbstractScheduleCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScheduleCardsScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "sc1-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScheduleCards")) {
			...
			this.card1WasScheduled();
			this.card3WasScheduled();
			this.card4WasScheduled();
	...
	private void card1WasScheduled() throws Exception {
		...
		LOG.info("THEN: card1WasScheduled passed");
	}
	private void card3WasScheduled() throws Exception {
		...
		LOG.info("THEN: card3WasScheduled passed");
	}
	private void card4WasScheduled() throws Exception {
		...
		LOG.info("THEN: card4WasScheduled passed");
	}
