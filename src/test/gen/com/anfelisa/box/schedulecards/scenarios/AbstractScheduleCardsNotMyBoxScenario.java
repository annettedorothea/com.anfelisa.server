...
public abstract class AbstractScheduleCardsNotMyBoxScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		return 
		com.anfelisa.box.ActionCalls.callScheduleCards(scheduleCards0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
