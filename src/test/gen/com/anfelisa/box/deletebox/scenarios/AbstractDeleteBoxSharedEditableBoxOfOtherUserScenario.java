...
public abstract class AbstractDeleteBoxSharedEditableBoxOfOtherUserScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteBoxSharedEditableBoxOfOtherUserScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DeleteBoxSharedEditableBoxOfOtherUser")) {
			...
			LOG.info("WHEN: prerequisite for DeleteBoxSharedEditableBoxOfOtherUser not met");
		}
	...
	protected String scenarioName() {
		return "DeleteBoxSharedEditableBoxOfOtherUser";
	}
