...
public abstract class AbstractDeleteBoxHasReverseBoxScenario extends BaseScenario {
	...
	private void accessToCategoryWasDeleted() throws Exception {
		com.anfelisa.category.models.UserAccessToCategoryModel actual = daoProvider.getUserAccessToCategoryDao().selectByPrimaryKey(handle, "reverseBoxId-" + this.getTestId() + "", "uuid2-" + this.getTestId() + "");
