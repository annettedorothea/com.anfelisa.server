...
public abstract class AbstractDeleteBoxCascadesAllScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreCardAsAdmin")) {
			uuid = "admin-score".replace("${testId}", this.getTestId());
			...
			LOG.info("GIVEN: ScoreCardAsAdmin");
		} else {
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void deleteBoxCascadesAll() throws Exception {
					given();
					...
					if (prerequisite("DeleteBoxCascadesAll")) {
						...
						LOG.info("prerequisite for DeleteBoxCascadesAll not met");
					}
				}
