...
public abstract class AbstractDeleteBoxNotMyCategoryScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteBoxNotMyCategoryScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.DeleteBoxModel model_0 = objectMapper.readValue("{" +
			"\"boxId\" : \"boxIdOfInvitedUser-" + this.getTestId() + "\"} ", com.anfelisa.box.models.DeleteBoxModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DeleteBoxNotMyCategory")) {
			...
			LOG.info("WHEN: prerequisite for DeleteBoxNotMyCategory not met");
		}
	...
	private void accessToCategoryWasDeleted() throws Exception {
		com.anfelisa.category.models.UserAccessToCategoryModel actual = daoProvider.getUserAccessToCategoryDao().selectByPrimaryKey(handle, "boxIdOfInvitedUser-" + this.getTestId() + "", "uuid2-" + this.getTestId() + "");
	...
	private void cardsWereNotDeleted() throws Exception {
		Map<String, String> filterMap = new HashMap<String, String>();
		filterMap.put("rootCategoryId", "boxId-" + this.getTestId() + "");
