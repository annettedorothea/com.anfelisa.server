...
public abstract class AbstractDeleteBoxUnauthorizedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteBoxUnauthorizedScenario.class);
	...
	private Response when() throws Exception {
		...
		return 
		com.anfelisa.box.ActionCalls.callDeleteBox(objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ",
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 401) {
			...
			assertFail(message);
				...
				@Test
				public void deleteBoxUnauthorized() throws Exception {
					given();
						
					if (prerequisite("DeleteBoxUnauthorized")) {
						...
						LOG.info("prerequisite for DeleteBoxUnauthorized not met");
					}
				}
