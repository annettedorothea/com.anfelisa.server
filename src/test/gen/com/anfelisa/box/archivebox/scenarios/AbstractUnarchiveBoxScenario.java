...
public abstract class AbstractUnarchiveBoxScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractUnarchiveBoxScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.BoxArchiveModel model_0 = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"archived\" : false} ", com.anfelisa.box.models.BoxArchiveModel.class);
		Data<com.anfelisa.box.models.BoxArchiveModel> data_0 = new Data<com.anfelisa.box.models.BoxArchiveModel>(uuid);
		data_0.setModel(model_0);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("UnarchiveBox")) {
			...
			LOG.info("WHEN: prerequisite for UnarchiveBox not met");
		}
	...
	private void boxWasArchived() throws Exception {
		...
		LOG.info("THEN: boxWasArchived passed");
	}
