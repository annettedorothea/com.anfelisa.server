...
public abstract class AbstractArchiveBoxScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractArchiveBoxScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ArchiveBox")) {
			...
			LOG.info("WHEN: prerequisite for ArchiveBox not met");
		}
