...
public abstract class AbstractGetBoxesSharedBoxOfOtherUserScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesSharedBoxOfOtherUserScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesSharedBoxOfOtherUser")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxesSharedBoxOfOtherUser not met");
		}
	...
	protected String scenarioName() {
		return "GetBoxesSharedBoxOfOtherUser";
	}
