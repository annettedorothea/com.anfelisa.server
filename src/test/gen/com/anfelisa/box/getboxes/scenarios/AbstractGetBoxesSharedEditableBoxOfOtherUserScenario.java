...
public abstract class AbstractGetBoxesSharedEditableBoxOfOtherUserScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesSharedEditableBoxOfOtherUserScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesSharedEditableBoxOfOtherUser")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxesSharedEditableBoxOfOtherUser not met");
		}
	...
	protected String scenarioName() {
		return "GetBoxesSharedEditableBoxOfOtherUser";
	}
