...
public abstract class AbstractGetBoxesWithOneScoredCard0AndReinforceSameDayScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesWithOneScoredCard0AndReinforceSameDayScenario.class);
	...
	private com.anfelisa.box.data.GetBoxesResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void getBoxesWithOneScoredCard0AndReinforceSameDay() throws Exception {
					given();
					...
					if (prerequisite("GetBoxesWithOneScoredCard0AndReinforceSameDay")) {
						...
						LOG.info("prerequisite for GetBoxesWithOneScoredCard0AndReinforceSameDay not met");
					}
				}
