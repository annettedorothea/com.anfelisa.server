...
public abstract class AbstractGetBoxesTwoDaysLaterScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("InitMyBoxesForDayWithScoredAndReinforceCardsTwoDaysLaterPostponesCards")) {
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsTwoDaysLaterPostponesCards fails due to {} in {} ms", message, (timeAfterRequest-timeBeforeRequest));
				addToMetrics("InitMyBoxesForDay", (timeAfterRequest-timeBeforeRequest));
				assertFail(message);
			}
			LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsTwoDaysLaterPostponesCards success in {} ms", (timeAfterRequest-timeBeforeRequest));
			addToMetrics("InitMyBoxesForDay", (timeAfterRequest-timeBeforeRequest));
		} else {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesTwoDaysLater")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxesTwoDaysLater not met");
		}
	}
