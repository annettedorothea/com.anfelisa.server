	...
	private void given() throws Exception {
		...
		if (prerequisite("InitMyBoxesForDayWithScoredAndReinforceCardsTwoDaysLaterPostponesCards")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsTwoDaysLaterPostponesCards fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsTwoDaysLaterPostponesCards success in {} ms", response_12.getDuration());
