	...
	private void given() throws Exception {
		...
		if (prerequisite("RegisterUser")) {
			...
			if (response_3.getStatusCode() >= 400) {
				...
				String message = "GIVEN RegisterUser fails\n" + statusMessage;
				LOG.error("GIVEN: RegisterUser fails due to {} in {} ms", message, response_3.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: RegisterUser success in {} ms", response_3.getDuration());
		...
		if (prerequisite("CreateBoxMinimal")) {
			uuid = "boxId-" + this.getTestId() + "";
			com.anfelisa.box.data.CreateBoxPayload payload_4 = objectMapper.readValue("{" +
				"\"categoryName\" : \"cat\"," + 
				"\"dictionaryLookup\" : false," + 
				"\"maxCardsPerDay\" : 10} ",
					com.anfelisa.box.data.CreateBoxPayload.class);
			com.anfelisa.box.data.BoxCreationData data_4 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
			"\"categoryName\" : \"cat\"," + 
			"\"dictionaryLookup\" : false," + 
			"\"maxCardsPerDay\" : 10} ",
			...
			if (response_4.getStatusCode() >= 400) {
				...
				String message = "GIVEN CreateBoxMinimal fails\n" + statusMessage;
				LOG.error("GIVEN: CreateBoxMinimal fails due to {} in {} ms", message, response_4.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: CreateBoxMinimal success in {} ms", response_4.getDuration());
			addToMetrics("CreateBox", response_4.getDuration());
		} else {
			LOG.info("GIVEN: prerequisite for CreateBoxMinimal not met");
		}
		...
		if (prerequisite("ArchiveBox")) {
			...
			com.anfelisa.box.data.ArchiveBoxPayload payload_5 = objectMapper.readValue("{" +
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"archived\" : true} ",
					com.anfelisa.box.data.ArchiveBoxPayload.class);
			com.anfelisa.box.data.BoxArchiveData data_5 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"archived\" : true} ",
			...
			if (response_5.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ArchiveBox fails due to {} in {} ms", message, response_5.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ArchiveBox success in {} ms", response_5.getDuration());
			addToMetrics("ArchiveBox", response_5.getDuration());
		} else {
