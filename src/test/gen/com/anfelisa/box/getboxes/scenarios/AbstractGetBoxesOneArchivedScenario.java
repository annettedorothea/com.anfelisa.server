...
public abstract class AbstractGetBoxesOneArchivedScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("ArchiveBox")) {
			...
			com.anfelisa.box.models.BoxArchiveModel model_3 = objectMapper.readValue("{" +
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"archived\" : true} ", com.anfelisa.box.models.BoxArchiveModel.class);
			Data<com.anfelisa.box.models.BoxArchiveModel> data_3 = new Data<com.anfelisa.box.models.BoxArchiveModel>(uuid);
