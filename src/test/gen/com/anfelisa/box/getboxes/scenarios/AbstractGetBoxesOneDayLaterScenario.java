...
public abstract class AbstractGetBoxesOneDayLaterScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesOneDayLaterScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards")) {
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards fails due to {} in {} ms", message, (timeAfterRequest-timeBeforeRequest));
				addToMetrics("InitMyBoxesForDay", (timeAfterRequest-timeBeforeRequest));
				assertFail(message);
			}
			LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards success in {} ms", (timeAfterRequest-timeBeforeRequest));
			addToMetrics("InitMyBoxesForDay", (timeAfterRequest-timeBeforeRequest));
		} else {
