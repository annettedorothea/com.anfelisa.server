...
public abstract class AbstractLoadNextCardSortedOutScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardSortedOutScenario.class);
			...
			return actual;
				...
				public void loadNextCardSortedOut() throws Exception {
					...
					if (prerequisite("LoadNextCardSortedOut")) {
						...
						LOG.info("prerequisite for LoadNextCardSortedOut not met");
					}
				}
