...
public abstract class AbstractLoadNextCardScored3Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardScored3Scenario.class);
	...
	private com.anfelisa.box.data.LoadNextCardResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void loadNextCardScored3() throws Exception {
					given();
						
					if (prerequisite("LoadNextCardScored3")) {
						...
						LOG.info("WHEN: prerequisite for LoadNextCardScored3 not met");
					}
				}
