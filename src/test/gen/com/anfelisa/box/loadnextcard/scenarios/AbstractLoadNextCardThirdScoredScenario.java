...
public abstract class AbstractLoadNextCardThirdScoredScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardThirdScoredScenario.class);
	...
	private com.anfelisa.box.data.LoadNextCardResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void loadNextCardThirdScored() throws Exception {
					given();
						
					if (prerequisite("LoadNextCardThirdScored")) {
						...
						LOG.info("prerequisite for LoadNextCardThirdScored not met");
					}
				}
				...
				protected String scenarioName() {
					return "LoadNextCardThirdScored";
				}
