...
public abstract class AbstractLoadNextCardNoCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardNoCardsScenario.class);
	...
	private com.anfelisa.box.data.LoadNextCardResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void loadNextCardNoCards() throws Exception {
					given();
						
					if (prerequisite("LoadNextCardNoCards")) {
						...
						LOG.info("WHEN: prerequisite for LoadNextCardNoCards not met");
					}
				}
