	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard1")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ScoreReinforceCard1 fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard1 success in {} ms", response_12.getDuration());
