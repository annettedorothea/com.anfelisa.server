	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard1")) {
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: ScoreReinforceCard1 fails due to {} in {} ms", message, (timeAfterRequest-timeBeforeRequest));
				addToMetrics("ScoreReinforceCard", (timeAfterRequest-timeBeforeRequest));
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard1 success in {} ms", (timeAfterRequest-timeBeforeRequest));
			addToMetrics("ScoreReinforceCard", (timeAfterRequest-timeBeforeRequest));
		} else {
