...
public abstract class AbstractLoadNextCardReinforceScored3Scenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard3")) {
			...
			LOG.info("GIVEN: ScoreReinforceCard3");
		} else {
	...
	private com.anfelisa.box.data.LoadNextCardResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void loadNextCardReinforceScored3() throws Exception {
					if (prerequisite("LoadNextCardReinforceScored3")) {
						given();
						...
						LOG.info("prerequisite for LoadNextCardReinforceScored3 not met");
					}
				}
				...
				protected String scenarioName() {
					return "LoadNextCardReinforceScored3";
				}
