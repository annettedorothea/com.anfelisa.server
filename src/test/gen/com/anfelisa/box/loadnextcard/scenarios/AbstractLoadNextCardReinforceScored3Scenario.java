	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard3")) {
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: ScoreReinforceCard3 fails due to " + message);
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard3 success");
		} else {
			...
			return actual;
				...
				public void loadNextCardReinforceScored3() throws Exception {
					...
					if (prerequisite("LoadNextCardReinforceScored3")) {
						...
						LOG.info("WHEN: prerequisite for LoadNextCardReinforceScored3 not met");
					}
				}
