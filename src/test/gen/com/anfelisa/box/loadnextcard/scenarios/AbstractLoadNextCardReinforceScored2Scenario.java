	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard2")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ScoreReinforceCard2 fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard2 success in {} ms", response_12.getDuration());
