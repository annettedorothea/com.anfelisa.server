...
public abstract class AbstractLoadNextCardFinished5Scenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreCard1")) {
			...
			com.anfelisa.box.data.ScoreCardPayload payload_10 = objectMapper.readValue("{" +
				...
				"\"scheduledCardId\" : \"c3-" + this.getTestId() + "-sc1-" + this.getTestId() + "\"} ",
					com.anfelisa.box.data.ScoreCardPayload.class);
			com.anfelisa.box.models.ScoreCardModel model_10 = objectMapper.readValue("{" +
				"\"scoredCardQuality\" : 1," + 
				"\"scheduledCardId\" : \"c3-" + this.getTestId() + "-sc1-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreCardModel.class);
			Data<com.anfelisa.box.models.ScoreCardModel> data_10 = new Data<com.anfelisa.box.models.ScoreCardModel>(uuid);
		...
		if (prerequisite("ScoreCard5")) {
			...
			com.anfelisa.box.data.ScoreCardPayload payload_11 = objectMapper.readValue("{" +
				...
				"\"scheduledCardId\" : \"c4-" + this.getTestId() + "-sc1-" + this.getTestId() + "\"} ",
					com.anfelisa.box.data.ScoreCardPayload.class);
			com.anfelisa.box.models.ScoreCardModel model_11 = objectMapper.readValue("{" +
				"\"scoredCardQuality\" : 5," + 
				"\"scheduledCardId\" : \"c4-" + this.getTestId() + "-sc1-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreCardModel.class);
			Data<com.anfelisa.box.models.ScoreCardModel> data_11 = new Data<com.anfelisa.box.models.ScoreCardModel>(uuid);
		...
		if (prerequisite("ScoreReinforceCardKeep")) {
			...
			com.anfelisa.box.models.ScoreReinforceCardModel model_12 = objectMapper.readValue("{" +
				"\"keep\" : true," + 
				"\"reinforceCardId\" : \"score0-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreReinforceCardModel.class);
			Data<com.anfelisa.box.models.ScoreReinforceCardModel> data_12 = new Data<com.anfelisa.box.models.ScoreReinforceCardModel>(uuid);
		...
		if (prerequisite("ScoreOtherReinforceCard")) {
			...
			com.anfelisa.box.data.ScoreReinforceCardPayload payload_13 = objectMapper.readValue("{" +
				...
				"\"reinforceCardId\" : \"score1-" + this.getTestId() + "\"} ",
					com.anfelisa.box.data.ScoreReinforceCardPayload.class);
			com.anfelisa.box.models.ScoreReinforceCardModel model_13 = objectMapper.readValue("{" +
				"\"keep\" : false," + 
				"\"reinforceCardId\" : \"score1-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreReinforceCardModel.class);
			Data<com.anfelisa.box.models.ScoreReinforceCardModel> data_13 = new Data<com.anfelisa.box.models.ScoreReinforceCardModel>(uuid);
		...
		if (prerequisite("ScoreReinforceCardRemove")) {
			...
			com.anfelisa.box.data.ScoreReinforceCardPayload payload_14 = objectMapper.readValue("{" +
				...
				"\"reinforceCardId\" : \"score0-" + this.getTestId() + "\"} ",
					com.anfelisa.box.data.ScoreReinforceCardPayload.class);
			com.anfelisa.box.models.ScoreReinforceCardModel model_14 = objectMapper.readValue("{" +
				"\"keep\" : false," + 
				"\"reinforceCardId\" : \"score0-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreReinforceCardModel.class);
			Data<com.anfelisa.box.models.ScoreReinforceCardModel> data_14 = new Data<com.anfelisa.box.models.ScoreReinforceCardModel>(uuid);
	...
	private HttpResponse<com.anfelisa.box.data.LoadNextCardResponse> when_0() throws Exception {
		...
		com.anfelisa.box.models.NextCardModel model_0 = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"todayAtMidnightInUTC\" : \"2020-04-18T02:00\"} ", com.anfelisa.box.models.NextCardModel.class);
		Data<com.anfelisa.box.models.NextCardModel> data_0 = new Data<com.anfelisa.box.models.NextCardModel>(uuid);
		data_0.setModel(model_0);
		HttpResponse<com.anfelisa.box.data.LoadNextCardResponse> response = 
		this.httpGet(
			"/box/next-card?boxId=" + (data_0.getModel().getBoxId() != null ? URLEncoder.encode(data_0.getModel().getBoxId(), StandardCharsets.UTF_8.toString()) : "") + "&todayAtMidnightInUTC=" + data_0.getModel().getTodayAtMidnightInUTC() + "", 
			authorization("Annette-${testId}", "password"),
			uuid,
	...
	private com.anfelisa.box.data.LoadNextCardResponse then_0(HttpResponse<com.anfelisa.box.data.LoadNextCardResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.NextCardModel expectedData = objectMapper.readValue("{" +
				"\"allTodaysCards\" : 3," + 
				"\"openTodaysCards\" : 0," + 
				"\"reverse\" : false," + 
				"\"boxName\" : \"cat\"," + 
				"\"nextCard\" : null} ", com.anfelisa.box.models.NextCardModel.class);
