	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard0")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ScoreReinforceCard0 fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard0 success in {} ms", response_12.getDuration());
		...
		if (prerequisite("ScoreReinforceCard5")) {
			...
			if (response_14.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ScoreReinforceCard5 fails due to {} in {} ms", message, response_14.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard5 success in {} ms", response_14.getDuration());
