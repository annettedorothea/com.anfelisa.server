	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard0")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreReinforceCard0 fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreReinforceCard5")) {
			...
			if (response_14.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreReinforceCard5 fails due to {} in {} ms", message, response_14.getDuration());
				assertFail(message);
			}
			...
			LOG.info("THEN: status 200 passed");
				...
				if (response.getStatusCode() < 400) {
					try {
						...
						//readEntity(com.anfelisa.box.data.LoadNextCardResponse.class);
