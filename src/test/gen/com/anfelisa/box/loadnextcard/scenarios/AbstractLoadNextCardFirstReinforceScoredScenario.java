...
public abstract class AbstractLoadNextCardFirstReinforceScoredScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardFirstReinforceScoredScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadNextCardFirstReinforceScored")) {
	...
	protected String scenarioName() {
		return "LoadNextCardFirstReinforceScored";
	}
