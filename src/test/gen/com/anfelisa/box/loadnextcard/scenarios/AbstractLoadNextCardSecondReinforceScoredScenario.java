...
public abstract class AbstractLoadNextCardSecondReinforceScoredScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardSecondReinforceScoredScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadNextCardSecondReinforceScored")) {
