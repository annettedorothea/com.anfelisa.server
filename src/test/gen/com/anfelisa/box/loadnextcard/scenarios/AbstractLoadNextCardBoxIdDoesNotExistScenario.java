...
public abstract class AbstractLoadNextCardBoxIdDoesNotExistScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardBoxIdDoesNotExistScenario.class);
			...
			return actual;
				...
				public void loadNextCardBoxIdDoesNotExist() throws Exception {
					...
					if (prerequisite("LoadNextCardBoxIdDoesNotExist")) {
						...
						LOG.info("prerequisite for LoadNextCardBoxIdDoesNotExist not met");
					}
				}
