...
public abstract class AbstractLoadNextCardJustScheduledScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardJustScheduledScenario.class);
			...
			return actual;
				...
				public void loadNextCardJustScheduled() throws Exception {
					if (prerequisite("LoadNextCardJustScheduled")) {
						...
						LOG.info("prerequisite for LoadNextCardJustScheduled not met");
					}
				}
				...
				protected String scenarioName() {
					return "LoadNextCardJustScheduled";
				}
