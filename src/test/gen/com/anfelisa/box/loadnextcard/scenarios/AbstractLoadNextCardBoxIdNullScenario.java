...
public abstract class AbstractLoadNextCardBoxIdNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardBoxIdNullScenario.class);
			...
			return actual;
				...
				public void loadNextCardBoxIdNull() throws Exception {
					...
					if (prerequisite("LoadNextCardBoxIdNull")) {
						...
						LOG.info("prerequisite for LoadNextCardBoxIdNull not met");
					}
				}
