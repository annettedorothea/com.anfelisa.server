...
public abstract class AbstractLoadNextCardAllScoredNextDayScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards")) {
			...
			com.anfelisa.box.models.InitMyBoxesDataModel model_12 = objectMapper.readValue("{" +
				"\"todayAtMidnightInUTC\" : \"2020-04-19T02:00\"} ", com.anfelisa.box.models.InitMyBoxesDataModel.class);
			Data<com.anfelisa.box.models.InitMyBoxesDataModel> data_12 = new Data<com.anfelisa.box.models.InitMyBoxesDataModel>(uuid);
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards success in {} ms", response_12.getDuration());
			addToMetrics("InitMyBoxesForDay", response_12.getDuration());
		} else {
	...
	private HttpResponse<com.anfelisa.box.data.LoadNextCardResponse> when_0() throws Exception {
		...
		com.anfelisa.box.models.NextCardModel model_0 = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"todayAtMidnightInUTC\" : \"2020-04-19T04:00\"} ", com.anfelisa.box.models.NextCardModel.class);
	...
	private com.anfelisa.box.data.LoadNextCardResponse then_0(HttpResponse<com.anfelisa.box.data.LoadNextCardResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.NextCardModel expectedData = objectMapper.readValue("{" +
				...
				"\"wanted\" : \"wanted\"," + 
				"\"categoryName\" : \"level 1 #1\"," + 
				"\"lastQuality\" : 0}} ", com.anfelisa.box.models.NextCardModel.class);
