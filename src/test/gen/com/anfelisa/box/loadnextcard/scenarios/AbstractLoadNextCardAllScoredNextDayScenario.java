	...
	private void given() throws Exception {
		...
		if (prerequisite("InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: InitMyBoxesForDayWithScoredAndReinforceCardsOneDayLaterDeletesOutdatedReinforceCards fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
