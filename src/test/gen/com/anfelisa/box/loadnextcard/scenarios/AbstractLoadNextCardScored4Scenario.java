...
public abstract class AbstractLoadNextCardScored4Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardScored4Scenario.class);
	...
	private com.anfelisa.box.data.LoadNextCardResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void loadNextCardScored4() throws Exception {
					given();
						
					if (prerequisite("LoadNextCardScored4")) {
						...
						LOG.info("prerequisite for LoadNextCardScored4 not met");
					}
				}
