...
public abstract class AbstractLoadNextCardSecondScoredScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextCardSecondScoredScenario.class);
	...
	private com.anfelisa.box.data.LoadNextCardResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void loadNextCardSecondScored() throws Exception {
					given();
						
					if (prerequisite("LoadNextCardSecondScored")) {
						...
						LOG.info("WHEN: prerequisite for LoadNextCardSecondScored not met");
					}
				}
				...
				protected String scenarioName() {
					return "LoadNextCardSecondScored";
				}
