	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard4")) {
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: ScoreReinforceCard4 fails due to {} in {} ms", message, (timeAfterRequest-timeBeforeRequest));
				addToMetrics("ScoreReinforceCard", (timeAfterRequest-timeBeforeRequest));
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard4 success in {} ms", (timeAfterRequest-timeBeforeRequest));
			addToMetrics("ScoreReinforceCard", (timeAfterRequest-timeBeforeRequest));
		} else {
