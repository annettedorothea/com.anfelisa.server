	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard4")) {
			...
			if (response_14.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: ScoreReinforceCard4 fails due to {} in {} ms", message, response_14.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreReinforceCard4 success in {} ms", response_14.getDuration());
