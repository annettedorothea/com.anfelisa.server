...
public abstract class AbstractScoreReinforceCardDoesNotExistScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCardDoesNotExistScenario.class);
			...
			assertFail(message);
				...
				public void scoreReinforceCardDoesNotExist() throws Exception {
					...
					if (prerequisite("ScoreReinforceCardDoesNotExist")) {
						...
						LOG.info("prerequisite for ScoreReinforceCardDoesNotExist not met");
					}
				}
