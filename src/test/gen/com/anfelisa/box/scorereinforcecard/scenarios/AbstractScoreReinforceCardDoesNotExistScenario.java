...
public abstract class AbstractScoreReinforceCardDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.ScoreReinforceCardData scoreReinforceCard0 = new com.anfelisa.box.data.ScoreReinforceCardData(randomUUID());
		scoreReinforceCard0.setScoredCardQuality(5);
		scoreReinforceCard0.setReinforceCardId(this.templateStringValue("xx", 0));
		
		
		return 
		com.anfelisa.box.ActionCalls.callScoreReinforceCard(scoreReinforceCard0, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 400);
				...
				@Test
				public void scoreReinforceCardDoesNotExist() throws Exception {
					given();
