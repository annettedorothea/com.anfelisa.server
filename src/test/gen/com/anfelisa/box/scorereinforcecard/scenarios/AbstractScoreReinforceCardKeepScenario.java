...
public abstract class AbstractScoreReinforceCardKeepScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCardKeepScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreReinforceCardKeep")) {
			...
			LOG.info("WHEN: prerequisite for ScoreReinforceCardKeep not met");
		}
