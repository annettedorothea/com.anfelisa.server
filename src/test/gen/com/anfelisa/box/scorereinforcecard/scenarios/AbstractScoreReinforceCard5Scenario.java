...
public abstract class AbstractScoreReinforceCard5Scenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCard5Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "sr5-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard5")) {
			...
			LOG.info("WHEN: prerequisite for ScoreReinforceCard5 not met");
		}
	}
