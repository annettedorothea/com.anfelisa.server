...
public abstract class AbstractScoreReinforceCard3Scenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCard3Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "sr3-${testId}".replace("${testId}", this.getTestId());
			...
			assertFail(message);
				...
				public void scoreReinforceCard3() throws Exception {
					...
					if (prerequisite("ScoreReinforceCard3")) {
						...
						LOG.info("prerequisite for ScoreReinforceCard3 not met");
					}
				}
