...
public abstract class AbstractScoreReinforceCardNotMyCardScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.box.data.ScoreCardTestData scoreCard9 = new com.anfelisa.box.data.ScoreCardTestData("score0");
		...
		com.anfelisa.user.data.UserRegistrationTestData registerUser10 = new com.anfelisa.user.data.UserRegistrationTestData("uuid-admin");
		registerUser10.setEmail(this.templateStringValue("annette.pohl@anfelisa.de", 10));
		registerUser10.setLanguage(this.templateStringValue("de", 10));
		registerUser10.setPassword(this.templateStringValue("admin-password", 10));
		registerUser10.setUsername(this.templateStringValue("Admin", 10));
		registerUser10.setToken(this.templateStringValue("ADMIN-TOKEN", 10));
		
		
		com.anfelisa.user.ActionCalls.callRegisterUser(registerUser10, DROPWIZARD.getLocalPort());
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.ScoreReinforceCardTestData scoreReinforceCard0 = new com.anfelisa.box.data.ScoreReinforceCardTestData("1");
		scoreReinforceCard0.setScoredCardQuality(5);
		scoreReinforceCard0.setReinforceCardId(this.templateStringValue("score0", 0));
		
		
		return 
		com.anfelisa.box.ActionCalls.callScoreReinforceCard(scoreReinforceCard0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 401);
				...
				@Test
				public void scoreReinforceCardNotMyCard() throws Exception {
					given();
