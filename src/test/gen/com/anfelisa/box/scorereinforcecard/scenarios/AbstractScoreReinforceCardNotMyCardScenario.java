...
public abstract class AbstractScoreReinforceCardNotMyCardScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.user.data.UserRegistrationData registerUser10 = new com.anfelisa.user.data.UserRegistrationData("uuid-admin");
	...
	private Response when() throws Exception {
		NotReplayableDataProvider.setSystemTime(DateTime.parse("20200418 16:40", DateTimeFormat.forPattern("yyyyMMdd HH:mm")));
		com.anfelisa.box.data.ScoreReinforceCardData scoreReinforceCard0 = new com.anfelisa.box.data.ScoreReinforceCardData("1");
