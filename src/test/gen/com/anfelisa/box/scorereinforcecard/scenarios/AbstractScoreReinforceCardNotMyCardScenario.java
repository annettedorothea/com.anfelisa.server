...
public abstract class AbstractScoreReinforceCardNotMyCardScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCardNotMyCardScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("RegisterUserAdmin")) {
			...
			this.callNotReplayableDataProviderPutValue(uuid, "token", 
						...
						this.getProtocol(), this.getHost(), this.getPort());
			com.anfelisa.user.data.UserRegistrationData data_11 = objectMapper.readValue("{" +
				"\"uuid\" : \"" + uuid + "\"," + 
					"\"email\" : \"annette.pohl@anfelisa.de\"," + 
					"\"language\" : \"de\"," + 
			...
			assertFail(message);
				...
				public void scoreReinforceCardNotMyCard() throws Exception {
					...
					if (prerequisite("ScoreReinforceCardNotMyCard")) {
						...
						LOG.info("prerequisite for ScoreReinforceCardNotMyCard not met");
					}
				}
