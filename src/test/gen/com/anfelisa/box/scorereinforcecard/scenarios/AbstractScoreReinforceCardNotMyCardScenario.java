...
public abstract class AbstractScoreReinforceCardNotMyCardScenario extends BaseScenario {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.ScoreReinforceCardModel model_0 = objectMapper.readValue("{" +
			"\"keep\" : false," + 
			"\"reinforceCardId\" : \"score0-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreReinforceCardModel.class);
		Data<com.anfelisa.box.models.ScoreReinforceCardModel> data_0 = new Data<com.anfelisa.box.models.ScoreReinforceCardModel>(uuid);
		data_0.setModel(model_0);
