...
public abstract class AbstractScoreReinforceCard1Scenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCard1Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "sr1-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard1")) {
			...
			LOG.info("WHEN: prerequisite for ScoreReinforceCard1 not met");
		}
	}
