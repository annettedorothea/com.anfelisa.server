...
public abstract class AbstractScoreReinforceCard1Scenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		scoreReinforceCard0.setScoredCardQuality(1);
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 200);
				...
				@Test
				public void scoreReinforceCard1() throws Exception {
					given();
