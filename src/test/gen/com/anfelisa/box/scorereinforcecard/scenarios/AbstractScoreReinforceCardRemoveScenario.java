...
public abstract class AbstractScoreReinforceCardRemoveScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCardRemoveScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreReinforceCardRemove")) {
			...
			LOG.info("WHEN: prerequisite for ScoreReinforceCardRemove not met");
		}
	...
	protected String scenarioName() {
		return "ScoreReinforceCardRemove";
	}
