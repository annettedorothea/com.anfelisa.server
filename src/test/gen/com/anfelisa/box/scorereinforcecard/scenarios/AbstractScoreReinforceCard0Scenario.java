...
public abstract class AbstractScoreReinforceCard0Scenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreReinforceCard0Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "sr0-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreReinforceCard0")) {
			...
			LOG.info("WHEN: prerequisite for ScoreReinforceCard0 not met");
		}
	}
