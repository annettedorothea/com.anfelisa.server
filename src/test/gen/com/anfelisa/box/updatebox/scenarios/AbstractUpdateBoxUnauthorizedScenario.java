...
public abstract class AbstractUpdateBoxUnauthorizedScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateBoxUnauthorizedScenario.class);
		...
		if (response.getStatus() != 401) {
			...
			assertFail(message);
				...
				public void updateBoxUnauthorized() throws Exception {
					...
					if (prerequisite("UpdateBoxUnauthorized")) {
						...
						LOG.info("prerequisite for UpdateBoxUnauthorized not met");
					}
				}
