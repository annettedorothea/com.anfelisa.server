...
public abstract class AbstractUpdateBoxNoAccessScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		updateBox0.setCategoryName(this.templateStringValue("adminBox", 0));
		updateBox0.setMaxCardsPerDay(10);
		
		
		return 
		com.anfelisa.box.ActionCalls.callUpdateBox(updateBox0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
