...
public abstract class AbstractUpdateBoxCategoryNameNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateBoxCategoryNameNullScenario.class);
			...
			assertFail(message);
				...
				public void updateBoxCategoryNameNull() throws Exception {
					...
					if (prerequisite("UpdateBoxCategoryNameNull")) {
						...
						LOG.info("prerequisite for UpdateBoxCategoryNameNull not met");
					}
				}
				...
				protected String scenarioName() {
					return "UpdateBoxCategoryNameNull";
				}
