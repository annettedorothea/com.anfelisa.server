...
public abstract class AbstractUpdateBoxGivenLanguageInvalidScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateBoxGivenLanguageInvalidScenario.class);
			...
			assertFail(message);
				...
				public void updateBoxGivenLanguageInvalid() throws Exception {
					if (prerequisite("UpdateBoxGivenLanguageInvalid")) {
						...
						LOG.info("prerequisite for UpdateBoxGivenLanguageInvalid not met");
					}
				}
