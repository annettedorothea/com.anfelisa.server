...
public abstract class AbstractUpdateBoxGivenLanguageInvalidScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		updateBox0.setGivenLanguage(this.templateStringValue("xx", 0));
		updateBox0.setWantedLanguage(this.templateStringValue("en", 0));
