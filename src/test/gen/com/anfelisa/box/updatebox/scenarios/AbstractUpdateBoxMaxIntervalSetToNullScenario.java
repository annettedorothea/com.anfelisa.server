...
public abstract class AbstractUpdateBoxMaxIntervalSetToNullScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("UpdateBoxMaxInterval")) {
			...
			com.anfelisa.box.data.BoxUpdateData data_2 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"categoryId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"categoryName\" : \"changed\"," + 
			...
			if (response_2.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: UpdateBoxMaxInterval fails due to {} in {} ms", message, response_2.getDuration());
				assertFail(message);
			}
