...
public abstract class AbstractUpdateBoxMaxCardsPerDayNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateBoxMaxCardsPerDayNullScenario.class);
			...
			assertFail(message);
				...
				public void updateBoxMaxCardsPerDayNull() throws Exception {
					...
					if (prerequisite("UpdateBoxMaxCardsPerDayNull")) {
						...
						LOG.info("prerequisite for UpdateBoxMaxCardsPerDayNull not met");
					}
				}
				...
				protected String scenarioName() {
					return "UpdateBoxMaxCardsPerDayNull";
				}
