...
public abstract class AbstractUpdateBoxCategoryIdNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractUpdateBoxCategoryIdNullScenario.class);
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				public void updateBoxCategoryIdNull() throws Exception {
					if (prerequisite("UpdateBoxCategoryIdNull")) {
						given();
						...
						LOG.info("prerequisite for UpdateBoxCategoryIdNull not met");
					}
				}
				...
				protected String scenarioName() {
					return "UpdateBoxCategoryIdNull";
				}
