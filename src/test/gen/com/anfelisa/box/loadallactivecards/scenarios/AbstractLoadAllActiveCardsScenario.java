...
public abstract class AbstractLoadAllActiveCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCards")) {
			...
			LOG.info("WHEN: prerequisite for LoadAllActiveCards not met");
		}
