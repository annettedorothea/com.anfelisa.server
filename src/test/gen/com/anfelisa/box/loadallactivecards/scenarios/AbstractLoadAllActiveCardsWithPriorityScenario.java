...
public abstract class AbstractLoadAllActiveCardsWithPriorityScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsWithPriorityScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("UpdateCardPriority1")) {
			...
			com.anfelisa.card.models.CardUpdatePriorityModel model_9 = objectMapper.readValue("{" +
				"\"cardId\" : \"c1-" + this.getTestId() + "\"," + 
				"\"priority\" : 1} ", com.anfelisa.card.models.CardUpdatePriorityModel.class);
			Data<com.anfelisa.card.models.CardUpdatePriorityModel> data_9 = new Data<com.anfelisa.card.models.CardUpdatePriorityModel>(uuid);
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: UpdateCardPriority1 fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: UpdateCardPriority1 success in {} ms", response_9.getDuration());
	...
	private com.anfelisa.box.data.LoadAllActiveCardsResponse then_0(HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.ActiveCardListModel expectedData = objectMapper.readValue("{" +
				...
				"\"lastQuality\" : null," + 
				"\"next\" : \"2020-04-18T10:30\"," + 
				"\"priority\" : 1}]} ", com.anfelisa.box.models.ActiveCardListModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCardsWithPriority")) {
			...
			LOG.info("WHEN: prerequisite for LoadAllActiveCardsWithPriority not met");
		}
	...
	protected String scenarioName() {
		return "LoadAllActiveCardsWithPriority";
	}
