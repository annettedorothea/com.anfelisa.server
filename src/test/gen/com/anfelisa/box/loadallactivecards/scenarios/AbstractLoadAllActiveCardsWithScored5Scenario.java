...
public abstract class AbstractLoadAllActiveCardsWithScored5Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsWithScored5Scenario.class);
	...
	private com.anfelisa.box.data.LoadAllActiveCardsResponse then_0(HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.ActiveCardListModel expectedData = objectMapper.readValue("{" +
				...
				"\"interval\" : 6," + 
				"\"lastQuality\" : 5," + 
				"\"next\" : \"2020-04-24T16:55\"}]} ", com.anfelisa.box.models.ActiveCardListModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCardsWithScored5")) {
			...
			LOG.info("WHEN: prerequisite for LoadAllActiveCardsWithScored5 not met");
		}
	...
	protected String scenarioName() {
		return "LoadAllActiveCardsWithScored5";
	}
