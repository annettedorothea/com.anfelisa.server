...
public abstract class AbstractLoadAllActiveCardsBoxDoesNotExistScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsBoxDoesNotExistScenario.class);
	...
	private HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> when_0() throws Exception {
		...
		com.anfelisa.box.models.ActiveCardListModel model_0 = objectMapper.readValue("{" +
			"\"boxId\" : \"invalidbox\"} ", com.anfelisa.box.models.ActiveCardListModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCardsBoxDoesNotExist")) {
			...
			LOG.info("WHEN: prerequisite for LoadAllActiveCardsBoxDoesNotExist not met");
		}
	...
	protected String scenarioName() {
		return "LoadAllActiveCardsBoxDoesNotExist";
	}
