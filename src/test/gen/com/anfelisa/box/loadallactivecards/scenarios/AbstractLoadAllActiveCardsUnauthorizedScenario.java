...
public abstract class AbstractLoadAllActiveCardsUnauthorizedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsUnauthorizedScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCardsUnauthorized")) {
			...
			LOG.info("WHEN: prerequisite for LoadAllActiveCardsUnauthorized not met");
		}
	...
	protected String scenarioName() {
		return "LoadAllActiveCardsUnauthorized";
	}
