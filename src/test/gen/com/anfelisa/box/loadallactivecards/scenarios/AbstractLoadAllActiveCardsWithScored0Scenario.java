...
public abstract class AbstractLoadAllActiveCardsWithScored0Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsWithScored0Scenario.class);
	...
	private com.anfelisa.box.data.LoadAllActiveCardsResponse then_0(HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.ActiveCardListModel expectedData = objectMapper.readValue("{" +
				...
				"\"interval\" : 1," + 
				"\"lastQuality\" : 0," + 
				"\"next\" : \"2020-04-19T16:30\"}]} ", com.anfelisa.box.models.ActiveCardListModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCardsWithScored0")) {
			...
			LOG.info("WHEN: prerequisite for LoadAllActiveCardsWithScored0 not met");
		}
	...
	protected String scenarioName() {
		return "LoadAllActiveCardsWithScored0";
	}
