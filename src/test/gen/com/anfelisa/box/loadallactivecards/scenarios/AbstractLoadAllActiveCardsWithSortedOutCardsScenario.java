...
public abstract class AbstractLoadAllActiveCardsWithSortedOutCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadAllActiveCardsWithSortedOutCardsScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("SortCardsOut")) {
			...
			com.anfelisa.box.data.SortCardsOutPayload payload_9 = objectMapper.readValue("{" +
				"\"cardIds\" : [ \"c1-" + this.getTestId() + "\"," + 
				"\"c4-" + this.getTestId() + "\"]," + 
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ",
					com.anfelisa.box.data.SortCardsOutPayload.class);
			com.anfelisa.box.models.SortCardsOutModel model_9 = objectMapper.readValue("{" +
				"\"cardIds\" : [ \"c1-" + this.getTestId() + "\"," + 
				"\"c4-" + this.getTestId() + "\"]," + 
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ", com.anfelisa.box.models.SortCardsOutModel.class);
			Data<com.anfelisa.box.models.SortCardsOutModel> data_9 = new Data<com.anfelisa.box.models.SortCardsOutModel>(uuid);
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: SortCardsOut fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: SortCardsOut success in {} ms", response_9.getDuration());
			addToMetrics("SortCardsOut", response_9.getDuration());
		} else {
	...
	private HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> when_0() throws Exception {
		String uuid = this.randomUUID();
		com.anfelisa.box.models.ActiveCardListModel model_0 = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ActiveCardListModel.class);
		Data<com.anfelisa.box.models.ActiveCardListModel> data_0 = new Data<com.anfelisa.box.models.ActiveCardListModel>(uuid);
		data_0.setModel(model_0);
		HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> response = 
		this.httpGet(
			"/box/active-cards/" + (data_0.getModel().getBoxId() != null ? URLEncoder.encode(data_0.getModel().getBoxId(), StandardCharsets.UTF_8.toString()) : "") + "", 
			authorization("Annette-${testId}", "password"),
			uuid,
	...
	private com.anfelisa.box.data.LoadAllActiveCardsResponse then_0(HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.ActiveCardListModel expectedData = objectMapper.readValue("{" +
				...
				"\"interval\" : 1," + 
				"\"lastQuality\" : null," + 
				"\"next\" : \"2020-04-18T10:30\"}]} ", com.anfelisa.box.models.ActiveCardListModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("LoadAllActiveCardsWithSortedOutCards")) {
			
				HttpResponse<com.anfelisa.box.data.LoadAllActiveCardsResponse> response_0 = when_0();
				com.anfelisa.box.data.LoadAllActiveCardsResponse actualResponse_0 = then_0(response_0);
				
		
		} else {
			LOG.info("WHEN: prerequisite for LoadAllActiveCardsWithSortedOutCards not met");
		}
	...
	protected String scenarioName() {
		return "LoadAllActiveCardsWithSortedOutCards";
	}
