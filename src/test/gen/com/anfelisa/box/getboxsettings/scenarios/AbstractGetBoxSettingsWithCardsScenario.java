...
public abstract class AbstractGetBoxSettingsWithCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxSettingsWithCardsScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxSettingsWithCards")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxSettingsWithCards not met");
		}
	...
	protected String scenarioName() {
		return "GetBoxSettingsWithCards";
	}
