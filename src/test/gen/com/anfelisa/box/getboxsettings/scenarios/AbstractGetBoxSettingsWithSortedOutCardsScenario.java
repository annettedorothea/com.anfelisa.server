...
public abstract class AbstractGetBoxSettingsWithSortedOutCardsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxSettingsWithSortedOutCardsScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxSettingsWithSortedOutCards")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxSettingsWithSortedOutCards not met");
		}
	...
	protected String scenarioName() {
		return "GetBoxSettingsWithSortedOutCards";
	}
