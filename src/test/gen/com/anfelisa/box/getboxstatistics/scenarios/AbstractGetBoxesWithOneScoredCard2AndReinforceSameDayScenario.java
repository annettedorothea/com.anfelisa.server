...
public abstract class AbstractGetBoxesWithOneScoredCard2AndReinforceSameDayScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesWithOneScoredCard2AndReinforceSameDayScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreCard2")) {
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard2 fails due to {} in {} ms", message, (timeAfterRequest-timeBeforeRequest));
				addToMetrics("ScoreCard", (timeAfterRequest-timeBeforeRequest));
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreCard2 success in {} ms", (timeAfterRequest-timeBeforeRequest));
			addToMetrics("ScoreCard", (timeAfterRequest-timeBeforeRequest));
		} else {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesWithOneScoredCard2AndReinforceSameDay")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxesWithOneScoredCard2AndReinforceSameDay not met");
		}
	}
