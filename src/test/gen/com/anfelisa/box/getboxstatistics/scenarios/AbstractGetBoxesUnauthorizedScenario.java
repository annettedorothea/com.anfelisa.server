...
public abstract class AbstractGetBoxesUnauthorizedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesUnauthorizedScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesUnauthorized")) {
