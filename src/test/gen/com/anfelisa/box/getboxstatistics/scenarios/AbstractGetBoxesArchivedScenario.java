...
public abstract class AbstractGetBoxesArchivedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesArchivedScenario.class);
	...
	private HttpResponse<com.anfelisa.box.data.GetBoxStatisticsResponse> when() throws Exception {
	...
	private com.anfelisa.box.data.GetBoxStatisticsResponse then(HttpResponse<com.anfelisa.box.data.GetBoxStatisticsResponse> response) throws Exception {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesArchived")) {
			HttpResponse<com.anfelisa.box.data.GetBoxStatisticsResponse> response = when();

			com.anfelisa.box.data.GetBoxStatisticsResponse actualResponse = then(response);
			
	
		} else {
			LOG.info("WHEN: prerequisite for GetBoxesArchived not met");
		}
	}
