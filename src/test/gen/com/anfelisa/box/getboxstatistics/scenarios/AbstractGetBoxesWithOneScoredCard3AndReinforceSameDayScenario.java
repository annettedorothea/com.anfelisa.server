	...
	private com.anfelisa.box.data.GetBoxStatisticsResponse then(Response response) throws Exception {
		...
		assertThat(actual, expected);
			...
			return actual;
				...
				@Test
				public void getBoxesWithOneScoredCard3AndReinforceSameDay() throws Exception {
					given();
					...
					if (prerequisite("GetBoxesWithOneScoredCard3AndReinforceSameDay")) {
						...
						LOG.info("prerequisite for GetBoxesWithOneScoredCard3AndReinforceSameDay not met");
					}
				}
