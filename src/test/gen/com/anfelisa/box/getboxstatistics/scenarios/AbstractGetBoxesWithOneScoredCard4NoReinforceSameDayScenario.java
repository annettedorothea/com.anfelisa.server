...
public abstract class AbstractGetBoxesWithOneScoredCard4NoReinforceSameDayScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreCard4")) {
			...
			LOG.info("GIVEN: ScoreCard4 uuid " + uuid);
			...
			if (response.getStatus() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard4 fails due to " + message);
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreCard4 success");
		} else {
			...
			return actual;
				...
				public void getBoxesWithOneScoredCard4NoReinforceSameDay() throws Exception {
					...
					if (prerequisite("GetBoxesWithOneScoredCard4NoReinforceSameDay")) {
						...
						LOG.info("prerequisite for GetBoxesWithOneScoredCard4NoReinforceSameDay not met");
					}
				}
