...
public abstract class AbstractGetBoxesWithOneScoredCard4NoReinforceSameDayScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractGetBoxesWithOneScoredCard4NoReinforceSameDayScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreCard4")) {
			...
			timeAfterRequest = System.currentTimeMillis();
			if (response.getStatus() >= 400) {
				String message = "GIVEN ScoreCard4 fails\n" + response.readEntity(String.class);
				LOG.info("GIVEN: ScoreCard4 fails due to {} in {} ms", message, (timeAfterRequest-timeBeforeRequest));
				addToMetrics("ScoreCard", (timeAfterRequest-timeBeforeRequest));
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreCard4 success in {} ms", (timeAfterRequest-timeBeforeRequest));
			addToMetrics("ScoreCard", (timeAfterRequest-timeBeforeRequest));
		} else {
			LOG.info("GIVEN: prerequisite for ScoreCard4 not met");
		}
	...
	private Response when() throws Exception {
		...
		LOG.info("WHEN: GetBoxStatistics finished in {} ms", (timeAfterRequest-timeBeforeRequest));
		addToMetrics("GetBoxStatistics", (timeAfterRequest-timeBeforeRequest));
		return response;
	}
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetBoxesWithOneScoredCard4NoReinforceSameDay")) {
			...
			LOG.info("WHEN: prerequisite for GetBoxesWithOneScoredCard4NoReinforceSameDay not met");
		}
	}
	...
	protected String scenarioName() {
		return "GetBoxesWithOneScoredCard4NoReinforceSameDay";
	}
