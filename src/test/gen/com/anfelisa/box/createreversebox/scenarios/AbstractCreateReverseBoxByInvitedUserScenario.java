...
public abstract class AbstractCreateReverseBoxByInvitedUserScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateReverseBoxByInvitedUserScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("CreateReverseBoxByInvitedUser")) {
			...
			LOG.info("WHEN: prerequisite for CreateReverseBoxByInvitedUser not met");
		}
	}
	...
	protected String scenarioName() {
		return "CreateReverseBoxByInvitedUser";
	}
