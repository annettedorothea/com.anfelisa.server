...
public abstract class AbstractCreateReverseBoxScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateReverseBoxScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("CreateReverseBox")) {
			...
			LOG.info("WHEN: prerequisite for CreateReverseBox not met");
		}
	}
