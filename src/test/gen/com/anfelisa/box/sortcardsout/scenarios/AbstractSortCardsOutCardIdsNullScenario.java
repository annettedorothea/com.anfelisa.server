...
public abstract class AbstractSortCardsOutCardIdsNullScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSortCardsOutCardIdsNullScenario.class);
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.SortCardsOutData data_0 = objectMapper.readValue("{ \"uuid\" : \"" + uuid + "\"}",
	...
	protected String scenarioName() {
		return "SortCardsOutCardIdsNull";
	}
