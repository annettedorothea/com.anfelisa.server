...
public abstract class AbstractSortCardsOutEmptyCardIdsScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSortCardsOutEmptyCardIdsScenario.class);
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void sortCardsOutEmptyCardIds() throws Exception {
					given();
					...
					if (prerequisite("SortCardsOutEmptyCardIds")) {
						...
						LOG.info("prerequisite for SortCardsOutEmptyCardIds not met");
					}
				}
