...
public abstract class AbstractSortCardsOutScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractSortCardsOutScenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("SortCardsOut")) {
			...
			this.card1WasSortedOut();
			this.card3WasNotSortedOut();
			this.card4WasSortedOut();
		
		} else {
			LOG.info("WHEN: prerequisite for SortCardsOut not met");
		}
	}
	
	
	private void card1WasSortedOut() throws Exception {
		...
		LOG.info("THEN: card1WasSortedOut passed");
	}
