...
public abstract class AbstractSortCardsOutWithScoredAndReinforceScenario extends BaseScenario {
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		LOG.info("WHEN: SortCardsOut finished in {} ms", response.getDuration());
		if (response.getStatusCode() >= 200 && response.getStatusCode() < 300) {
			addToMetrics("SortCardsOut", response.getDuration());
		}
		return response;
	}
	...
	private void scoredCard1WasNotTouched() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c1-" + this.getTestId() + "-sc1-" + this.getTestId() + "");
		
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
	...
	private void newScheduledCard1WasSortedOut() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score0-" + this.getTestId() + "");
	...
	private void reinforceCard1WasDeleted() throws Exception {
		com.anfelisa.box.models.ReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score0-" + this.getTestId() + "");
	...
	private void scoredCard3Remains() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c3-" + this.getTestId() + "-sc1-" + this.getTestId() + "");
	...
	private void newScheuledCard3Remains() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score1-" + this.getTestId() + "");
	...
	private void reinforceCard3Remains() throws Exception {
		com.anfelisa.box.models.ReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score1-" + this.getTestId() + "");
		
		com.anfelisa.box.models.ReinforceCardModel expected = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
	...
	private void card4WasSortedOut() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "c4-" + this.getTestId() + "-sc1-" + this.getTestId() + "");
