...
public abstract class AbstractCreateBoxCategoryNameEmptyScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.box.ActionCalls.callCreateBox("boxId", "", new Boolean("false"), null, null, 10, null, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
	...
	@Test
	public void createBoxCategoryNameEmpty() throws Exception {
		given();
