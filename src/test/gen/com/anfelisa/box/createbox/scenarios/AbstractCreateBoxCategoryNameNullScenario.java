...
public abstract class AbstractCreateBoxCategoryNameNullScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.box.ActionCalls.callCreateBox("boxId", null, new Boolean("false"), null, null, 10, null, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
