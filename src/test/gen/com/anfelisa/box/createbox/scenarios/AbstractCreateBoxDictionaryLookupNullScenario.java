...
public abstract class AbstractCreateBoxDictionaryLookupNullScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractCreateBoxDictionaryLookupNullScenario.class);
			...
			assertFail(message);
				...
				public void createBoxDictionaryLookupNull() throws Exception {
					if (prerequisite("CreateBoxDictionaryLookupNull")) {
						...
						LOG.info("prerequisite for CreateBoxDictionaryLookupNull not met");
					}
				}
