...
public abstract class AbstractCreateBoxDictionaryLookupNullScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.box.ActionCalls.callCreateBox("boxId", this.templateStringValue("cat", 0), null, null, null, 10, null, DROPWIZARD.getLocalPort(), authorization("Annette", "password"));
	}
