...
public abstract class AbstractScoreCard37Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard37Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "score37-" + this.getTestId() + "";
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score37-" + this.getTestId() + "");
		
		com.anfelisa.box.models.IScheduledCardModel expected = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"cardId\" : \"c1-" + this.getTestId() + "\"," + 
				"\"count\" : 8," + 
				"\"createdDate\" : \"2021-07-01T16:30\"," + 
				"\"ef\" : \"1.76F\"," + 
				"\"interval\" : 90," + 
				"\"lastQuality\" : 3," + 
				"\"n\" : 9," + 
				...
				"\"scheduledDate\" : \"2021-09-29T16:30\"," + 
				"\"scoredDate\" : null} ",
