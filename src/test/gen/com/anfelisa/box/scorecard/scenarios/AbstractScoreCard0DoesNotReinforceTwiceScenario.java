...
public abstract class AbstractScoreCard0DoesNotReinforceTwiceScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard0DoesNotReinforceTwiceScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "score01-${testId}".replace("${testId}", this.getTestId());
		this.callNotReplayableDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200419 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
		com.anfelisa.box.data.ScoreCardData data_0 = objectMapper.readValue("{" +
			"\"uuid\" : \"" + uuid + "\"," + 
				"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"scoredCardQuality\" : 0," + 
				"\"scoredCardScheduledCardId\" : \"score0-" + this.getTestId() + "\"} ",
		com.anfelisa.box.data.ScoreCardData.class);
