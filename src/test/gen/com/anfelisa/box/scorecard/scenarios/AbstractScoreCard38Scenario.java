...
public abstract class AbstractScoreCard38Scenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.ScoreCardTestData scoreCard0 = new com.anfelisa.box.data.ScoreCardTestData("score38");
		scoreCard0.setBoxId(this.templateStringValue("boxId", 0));
		scoreCard0.setScoredCardQuality(3);
		scoreCard0.setScoredCardScheduledCardId(this.templateStringValue("score37", 0));
