...
public abstract class AbstractScoreAlreadyScoredScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreAlreadyScoredScenario.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_0() throws Exception {
		String uuid = "already-scored-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreAlreadyScored")) {
			...
			LOG.info("WHEN: prerequisite for ScoreAlreadyScored not met");
		}
	...
	private void reinforceCardWasNotCreated() throws Exception {
		com.anfelisa.box.models.ReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score5-" + this.getTestId() + "");
