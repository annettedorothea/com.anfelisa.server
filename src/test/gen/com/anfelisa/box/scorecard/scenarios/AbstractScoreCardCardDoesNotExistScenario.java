...
public abstract class AbstractScoreCardCardDoesNotExistScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCardCardDoesNotExistScenario.class);
	...
	private Response when() throws Exception {
		String uuid = "score1-${testId}".replace("${testId}", this.getTestId());
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 400) {
			...
			assertFail(message);
				...
				@Test
				public void scoreCardCardDoesNotExist() throws Exception {
					given();
					...
					if (prerequisite("ScoreCardCardDoesNotExist")) {
						...
						LOG.info("prerequisite for ScoreCardCardDoesNotExist not met");
					}
				}
				...
				protected String scenarioName() {
					return "ScoreCardCardDoesNotExist";
				}
