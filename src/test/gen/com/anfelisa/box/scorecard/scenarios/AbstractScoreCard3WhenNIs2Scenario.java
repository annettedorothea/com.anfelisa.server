...
public abstract class AbstractScoreCard3WhenNIs2Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard3WhenNIs2Scenario.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_0() throws Exception {
		...
		com.anfelisa.box.models.ScoreCardModel model_0 = objectMapper.readValue("{" +
			"\"scoredCardQuality\" : 3," + 
			"\"scheduledCardId\" : \"score5-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreCardModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreCard3WhenNIs2")) {
			...
			LOG.info("WHEN: prerequisite for ScoreCard3WhenNIs2 not met");
		}
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "n2-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 3," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"n2-" + this.getTestId() + "\"," + 
			"\"scheduledDate\" : \"2020-05-05T16:55\"," + 
			"\"scoredDate\" : null} ",
