...
public abstract class AbstractScoreCard3WhenNIs0Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard3WhenNIs0Scenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreCard3WhenNIs0")) {
			...
			LOG.info("WHEN: prerequisite for ScoreCard3WhenNIs0 not met");
		}
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "n0-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 1," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"n0-" + this.getTestId() + "\"," + 
