...
public abstract class AbstractScoreCard1Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard1Scenario.class);
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void scoreCard1() throws Exception {
					given();
					...
					if (prerequisite("ScoreCard1")) {
						...
						LOG.info("prerequisite for ScoreCard1 not met");
					}
				}
