...
public abstract class AbstractDoNotScheduleCardThatWasAccidentallyAlreadyScheduledScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDoNotScheduleCardThatWasAccidentallyAlreadyScheduledScenario.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_0() throws Exception {
		String uuid = "score-scheduled-" + this.getTestId() + "";
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DoNotScheduleCardThatWasAccidentallyAlreadyScheduled")) {
				...
				this.scoredCardWasNotChanged();
				this.newScheduledCardWasNotCreated();
				
		
		} else {
			LOG.info("WHEN: prerequisite for DoNotScheduleCardThatWasAccidentallyAlreadyScheduled not met");
		}
	...
	private void scoredCardWasNotChanged() throws Exception {
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"scoredDate\" : \"2020-04-18T16:55\"} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);
	
		LOG.info("THEN: scoredCardWasNotChanged passed");
	}
	private void newScheduledCardWasNotCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score-scheduled-" + this.getTestId() + "");
	...
	protected String scenarioName() {
		return "DoNotScheduleCardThatWasAccidentallyAlreadyScheduled";
	}
