...
public abstract class AbstractScoreCard36Scenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.ScoreCardTestData scoreCard0 = new com.anfelisa.box.data.ScoreCardTestData("score36");
		scoreCard0.setBoxId(this.templateStringValue("boxId", 0));
		scoreCard0.setScoredCardQuality(3);
		scoreCard0.setScoredCardScheduledCardId(this.templateStringValue("score35", 0));
