	...
	private void given() throws Exception {
		...
		if (prerequisite("UpdateBoxSetMaxCardsTo1")) {
			...
			if (response_8.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: UpdateBoxSetMaxCardsTo1 fails due to {} in {} ms", message, response_8.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScheduleCards")) {
			...
			if (response_9.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScheduleCards fails due to {} in {} ms", message, response_9.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard0")) {
			...
			if (response_10.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard0 fails due to {} in {} ms", message, response_10.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCardSecond0")) {
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCardSecond0 fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
