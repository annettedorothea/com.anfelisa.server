...
public abstract class AbstractScoreCard34Scenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.box.data.ScoreCardTestData scoreCard0 = new com.anfelisa.box.data.ScoreCardTestData("score34");
		scoreCard0.setBoxId(this.templateStringValue("boxId", 0));
		scoreCard0.setScoredCardQuality(5);
		scoreCard0.setScoredCardScheduledCardId(this.templateStringValue("score33", 0));
	...
	private void then(Response response) throws Exception {
		assertThat(response.getStatus(), 200);
				...
				@Test
				public void scoreCard34() throws Exception {
					given();
