...
public abstract class AbstractScoreCard0Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard0Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "score0-${testId}".replace("${testId}", this.getTestId());
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void scoreCard0() throws Exception {
					given();
					...
					if (prerequisite("ScoreCard0")) {
						...
						LOG.info("WHEN: prerequisite for ScoreCard0 not met");
					}
				}
