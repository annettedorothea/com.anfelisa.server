...
public abstract class AbstractScoreCard2Scenario extends BaseScenario {
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score2-" + this.getTestId() + "");
		
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			"\"boxId\" : \"boxId-" + this.getTestId() + "\"," + 
			"\"cardId\" : \"c1-" + this.getTestId() + "\"," + 
			"\"count\" : 1," + 
			"\"createdDate\" : \"2020-04-18T16:40\"," + 
			"\"ef\" : \"2.18F\"," + 
			"\"interval\" : 1," + 
			"\"lastQuality\" : 2," + 
			"\"n\" : 0," + 
			...
			"\"scheduledDate\" : \"2020-04-19T16:40\"," + 
			"\"scoredDate\" : null} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);
	...
	private void reinforceCardWasCreated() throws Exception {
		com.anfelisa.box.models.ReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score2-" + this.getTestId() + "");
