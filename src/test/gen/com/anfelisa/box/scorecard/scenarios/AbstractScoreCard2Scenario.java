...
public abstract class AbstractScoreCard2Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard2Scenario.class);
	...
	private Response when() throws Exception {
		String uuid = "score2-${testId}".replace("${testId}", this.getTestId());
	...
	private void then(Response response) throws Exception {
		...
		if (response.getStatus() != 200) {
			...
			assertFail(message);
				...
				@Test
				public void scoreCard2() throws Exception {
					given();
					...
					if (prerequisite("ScoreCard2")) {
						...
						LOG.info("prerequisite for ScoreCard2 not met");
					}
				}
