...
public abstract class AbstractScoreCardMinimumQFactorScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("ScoreCard33")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200615 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
		...
		if (prerequisite("ScoreCard34")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200819 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
		...
		if (prerequisite("ScoreCard35")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20201120 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
		...
		if (prerequisite("ScoreCard36")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20210301 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
			...
			if (response_16.getStatusCode() >= 400) {
				String statusMessage = response_16.getStatusMessage() != null ? response_16.getStatusMessage() : "";
		...
		if (prerequisite("ScoreCard37")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20210701 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
			...
			if (response_17.getStatusCode() >= 400) {
				String statusMessage = response_17.getStatusMessage() != null ? response_17.getStatusMessage() : "";
		...
		if (prerequisite("ScoreCard38")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20211001 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
			...
			if (response_18.getStatusCode() >= 400) {
				String statusMessage = response_18.getStatusMessage() != null ? response_18.getStatusMessage() : "";
		...
		if (prerequisite("ScoreCard39")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20220201 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
			...
			if (response_19.getStatusCode() >= 400) {
				String statusMessage = response_19.getStatusMessage() != null ? response_19.getStatusMessage() : "";
		...
		if (prerequisite("ScoreCard310")) {
			...
			this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20220601 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
			com.anfelisa.box.data.ScoreCardPayload payload_20 = objectMapper.readValue("{" +
				"\"scoredCardQuality\" : 3," + 
			...
			if (response_20.getStatusCode() >= 400) {
				String statusMessage = response_20.getStatusMessage() != null ? response_20.getStatusMessage() : "";
				String message = "GIVEN ScoreCard310 fails\n" + statusMessage;
				LOG.error("GIVEN: ScoreCard310 fails due to {} in {} ms", message, response_20.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: ScoreCard310 success in {} ms", response_20.getDuration());
			addToMetrics("ScoreCard", response_20.getDuration());
		} else {
	...
	private HttpResponse<Object> when() throws Exception {
		...
		this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20221001 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
