...
public abstract class AbstractScoreCardMinimumQFactorScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		if (prerequisite("UpdateBoxMaxInterval")) {
			...
			if (response_10.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: UpdateBoxMaxInterval fails due to {} in {} ms", message, response_10.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard31")) {
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard31 fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard32")) {
			...
			if (response_12.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard32 fails due to {} in {} ms", message, response_12.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard33")) {
			...
			if (response_13.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard33 fails due to {} in {} ms", message, response_13.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard34")) {
			...
			if (response_14.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard34 fails due to {} in {} ms", message, response_14.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard35")) {
			...
			if (response_15.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard35 fails due to {} in {} ms", message, response_15.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard36")) {
			...
			if (response_16.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard36 fails due to {} in {} ms", message, response_16.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard37")) {
			...
			if (response_17.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard37 fails due to {} in {} ms", message, response_17.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard38")) {
			...
			if (response_18.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard38 fails due to {} in {} ms", message, response_18.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard39")) {
			...
			if (response_19.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard39 fails due to {} in {} ms", message, response_19.getDuration());
				assertFail(message);
			}
		...
		if (prerequisite("ScoreCard310")) {
			...
			if (response_20.getStatusCode() >= 400) {
				...
				LOG.info("GIVEN: ScoreCard310 fails due to {} in {} ms", message, response_20.getDuration());
				assertFail(message);
			}
	...
	private HttpResponse<Object> when() throws Exception {
		...
		this.callNonDeterministicDataProviderPutSystemTime(uuid, LocalDateTime.parse("20221001 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
