...
public abstract class AbstractScoreCard4Scenario extends BaseScenario {
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score4-" + this.getTestId() + "");
	...
	private void reinforceCardWasNotCreated() throws Exception {
		com.anfelisa.box.models.ReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score4-" + this.getTestId() + "");
