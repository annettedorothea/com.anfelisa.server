...
public abstract class AbstractScoreCard4Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard4Scenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreCard4")) {
			...
			LOG.info("WHEN: prerequisite for ScoreCard4 not met");
		}
	}
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score4-" + this.getTestId() + "");
	...
	private void reinforceCardWasNotCreated() throws Exception {
		com.anfelisa.box.models.IReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score4-" + this.getTestId() + "");
