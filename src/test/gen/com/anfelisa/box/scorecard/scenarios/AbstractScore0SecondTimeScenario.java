...
public abstract class AbstractScore0SecondTimeScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScore0SecondTimeScenario.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_0() throws Exception {
		String uuid = "secondtime-" + this.getTestId() + "";
		...
		com.anfelisa.box.models.ScoreCardModel model_0 = objectMapper.readValue("{" +
			"\"scoredCardQuality\" : 0," + 
			"\"scheduledCardId\" : \"score0-" + this.getTestId() + "\"} ", com.anfelisa.box.models.ScoreCardModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("Score0SecondTime")) {
			...
			LOG.info("WHEN: prerequisite for Score0SecondTime not met");
		}
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "secondtime-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 0," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"secondtime-" + this.getTestId() + "\"," + 
