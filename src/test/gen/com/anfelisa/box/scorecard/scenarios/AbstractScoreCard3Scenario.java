...
public abstract class AbstractScoreCard3Scenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreCard3Scenario.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreCard3")) {
			...
			LOG.info("WHEN: prerequisite for ScoreCard3 not met");
		}
	}
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score3-" + this.getTestId() + "");
	...
	private void reinforceCardWasCreated() throws Exception {
		com.anfelisa.box.models.IReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score3-" + this.getTestId() + "");
