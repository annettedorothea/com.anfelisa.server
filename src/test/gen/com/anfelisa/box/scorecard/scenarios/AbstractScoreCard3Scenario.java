...
public abstract class AbstractScoreCard3Scenario extends BaseScenario {
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "score3-" + this.getTestId() + "");
	...
	private void reinforceCardWasCreated() throws Exception {
		com.anfelisa.box.models.ReinforceCardModel actual = daoProvider.getReinforceCardDao().selectByReinforceCardId(handle, "score3-" + this.getTestId() + "");
