...
public abstract class AbstractScoreMaxCardsPerDayScenario extends BaseScenario {
	...
	private void newScheduledCard1WasCreated() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxCards1-" + this.getTestId() + "");
	...
	private void newScheduledCard2WasCreated() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxCards2-" + this.getTestId() + "");
	...
	private void newScheduledCard3WasCreated() throws Exception {
		com.anfelisa.box.models.IScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxCards3-" + this.getTestId() + "");
