...
public abstract class AbstractScoreMaxCardsPerDayScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreMaxCardsPerDayScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.BoxUpdateModel model_0 = objectMapper.readValue("{" +
			...
			"\"categoryName\" : \"cat-name\"," + 
			"\"maxCardsPerDay\" : 1," + 
			"\"maxInterval\" : 10} ", com.anfelisa.box.models.BoxUpdateModel.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_1() throws Exception {
		String uuid = "maxCards1-" + this.getTestId() + "";
	...
	private com.anfelisa.box.data.ScoreCardResponse then_1(HttpResponse<com.anfelisa.box.data.ScoreCardResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.ScoreCardModel expectedData = objectMapper.readValue("{" +
				...
				"\"maxCardsPerDay\" : 1," + 
				"\"maxInterval\" : 10} ", com.anfelisa.box.models.ScoreCardModel.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_2() throws Exception {
		String uuid = "maxCards2-" + this.getTestId() + "";
		this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200418 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
		com.anfelisa.box.data.ScoreCardPayload payload_0 = objectMapper.readValue("{" +
			"\"scoredCardQuality\" : 0," + 
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_3() throws Exception {
		String uuid = "maxCards3-" + this.getTestId() + "";
		this.callSquishyDataProviderPutSystemTime(uuid, LocalDateTime.parse("20200418 16:30", DateTimeFormatter.ofPattern("yyyyMMdd HH:mm")));
		com.anfelisa.box.data.ScoreCardPayload payload_0 = objectMapper.readValue("{" +
			"\"scoredCardQuality\" : 0," + 
	...
	private com.anfelisa.box.data.ScoreCardResponse then_3(HttpResponse<com.anfelisa.box.data.ScoreCardResponse> response) throws Exception {
		if (response.getStatusCode() == 500) {
			String statusMessage = response.getStatusMessage() != null ? response.getStatusMessage() : "";
			String errorMessage = "status " + response.getStatusCode() + " failed: " + statusMessage;
			LOG.error("THEN: " + errorMessage);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreMaxCardsPerDay")) {
				...
				HttpResponse<com.anfelisa.box.data.ScoreCardResponse> response_3 = when_3();
				com.anfelisa.box.data.ScoreCardResponse actualResponse_3 = then_3(response_3);
				this.newScheduledCard1WasCreated();
				this.newScheduledCard2WasCreated();
				this.newScheduledCard3WasCreated();
				
		
		} else {
			LOG.info("WHEN: prerequisite for ScoreMaxCardsPerDay not met");
		}
	...
	private void newScheduledCard1WasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxCards1-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 0," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"maxCards1-" + this.getTestId() + "\"," + 
			"\"scheduledDate\" : \"2020-04-19T16:30\"," + 
			"\"scoredDate\" : null} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);
	
		LOG.info("THEN: newScheduledCard1WasCreated passed");
	}
	private void newScheduledCard2WasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxCards2-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 0," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"maxCards2-" + this.getTestId() + "\"," + 
			"\"scheduledDate\" : \"2020-04-20T16:30\"," + 
			"\"scoredDate\" : null} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);
	
		LOG.info("THEN: newScheduledCard2WasCreated passed");
	}
	private void newScheduledCard3WasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxCards3-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 0," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"maxCards3-" + this.getTestId() + "\"," + 
			"\"scheduledDate\" : \"2020-04-21T16:30\"," + 
			"\"scoredDate\" : null} ",
		com.anfelisa.box.models.ScheduledCardModel.class);
		assertThat(actual, expected);
	
		LOG.info("THEN: newScheduledCard3WasCreated passed");
	}
		
	@Override
	protected String scenarioName() {
		return "ScoreMaxCardsPerDay";
	}
