...
public abstract class AbstractScoreCardNoAccessToBoxScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		com.anfelisa.user.data.UserRegistrationTestData registerUser9 = new com.anfelisa.user.data.UserRegistrationTestData("uuid-admin");
		registerUser9.setEmail(this.templateStringValue("annette.pohl@anfelisa.de", 9));
		registerUser9.setLanguage(this.templateStringValue("de", 9));
		registerUser9.setPassword(this.templateStringValue("admin-password", 9));
		registerUser9.setUsername(this.templateStringValue("Admin", 9));
		registerUser9.setToken(this.templateStringValue("ADMIN-TOKEN", 9));
		
		
		com.anfelisa.user.ActionCalls.callRegisterUser(registerUser9, DROPWIZARD.getLocalPort());
	...
	private Response when() throws Exception {
		...
		return 
		com.anfelisa.box.ActionCalls.callScoreCard(scoreCard0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
