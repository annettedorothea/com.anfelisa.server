...
public abstract class AbstractScoreMaxIntervalScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractScoreMaxIntervalScenario.class);
	...
	private HttpResponse<Object> when_0() throws Exception {
		...
		com.anfelisa.box.models.BoxUpdateModel model_0 = objectMapper.readValue("{" +
			...
			"\"categoryName\" : \"cat-name\"," + 
			"\"maxCardsPerDay\" : 10," + 
			"\"maxInterval\" : 1} ", com.anfelisa.box.models.BoxUpdateModel.class);
	...
	private HttpResponse<com.anfelisa.box.data.ScoreCardResponse> when_1() throws Exception {
		String uuid = "maxInterval-" + this.getTestId() + "";
	...
	private com.anfelisa.box.data.ScoreCardResponse then_1(HttpResponse<com.anfelisa.box.data.ScoreCardResponse> response) throws Exception {
		...
		if (response.getStatusCode() < 400) {
			...
			com.anfelisa.box.models.ScoreCardModel expectedData = objectMapper.readValue("{" +
				...
				"\"maxCardsPerDay\" : 10," + 
				"\"maxInterval\" : 1} ", com.anfelisa.box.models.ScoreCardModel.class);
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("ScoreMaxInterval")) {
			...
			LOG.info("WHEN: prerequisite for ScoreMaxInterval not met");
		}
	...
	private void newScheduledCardWasCreated() throws Exception {
		com.anfelisa.box.models.ScheduledCardModel actual = daoProvider.getScheduledCardDao().selectByScheduledCardId(handle, "maxInterval-" + this.getTestId() + "");
		...
		com.anfelisa.box.models.ScheduledCardModel expected = objectMapper.readValue("{" +
			...
			"\"n\" : 2," + 
			"\"quality\" : null," + 
			"\"scheduledCardId\" : \"maxInterval-" + this.getTestId() + "\"," + 
