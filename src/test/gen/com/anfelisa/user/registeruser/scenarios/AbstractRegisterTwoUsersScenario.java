...
public abstract class AbstractRegisterTwoUsersScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		return com.anfelisa.user.ActionCalls.callRegisterUser("uuid2", this.templateStringValue("pw", 0), this.templateStringValue("Anne", 0), this.templateStringValue("info@anfelisa.de", 0), this.templateStringValue("de", 0), DROPWIZARD.getLocalPort());
	}
