...
public abstract class AbstractRegisterTwoUsersScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.user.data.UserRegistrationTestData registerUser0 = new com.anfelisa.user.data.UserRegistrationTestData("uuid2");
		registerUser0.setEmail(this.templateStringValue("info@anfelisa.de", 0));
		registerUser0.setLanguage(this.templateStringValue("de", 0));
		registerUser0.setPassword(this.templateStringValue("pw", 0));
		registerUser0.setUsername(this.templateStringValue("Anne", 0));
		registerUser0.setToken(this.templateStringValue("TOKEN_2", 0));
