...
public abstract class AbstractForgotPasswordOKScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		com.anfelisa.user.data.ForgotPasswordTestData forgotPassword0 = new com.anfelisa.user.data.ForgotPasswordTestData(randomUUID());
		forgotPassword0.setLanguage(this.templateStringValue("de", 0));
		forgotPassword0.setUsername(this.templateStringValue("Annette", 0));
