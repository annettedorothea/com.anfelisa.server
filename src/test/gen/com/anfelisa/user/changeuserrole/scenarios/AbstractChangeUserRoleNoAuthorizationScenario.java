...
public abstract class AbstractChangeUserRoleNoAuthorizationScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.user.ActionCalls.callChangeUserRole(randomUUID(), this.templateStringValue("STUDENT", 0), this.templateStringValue("uuid", 0), DROPWIZARD.getLocalPort(), null);
	}
