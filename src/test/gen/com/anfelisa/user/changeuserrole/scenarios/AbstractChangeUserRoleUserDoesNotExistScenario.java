...
public abstract class AbstractChangeUserRoleUserDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.user.ActionCalls.callChangeUserRole(randomUUID(), this.templateStringValue("STUDENT", 0), this.templateStringValue("doesNotExist", 0), DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	}
