...
public abstract class AbstractResetPasswordInvalidTokenScenario extends BaseScenario {
	...
	private void given() throws Exception {
		...
		NotReplayableDataProvider.put("token", "RESET-PW-TOKEN");
		com.anfelisa.user.ActionCalls.callForgotPassword(randomUUID(), "Annette", "de", DROPWIZARD.getLocalPort());

	}
	
	private Response when() throws Exception {
		NotReplayableDataProvider.put("token", "INVALID-TOKEN");
		return com.anfelisa.user.ActionCalls.callResetPassword(randomUUID(), "newPassword", "INVALID-TOKEN", DROPWIZARD.getLocalPort());
	}
