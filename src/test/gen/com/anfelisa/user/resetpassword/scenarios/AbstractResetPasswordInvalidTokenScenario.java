...
public abstract class AbstractResetPasswordInvalidTokenScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		return com.anfelisa.user.ActionCalls.callResetPassword(randomUUID(), this.templateStringValue("newPassword", 0), this.templateStringValue("INVALID-TOKEN", 0), DROPWIZARD.getLocalPort());
	}
