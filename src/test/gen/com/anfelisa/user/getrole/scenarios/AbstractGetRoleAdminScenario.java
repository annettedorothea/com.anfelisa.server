...
public abstract class AbstractGetRoleAdminScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		...
		return 
		com.anfelisa.user.ActionCalls.callGetRole(getRole0, DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	...
	private com.anfelisa.user.data.GetRoleResponse then(Response response) throws Exception {
		...
		expectedData.setRole(this.templateStringValue("ADMIN", null));
