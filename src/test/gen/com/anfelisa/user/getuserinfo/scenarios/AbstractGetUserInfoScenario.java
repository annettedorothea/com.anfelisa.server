...
public abstract class AbstractGetUserInfoScenario extends BaseScenario {
	...
	private com.anfelisa.user.data.GetUserInfoResponse then_0(HttpResponse<com.anfelisa.user.data.GetUserInfoResponse> response) throws Exception {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("GetUserInfo")) {
				...
				HttpResponse<com.anfelisa.user.data.GetUserInfoResponse> response_0 = when_0();
				com.anfelisa.user.data.GetUserInfoResponse actualResponse_0 = then_0(response_0);
