...
public abstract class AbstractGetUserProfileWrongPasswordScenario extends BaseScenario {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractGetUserProfileWrongPasswordScenario.class);
	...
	private Response when() throws Exception {
		...
		com.anfelisa.user.data.UserData data_0 = objectMapper.readValue("{ \"uuid\" : \"" + uuid + "\"}",
		com.anfelisa.user.data.UserData.class);
		
		return 
		this.httpGet(
			"/user/get?uuid=" + data_0.getUuid() + "", 
			...
			return actual;
				...
				public void getUserProfileWrongPassword() throws Exception {
					...
					if (prerequisite("GetUserProfileWrongPassword")) {
						...
						LOG.info("prerequisite for GetUserProfileWrongPassword not met");
					}
				}
				...
				protected String scenarioName() {
					return "GetUserProfileWrongPassword";
				}
