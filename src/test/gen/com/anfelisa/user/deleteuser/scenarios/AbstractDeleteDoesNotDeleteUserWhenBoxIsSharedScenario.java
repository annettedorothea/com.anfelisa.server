...
public abstract class AbstractDeleteDoesNotDeleteUserWhenBoxIsSharedScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDeleteDoesNotDeleteUserWhenBoxIsSharedScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("RegisterTwoUsers")) {
			...
			com.anfelisa.user.data.RegisterUserPayload payload_10 = objectMapper.readValue("{" +
				...
				"\"username\" : \"Anne-" + this.getTestId() + "\"} ",
					com.anfelisa.user.data.RegisterUserPayload.class);
			com.anfelisa.user.models.UserRegistrationModel model_10 = objectMapper.readValue("{" +
				"\"email\" : \"info@anfelisa.de\"," + 
				"\"language\" : \"de\"," + 
				"\"password\" : \"pw\"," + 
				"\"username\" : \"Anne-" + this.getTestId() + "\"} ", com.anfelisa.user.models.UserRegistrationModel.class);
			Data<com.anfelisa.user.models.UserRegistrationModel> data_10 = new Data<com.anfelisa.user.models.UserRegistrationModel>(uuid);
			...
			if (response_10.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: RegisterTwoUsers fails due to {} in {} ms", message, response_10.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: RegisterTwoUsers success in {} ms", response_10.getDuration());
		...
		if (prerequisite("InviteUserToCategory")) {
			...
			com.anfelisa.category.models.UserToCategoryInvitationModel model_11 = objectMapper.readValue("{" +
				"\"categoryId\" : \"boxId-" + this.getTestId() + "\"," + 
				"\"invitedUsername\" : \"Anne-" + this.getTestId() + "\"," + 
				"\"editable\" : false} ", com.anfelisa.category.models.UserToCategoryInvitationModel.class);
			Data<com.anfelisa.category.models.UserToCategoryInvitationModel> data_11 = new Data<com.anfelisa.category.models.UserToCategoryInvitationModel>(uuid);
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: InviteUserToCategory fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: InviteUserToCategory success in {} ms", response_11.getDuration());
			addToMetrics("InviteUserToCategory", response_11.getDuration());
		} else {
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DeleteDoesNotDeleteUserWhenBoxIsShared")) {
				...
				this.noCategoriesWereDeleted();
				this.noCardsWereDeleted();
				this.noScheduledCardsWereDeleted();
				this.noReinforceCardsWereDeleted();
				
		
		} else {
			LOG.info("WHEN: prerequisite for DeleteDoesNotDeleteUserWhenBoxIsShared not met");
		}
	...
	private void noCategoriesWereDeleted() throws Exception {
		...
		LOG.info("THEN: noCategoriesWereDeleted passed");
	}
	private void noCardsWereDeleted() throws Exception {
		Map<String, String> filterMap = new HashMap<String, String>();
		filterMap.put("rootCategoryId", "boxId-" + this.getTestId() + "");
		...
		LOG.info("THEN: noCardsWereDeleted passed");
	}
	private void noScheduledCardsWereDeleted() throws Exception {
		Map<String, String> filterMap = new HashMap<String, String>();
		...
		LOG.info("THEN: noScheduledCardsWereDeleted passed");
	}
	private void noReinforceCardsWereDeleted() throws Exception {
		Map<String, String> filterMap = new HashMap<String, String>();
		filterMap.put("boxId", "boxId-" + this.getTestId() + "");
		...
		LOG.info("THEN: noReinforceCardsWereDeleted passed");
	}
		
	@Override
	protected String scenarioName() {
		return "DeleteDoesNotDeleteUserWhenBoxIsShared";
	}
