...
public abstract class AbstractDoesNotDeleteSharedCategoriesAndCardsWhenThereIsAnotherUserWithWriteAccessScenario extends BaseScenario {

	static final Logger LOG = LoggerFactory.getLogger(AbstractDoesNotDeleteSharedCategoriesAndCardsWhenThereIsAnotherUserWithWriteAccessScenario.class);
	...
	private void given() throws Exception {
		...
		if (prerequisite("InviteUserToCategoryEditable")) {
			...
			if (response_11.getStatusCode() >= 400) {
				...
				LOG.error("GIVEN: InviteUserToCategoryEditable fails due to {} in {} ms", message, response_11.getDuration());
				assertFail(message);
			}
			LOG.info("GIVEN: InviteUserToCategoryEditable success in {} ms", response_11.getDuration());
	...
	public void runTest() throws Exception {
		...
		if (prerequisite("DoesNotDeleteSharedCategoriesAndCardsWhenThereIsAnotherUserWithWriteAccess")) {
			...
			LOG.info("WHEN: prerequisite for DoesNotDeleteSharedCategoriesAndCardsWhenThereIsAnotherUserWithWriteAccess not met");
		}
	...
	protected String scenarioName() {
		return "DoesNotDeleteSharedCategoriesAndCardsWhenThereIsAnotherUserWithWriteAccess";
	}
