...
public abstract class AbstractDeleteUserDoesNotExistScenario extends BaseScenario {
	...
	private Response when() throws Exception {
		return com.anfelisa.user.ActionCalls.callDeleteUser(randomUUID(), this.templateStringValue("doesNotExist", 0), DROPWIZARD.getLocalPort(), authorization("Admin", "admin-password"));
	}
