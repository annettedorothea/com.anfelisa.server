...
public class TestPresentationalData implements ITestPresentationalData {
	...
	public TestPresentationalData withName(String name) {
		this.name = name;
		return this;
	}
	...
	public TestPresentationalData withSequence(Integer sequence) {
		this.sequence = sequence;
		return this;
	}
	...
	public TestPresentationalData withHtml(String html) {
		this.html = html;
		return this;
	}
	...
	public TestPresentationalData withAuthor(String author) {
		this.author = author;
		return this;
	}
	...
	public TestPresentationalData withLessonName(String lessonName) {
		this.lessonName = lessonName;
		return this;
	}
	...
	public TestPresentationalData withLessonDescription(String lessonDescription) {
		this.lessonDescription = lessonDescription;
		return this;
	}
	...
	public TestPresentationalData withLessonAuthor(String lessonAuthor) {
		this.lessonAuthor = lessonAuthor;
		return this;
	}
	...
	public TestPresentationalData withCourseName(String courseName) {
		this.courseName = courseName;
		return this;
	}
	...
	public TestPresentationalData withCourseAuthor(String courseAuthor) {
		this.courseAuthor = courseAuthor;
		return this;
	}
	...
	public TestPresentationalData withTestList(java.util.List<com.anfelisa.test.models.ITestModel> testList) {
		this.testList = testList;
		return this;
	}
