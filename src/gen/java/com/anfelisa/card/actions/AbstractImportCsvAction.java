...
public abstract class AbstractImportCsvAction extends Action<ICsvUploadData> {
	...
	public AbstractImportCsvAction(Jdbi jdbi, CustomAppConfiguration appConfiguration, 
			IDaoProvider daoProvider, ViewProvider viewProvider, E2E e2e) {
		super("com.anfelisa.card.actions.ImportCsvAction", HttpMethod.PUT);
		this.jdbi = jdbi;
	...
	public void setActionData(IDataContainer data) {
		this.actionData = (ICsvUploadData)data;
	}
	...
	public Response apply() {
		...
		try {
			if (ServerConfiguration.DEV.equals(appConfiguration.getServerConfiguration().getMode())
				...
				this.actionData = (ICsvUploadData)originalData;
