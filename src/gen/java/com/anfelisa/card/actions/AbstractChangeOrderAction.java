...
public abstract class AbstractChangeOrderAction extends WriteAction<IChangeCardOrderListData> {
	...
	protected void initActionDataFrom(ITimelineItem timelineItem) {
		...
		IChangeCardOrderListData originalActionData = (IChangeCardOrderListData)originalData;
	...
	public Response changeOrderResource(
			...
			IChangeCardOrderListData payload)
		...
		LOG.info("execute ChangeOrder with uuid " + this.actionData.getUuid());
