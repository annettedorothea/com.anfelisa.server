	...
	public Response changeOrderResource(
		...
		com.anfelisa.card.data.IChangeCardOrderListData actionData = new ChangeCardOrderListData(payload.getUuid());
		...
		com.anfelisa.card.actions.ChangeOrderAction action = new com.anfelisa.card.actions.ChangeOrderAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
