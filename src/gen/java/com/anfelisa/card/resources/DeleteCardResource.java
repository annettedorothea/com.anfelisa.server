	...
	public Response deleteCardResource(
		...
		com.anfelisa.card.actions.DeleteCardAction action = new com.anfelisa.card.actions.DeleteCardAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
