...
public class ImportCsvResource extends Resource {
	...
	public Response importCsvResource(
		...
		try {
			com.anfelisa.card.data.ICsvUploadData actionData = new CsvUploadData(uuid);
			...
			com.anfelisa.card.actions.ImportCsvAction action = new com.anfelisa.card.actions.ImportCsvAction(persistenceConnection, appConfiguration, daoProvider, viewProvider);
			...
			return unauthorized("authorization needed for /category/import-csv");
		} catch (Exception x) {
