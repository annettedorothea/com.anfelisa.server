	...
	public Response getCardsResource(
		...
		com.anfelisa.card.actions.GetCardsAction action = new com.anfelisa.card.actions.GetCardsAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
