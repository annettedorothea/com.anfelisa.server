	...
	public Response getTranslationResource(
		...
		com.anfelisa.card.actions.GetTranslationAction action = new com.anfelisa.card.actions.GetTranslationAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
