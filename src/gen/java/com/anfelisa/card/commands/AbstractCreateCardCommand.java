...
public abstract class AbstractCreateCardCommand extends Command<ICardCreationData> {
	...
	@Override
	public void addEventsToTimeline(ICardCreationData data, PersistenceHandle timelineHandle) {
	...
	public void publishEvents(ICardCreationData data, PersistenceHandle handle, PersistenceHandle timelineHandle) {
		if (data.hasOutcome("ok")){
			new Event<ICardCreationData>("com.anfelisa.card.events.CreateCardOkEvent", viewProvider).publish(data.deepCopy(), handle, timelineHandle);
		}
	}
