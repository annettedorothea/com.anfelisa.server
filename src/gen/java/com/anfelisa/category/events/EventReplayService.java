	...
	public static void replayEvent(String eventClass, String json, PersistenceHandle handle, IDaoProvider daoProvider, ViewProvider viewProvider, CustomAppConfiguration appConfiguration) {
		try {
			if (eventClass.equals("com.anfelisa.category.events.CreateCategoryOkEvent")) {
				...
				Event event = new Event<CategoryCreationData>("com.anfelisa.category.events.CreateCategoryOkEvent", daoProvider, viewProvider, appConfiguration);
			...
			if (eventClass.equals("com.anfelisa.category.events.UpdateCategoryOkEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<CategoryUpdateData>("com.anfelisa.category.events.UpdateCategoryOkEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.category.events.DeleteCategoryOkEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<CategoryDeleteData>("com.anfelisa.category.events.DeleteCategoryOkEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.category.events.MoveCategoryOkEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<CategoryMoveData>("com.anfelisa.category.events.MoveCategoryOkEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.category.events.ChangeOrderCategoryOkEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<CategoryChangeOrderData>("com.anfelisa.category.events.ChangeOrderCategoryOkEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
			if (eventClass.equals("com.anfelisa.category.events.InviteUserToCategoryOkEvent")) {
				...
				data.migrateLegacyData(json);
				Event event = new Event<UserToCategoryInvitationData>("com.anfelisa.category.events.InviteUserToCategoryOkEvent", daoProvider, viewProvider, appConfiguration);
				event.notifyListeners(data, handle);
				event.notifyAfterCommitListeners(data, handle);
			}
		} catch (IOException e) {
