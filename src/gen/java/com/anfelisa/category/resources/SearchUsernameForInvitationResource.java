...
public class SearchUsernameForInvitationResource extends Resource {
	...
	public Response searchUsernameForInvitationResource(
		...
		try {
			Data<com.anfelisa.category.models.UsernameSearchModel> data = new Data<com.anfelisa.category.models.UsernameSearchModel>(uuid);
			com.anfelisa.category.models.UsernameSearchModel model = new com.anfelisa.category.models.UsernameSearchModel();
			if (usernameSearchString == null || StringUtils.isBlank(usernameSearchString) || "null".equals(usernameSearchString)) {
				return badRequest("usernameSearchString is mandatory");
			}
			if (usernameSearchString != null) {
				model.setUsernameSearchString(usernameSearchString);
			}
			...
			return Response.ok(new com.anfelisa.category.data.SearchUsernameForInvitationResponse(data.getModel())).build();
