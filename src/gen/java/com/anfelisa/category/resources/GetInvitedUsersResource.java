...
@Path("/category/invited-usernames")
@SuppressWarnings("unused")
public class GetInvitedUsersResource extends Resource {

	static final Logger LOG = LoggerFactory.getLogger(GetInvitedUsersResource.class);
	...
	public GetInvitedUsersResource(PersistenceConnection persistenceConnection, CustomAppConfiguration appConfiguration, 
	...
	@GET
	@Timed(name = "GetInvitedUsersActionTimed")
	@Metered(name = "GetInvitedUsersActionMetered")
	@ExceptionMetered
	@ResponseMetered
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response getInvitedUsersResource(
		...
		try {
			...
			return unauthorized("authorization needed for /category/invited-usernames");
		} catch (Exception x) {
