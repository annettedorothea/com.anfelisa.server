...
public class ChangeOrderCategoryResource extends Resource {
	...
	public Response changeOrderCategoryResource(
			...
			com.anfelisa.category.data.ChangeOrderCategoryPayload payload) 
		...
		try {
			Data<com.anfelisa.category.models.CategoryChangeOrderModel> data = new Data<com.anfelisa.category.models.CategoryChangeOrderModel>(uuid);
			com.anfelisa.category.models.CategoryChangeOrderModel model = new com.anfelisa.category.models.CategoryChangeOrderModel();
			...
			model.setMovedCategoryId(payload.getMovedCategoryId());
			...
			model.setTargetCategoryId(payload.getTargetCategoryId());
