...
public abstract class AbstractCategoryItemData extends AbstractData implements ICategoryItemData {
	
	static final Logger LOG = LoggerFactory.getLogger(AbstractCategoryItemData.class);
	...
	public AbstractCategoryItemData(
...
,		@JsonProperty("uuid") String uuid
	...
	public AbstractCategoryItemData( String uuid ) {
		super(uuid);
	}
