...
public abstract class AbstractChangeOrderCategoryAction extends Action<ICategoryChangeOrderData> {
	...
	public AbstractChangeOrderCategoryAction(PersistenceConnection persistenceConnection, CustomAppConfiguration appConfiguration, 
		...
		super("com.anfelisa.category.actions.ChangeOrderCategoryAction", HttpMethod.PUT);
	...
	public void setActionData(IDataContainer data) {
		this.actionData = (ICategoryChangeOrderData)data;
	}
	...
	public Response changeOrderCategoryResource(
		...
		try {
			...
			LOG.warn("failed to parse param {}", "movedCategoryId");
		}
		try {
			this.actionData.setTargetCategoryId(payload.getTargetCategoryId());
		} catch (Exception x) {
			LOG.warn("failed to parse param {}", "targetCategoryId");
		}
		try {
