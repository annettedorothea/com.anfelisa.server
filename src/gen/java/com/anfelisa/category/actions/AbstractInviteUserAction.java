...
public abstract class AbstractInviteUserAction extends Action<IInviteUserData> {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractInviteUserAction.class);
	...
	public AbstractInviteUserAction(Jdbi jdbi, CustomAppConfiguration appConfiguration, 
			IDaoProvider daoProvider, ViewProvider viewProvider, E2E e2e) {
		super("com.anfelisa.category.actions.InviteUserAction", HttpMethod.POST);
		this.jdbi = jdbi;
	...
	public ICommand getCommand() {
		return new InviteUserCommand(this.actionData, daoProvider, viewProvider, this.appConfiguration);
	}
	...
	public Response apply() {
		...
		try {
			if (ServerConfiguration.DEV.equals(appConfiguration.getServerConfiguration().getMode())
				...
				this.actionData = (IInviteUserData)originalData;
