...
public abstract class AbstractRevokeUserAccessAction extends Action<IRevokeUserData> {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractRevokeUserAccessAction.class);
	...
	public ICommand getCommand() {
		return new RevokeUserAccessCommand(this.actionData, daoProvider, viewProvider, this.appConfiguration);
	}
