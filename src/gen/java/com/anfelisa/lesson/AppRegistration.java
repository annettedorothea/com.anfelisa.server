...
public class AppRegistration {
	...
	public static void registerConsumers() {
				AceController.addConsumer("com.anfelisa.lesson.events.CreateLessonCreatedEvent", LessonView.createLesson);
				AceController.addConsumer("com.anfelisa.lesson.events.UpdateLessonUpdatedEvent", LessonView.updateLesson);
				AceController.addConsumer("com.anfelisa.lesson.events.DeleteLessonDeletedEvent", LessonView.deleteLesson);
    }
}
