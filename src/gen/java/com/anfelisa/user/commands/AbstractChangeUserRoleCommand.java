...
public abstract class AbstractChangeUserRoleCommand extends Command<ChangeUserRoleData> {
	...
	public AbstractChangeUserRoleCommand(ChangeUserRoleData commandParam, DatabaseHandle databaseHandle, DaoProvider daoProvider, ViewProvider viewProvider) {
		super("com.anfelisa.user.commands.ChangeUserRoleCommand", commandParam, databaseHandle, daoProvider, viewProvider);
	}

	public AbstractChangeUserRoleCommand(DatabaseHandle databaseHandle, DaoProvider daoProvider, ViewProvider viewProvider) {
