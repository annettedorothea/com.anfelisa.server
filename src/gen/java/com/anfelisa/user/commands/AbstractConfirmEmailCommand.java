...
public abstract class AbstractConfirmEmailCommand extends Command<IConfirmEmailData> {
	...
	public void publishEvents(IConfirmEmailData data, PersistenceHandle handle, PersistenceHandle timelineHandle) {
		if (data.hasOutcome("ok")){
			new Event<IConfirmEmailData>("com.anfelisa.user.events.ConfirmEmailOkEvent", daoProvider, viewProvider, appConfiguration).publish(data.deepCopy(), handle, timelineHandle);
		}
	}
	...
	public void publishAfterCommitEvents(IConfirmEmailData data, PersistenceHandle handle, PersistenceHandle timelineHandle) {
		if (data.hasOutcome("ok")){
			new Event<IConfirmEmailData>("com.anfelisa.user.events.ConfirmEmailOkEvent", daoProvider, viewProvider, appConfiguration).publishAfterCommit(data.deepCopy(), handle, timelineHandle);
		}
	}
