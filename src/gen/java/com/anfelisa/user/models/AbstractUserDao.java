...
public class AbstractUserDao {
	...
	public void insert(PersistenceHandle handle, IUserModel userModel) {
		Update statement = handle.getHandle().createUpdate("INSERT INTO public.user (userid, username, password, email, role, emailconfirmed) VALUES (:userid, :username, :password, :email, :role, :emailconfirmed)");
	...
	public void updateByUserId(PersistenceHandle handle, IUserModel userModel) {
		Update statement = handle.getHandle().createUpdate("UPDATE public.user SET userid = :userid, username = :username, password = :password, email = :email, role = :role, emailconfirmed = :emailconfirmed WHERE userid = :userid");
		statement.bind("userid",  userModel.getUserId() );
		statement.bind("username",  userModel.getUsername() );
		statement.bind("password",  userModel.getPassword() );
		statement.bind("email",  userModel.getEmail() );
	...
	public void deleteByUserId(PersistenceHandle handle, String userId) {
		Update statement = handle.getHandle().createUpdate("DELETE FROM public.user WHERE userid = :userid");
		statement.bind("userid", userId);
		statement.execute();
	}

	public IUserModel selectByUserId(PersistenceHandle handle, String userId) {
		Optional<IUserModel> optional = handle.getHandle().createQuery("SELECT userid, username, password, email, role, emailconfirmed FROM public.user WHERE userid = :userid")
			.bind("userid", userId)
			.map(new UserMapper())
			.findFirst();
	...
	public void updateByUsername(PersistenceHandle handle, IUserModel userModel) {
		Update statement = handle.getHandle().createUpdate("UPDATE public.user SET userid = :userid, username = :username, password = :password, email = :email, role = :role, emailconfirmed = :emailconfirmed WHERE username = :username");
		statement.bind("userid",  userModel.getUserId() );
		statement.bind("username",  userModel.getUsername() );
		statement.bind("password",  userModel.getPassword() );
		statement.bind("email",  userModel.getEmail() );
	...
	public void deleteByUsername(PersistenceHandle handle, String username) {
		Update statement = handle.getHandle().createUpdate("DELETE FROM public.user WHERE username = :username");
		statement.bind("username", username);
		statement.execute();
	}

	public IUserModel selectByUsername(PersistenceHandle handle, String username) {
		Optional<IUserModel> optional = handle.getHandle().createQuery("SELECT userid, username, password, email, role, emailconfirmed FROM public.user WHERE username = :username")
	...
	public List<IUserModel> selectAll(PersistenceHandle handle) {
		return handle.getHandle().createQuery("SELECT userid, username, password, email, role, emailconfirmed FROM public.user")
			.map(new UserMapper())
			.list();
	}

	public void truncate(PersistenceHandle handle) {
		Update statement = handle.getHandle().createUpdate("TRUNCATE TABLE public.user CASCADE");
		statement.execute();
	}
