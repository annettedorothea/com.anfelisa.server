	...
	public Response usernameAvailableResource(
		...
		com.anfelisa.user.actions.UsernameAvailableAction action = new com.anfelisa.user.actions.UsernameAvailableAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
