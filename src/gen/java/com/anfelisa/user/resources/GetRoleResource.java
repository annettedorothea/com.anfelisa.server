	...
	public Response getRoleResource(
		...
		com.anfelisa.user.actions.GetRoleAction action = new com.anfelisa.user.actions.GetRoleAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
