	...
	public Response confirmEmailResource(
		...
		com.anfelisa.user.data.IConfirmEmailData actionData = new ConfirmEmailData(payload.getUuid());
		...
		com.anfelisa.user.actions.ConfirmEmailAction action = new com.anfelisa.user.actions.ConfirmEmailAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
