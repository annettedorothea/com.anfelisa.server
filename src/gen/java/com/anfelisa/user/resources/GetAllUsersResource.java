	...
	public Response getAllUsersResource(
		...
		com.anfelisa.user.actions.GetAllUsersAction action = new com.anfelisa.user.actions.GetAllUsersAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
