...
public abstract class AbstractSortCardsOutAction extends Action<ISortCardsOutData> {
	...
	public AbstractSortCardsOutAction(PersistenceConnection persistenceConnection, CustomAppConfiguration appConfiguration, 
		...
		super("com.anfelisa.box.actions.SortCardsOutAction", HttpMethod.POST);
	...
	public void setActionData(IDataContainer data) {
		this.actionData = (ISortCardsOutData)data;
	}
	...
	public Response sortCardsOutResource(
			...
			@NotNull ISortCardsOutData payload)
			throws JsonProcessingException {
		this.actionData = new SortCardsOutData(payload.getUuid());
		try {
			this.actionData.setCardIds(payload.getCardIds());
		} catch (Exception x) {
			LOG.warn("failed to parse param {}", "cardIds");
		}
		try {
	...
	public Response apply() {
		...
		try {
			if (ServerConfiguration.DEV.equals(appConfiguration.getServerConfiguration().getMode())
				...
				ISortCardsOutData originalActionData = (ISortCardsOutData)originalData;
