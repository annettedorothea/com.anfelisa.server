...
public abstract class AbstractLoadNextReinforceCardAction extends Action<INextReinforceCardData> {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractLoadNextReinforceCardAction.class);
	...
	public AbstractLoadNextReinforceCardAction(Jdbi jdbi, CustomAppConfiguration appConfiguration, 
			IDaoProvider daoProvider, ViewProvider viewProvider, E2E e2e) {
		super("com.anfelisa.box.actions.LoadNextReinforceCardAction", HttpMethod.GET);
		this.jdbi = jdbi;
	...
	public Response apply() {
		...
		try {
			if (ServerConfiguration.DEV.equals(appConfiguration.getServerConfiguration().getMode())
				...
				this.actionData = (INextReinforceCardData)originalData;
