...
public abstract class AbstractScheduleNextCardAction extends Action<IScheduleNextCardData> {
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractScheduleNextCardAction.class);
	...
	public ICommand getCommand() {
		return new ScheduleNextCardCommand(this.actionData, daoProvider, viewProvider, this.appConfiguration);
	}
