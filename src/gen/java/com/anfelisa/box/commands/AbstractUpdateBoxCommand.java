...
public abstract class AbstractUpdateBoxCommand extends Command<IBoxUpdateData> {
	...
	public void publishEvents(IBoxUpdateData data, PersistenceHandle handle, PersistenceHandle timelineHandle) {
		if (data.hasOutcome("canEditCategory")){
			new Event<IBoxUpdateData>("com.anfelisa.box.events.UpdateBoxCanEditCategoryEvent", daoProvider, viewProvider, appConfiguration).publish(data.deepCopy(), handle, timelineHandle);
		}
		if (data.hasOutcome("ok")){
			new Event<IBoxUpdateData>("com.anfelisa.box.events.UpdateBoxOkEvent", daoProvider, viewProvider, appConfiguration).publish(data.deepCopy(), handle, timelineHandle);
		}
	}
