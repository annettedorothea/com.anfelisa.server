	...
	public Response getBoxSettingsResource(
		...
		com.anfelisa.box.actions.GetBoxSettingsAction action = new com.anfelisa.box.actions.GetBoxSettingsAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
