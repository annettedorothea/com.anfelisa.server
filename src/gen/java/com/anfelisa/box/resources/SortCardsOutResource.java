	...
	public Response sortCardsOutResource(
		...
		com.anfelisa.box.data.ISortCardsOutData actionData = new SortCardsOutData(payload.getUuid());
		...
		com.anfelisa.box.actions.SortCardsOutAction action = new com.anfelisa.box.actions.SortCardsOutAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
