	...
	public class GetBoxesResource extends Resource {
	
		static final Logger LOG = LoggerFactory.getLogger(GetBoxesResource.class);
	...
	public GetBoxesResource(PersistenceConnection persistenceConnection, CustomAppConfiguration appConfiguration, 
	...
	@GET
	@Timed(name = "GetBoxesActionTimed")
	@Metered(name = "GetBoxesActionMetered")
	@ExceptionMetered
	@ResponseMetered
	...
	public Response getBoxesResource(
		...
		com.anfelisa.box.actions.GetBoxesAction action = new com.anfelisa.box.actions.GetBoxesAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
