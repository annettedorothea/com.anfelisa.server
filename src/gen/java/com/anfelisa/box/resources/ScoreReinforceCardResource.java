	...
	public Response scoreReinforceCardResource(
		...
		com.anfelisa.box.data.IScoreReinforceCardData actionData = new ScoreReinforceCardData(payload.getUuid());
		...
		com.anfelisa.box.actions.ScoreReinforceCardAction action = new com.anfelisa.box.actions.ScoreReinforceCardAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
