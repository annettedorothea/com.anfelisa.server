	...
	public Response getBoxStatisticsResource(
		...
		com.anfelisa.box.actions.GetBoxStatisticsAction action = new com.anfelisa.box.actions.GetBoxStatisticsAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
