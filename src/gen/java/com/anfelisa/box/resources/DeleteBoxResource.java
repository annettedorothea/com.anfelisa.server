	...
	public Response deleteBoxResource(
		...
		com.anfelisa.box.actions.DeleteBoxAction action = new com.anfelisa.box.actions.DeleteBoxAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
