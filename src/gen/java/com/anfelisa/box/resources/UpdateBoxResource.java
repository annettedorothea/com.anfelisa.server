	...
	public Response updateBoxResource(
		...
		com.anfelisa.box.data.IBoxUpdateData actionData = new BoxUpdateData(payload.getUuid());
		...
		com.anfelisa.box.actions.UpdateBoxAction action = new com.anfelisa.box.actions.UpdateBoxAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
