	...
	public Response createBoxResource(
		...
		com.anfelisa.box.data.IBoxCreationData actionData = new BoxCreationData(payload.getUuid());
		...
		com.anfelisa.box.actions.CreateBoxAction action = new com.anfelisa.box.actions.CreateBoxAction(persistenceConnection, appConfiguration, daoProvider, viewProvider, e2e);
