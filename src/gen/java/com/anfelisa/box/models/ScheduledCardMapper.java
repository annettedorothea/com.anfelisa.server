...
public class ScheduledCardMapper extends AbstractMapper<ScheduledCardModel> {
	
	public ScheduledCardModel map(ResultSet r, StatementContext ctx) throws SQLException {
