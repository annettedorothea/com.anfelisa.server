...
public class CustomTestDao {
	...
	public List<ITestModel> selectTests(Handle handle, String schema, Integer lessonId) {
	...
	public List<IMyTestModel> selectMyTests(Handle handle, String schema, Integer lessonId, String username) {
		List<ITestModel> tests = this.selectTests(handle, schema, lessonId);
		...
		for (ITestModel test : tests) {
			...
			List<IResultAbstractModel> results = customResultDao.selectByTestIdAndUsername(handle, schema,
					test.getTestId(), username);
	...
	public ITestModel selectByTestIdAndUsername(Handle handle, Integer testId, String username, String schema) {
		return handle
