...
public class CreateScoredCardCreatedEvent extends AbstractCreateScoredCardCreatedEvent {
	...
	public CreateScoredCardCreatedEvent(ScoredCardData eventParam, DatabaseHandle databaseHandle, DaoProvider daoProvider, ViewProvider viewProvider) {
		super(eventParam, databaseHandle, daoProvider, viewProvider);
	}

	public CreateScoredCardCreatedEvent(DatabaseHandle databaseHandle, DaoProvider daoProvider, ViewProvider viewProvider) {
