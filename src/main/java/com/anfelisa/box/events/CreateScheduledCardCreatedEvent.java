...
public class CreateScheduledCardCreatedEvent extends AbstractCreateScheduledCardCreatedEvent {
	...
	public CreateScheduledCardCreatedEvent(ScheduledCardData eventParam, DatabaseHandle databaseHandle, DaoProvider daoProvider, ViewProvider viewProvider) {
		super(eventParam, databaseHandle, daoProvider, viewProvider);
	}

	public CreateScheduledCardCreatedEvent(DatabaseHandle databaseHandle, DaoProvider daoProvider, ViewProvider viewProvider) {
