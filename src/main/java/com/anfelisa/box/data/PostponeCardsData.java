...
public class PostponeCardsData extends AbstractPostponeCardsData implements IPostponeCardsData {
	...
	public static com.anfelisa.box.models.IPostponeCardsModel generateTestData() {
		java.util.Random random = new java.util.Random();
		com.anfelisa.box.models.IPostponeCardsModel testData = new com.anfelisa.box.models.PostponeCardsModel();
