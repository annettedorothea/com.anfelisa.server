...
public class BoxStatisticsData extends AbstractBoxStatisticsData implements IBoxStatisticsData {
	...
	public static com.anfelisa.box.models.IBoxStatisticsModel generateTestData() {
		java.util.Random random = new java.util.Random();
		int n;
		com.anfelisa.box.models.IBoxStatisticsModel testData = new com.anfelisa.box.models.BoxStatisticsModel();
