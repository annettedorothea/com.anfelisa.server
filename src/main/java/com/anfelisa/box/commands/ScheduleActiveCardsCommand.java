...
public class ScheduleActiveCardsCommand extends AbstractScheduleActiveCardsCommand {

	static final Logger LOG = LoggerFactory.getLogger(ScheduleActiveCardsCommand.class);

	public ScheduleActiveCardsCommand(IScheduledCardsData commandData, IDaoProvider daoProvider, ViewProvider viewProvider, 
