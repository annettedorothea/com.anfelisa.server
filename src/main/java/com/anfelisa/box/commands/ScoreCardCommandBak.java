...
public class ScoreCardCommandBak extends AbstractScoreCardCommand {

	public ScoreCardCommandBak(DatabaseHandle databaseHandle, IDaoProvider daoProvider, ViewProvider viewProvider) {
		super(databaseHandle, daoProvider, viewProvider);
		// TODO Auto-generated constructor stub
	}

	/*static final Logger LOG = LoggerFactory.getLogger(ScoreCardCommandBak.class);
	...
	public ScoreCardCommandBak(ScoreCardData commandData, DatabaseHandle databaseHandle, IDaoProvider daoProvider, ViewProvider viewProvider) {
