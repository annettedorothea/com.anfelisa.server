...
public class FillBoxWithCardsAction extends AbstractFillBoxWithCardsAction {
	...
	public FillBoxWithCardsAction(DBI jdbi, CustomAppConfiguration appConfiguration, IDaoProvider daoProvider, ViewProvider viewProvider) {
	...
	@Path("/fill")
	@PermitAll
	public Response post(@NotNull @QueryParam("uuid") String uuid, @NotNull @QueryParam("boxId") String boxId,
			@Auth AuthUser user) throws JsonProcessingException {
