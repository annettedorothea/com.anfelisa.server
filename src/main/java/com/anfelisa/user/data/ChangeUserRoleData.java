...
public class ChangeUserRoleData extends AbstractChangeUserRoleData implements IChangeUserRoleData {
	...
	public static com.anfelisa.user.models.IChangeUserRoleModel generateTestData() {
		java.util.Random random = new java.util.Random();
		com.anfelisa.user.models.IChangeUserRoleModel testData = new com.anfelisa.user.models.ChangeUserRoleModel();
