...
public class CreateLessonResource extends Resource {

	static final Logger LOG = LoggerFactory.getLogger(CreateLessonResource.class);

	public CreateLessonResource(DBI jdbi) {
		super(jdbi);
	}
	...
	public Response post(@NotNull LessonCreationData lessonCreationData) throws JsonProcessingException {
		return new CreateLessonAction(lessonCreationData, this.createDatabaseHandle()).apply();
	}
