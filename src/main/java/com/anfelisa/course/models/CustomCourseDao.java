...
public class CustomCourseDao {
	...
	public ICourseModel selectByLessonId(Handle handle, String lessonId) {
		return handle.createQuery(
	...
	public ICourseModel selectByCourseIdAndUsername(Handle handle, String courseId, String username) {
		return handle.createQuery(
