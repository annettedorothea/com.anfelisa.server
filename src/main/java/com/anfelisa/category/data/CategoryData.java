...
public class CategoryData extends AbstractCategoryData implements ICategoryData {
	...
	public static com.anfelisa.category.models.ICategoryModel generateTestData() {
		java.util.Random random = new java.util.Random();
		com.anfelisa.category.models.ICategoryModel testData = new com.anfelisa.category.models.CategoryModel();
